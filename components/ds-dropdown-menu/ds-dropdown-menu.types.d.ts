import { CSSProperties, MouseEvent, ReactNode } from '../../../../../node_modules/.pnpm/react@19.2.3/node_modules/react';
 ...
 */
export interface DsDropdownMenuContentProps extends Pick<Menu.ContentProps, 'className' | 'style' | 'children'> {
    /**
     * Whether to render in place instead of using portals
     * @default false
     */
 ...
 */
export interface DsDropdownMenuItemProps extends Pick<Menu.ItemProps, 'disabled' | 'asChild' | 'className' | 'style' | 'onSelect' | 'onClick' | 'value' | 'children'> {
    /**
...
export {};
//# sourceMappingURL=ds-dropdown-menu.types.d.ts.map