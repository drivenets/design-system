...
export interface DsFileUploadProps extends Omit<FileUploadProps, 'files' | 'acceptedFiles' | 'onFileAccept' | 'onFileReject' | 'onFileRemove' | 'onFileDelete' | 'onFileCancel' | 'onFileRetry' | 'uploadProgress'> {
...
//# sourceMappingURL=ds-file-upload.types.d.ts.map