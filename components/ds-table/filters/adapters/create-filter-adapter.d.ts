 ...
 */
export declare function createFilterAdapter<TData, TFilterValue, TCellValue = unknown>(config: FilterAdapterConfig<TData, TFilterValue, TCellValue>): FilterAdapter<TData, TFilterValue, TCellValue>;
//# sourceMappingURL=create-filter-adapter.d.ts.map