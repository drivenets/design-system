...
**Use [CONTEXT.md](../../../CONTEXT.md) vocabulary for the design-system domain, and [LANGUAGE.md](LANGUAGE.md) vocabulary for architecture.** If `CONTEXT.md` defines **Component**, talk about "the select **Component**" — not "the FooBarHandler," and not "the select widget."
