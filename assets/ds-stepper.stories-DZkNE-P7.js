import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./iframe-ftOD7I-v.js";import{n as i,t as a}from"./ds-icon-C4anMkI-.js";import{c as o,i as s,n as c,o as l,t as u}from"./ds-stepper-C4RK_88m.js";import{n as d,t as f}from"./ds-panel-QDRNX3nX.js";var p,m,h,g,_,v,y,b=t((()=>{p=`_stepperDemo_mgd72_1`,m=`_stepperDemoWide_mgd72_5`,h=`_approveStep_mgd72_9`,g=`_approveButton_mgd72_13`,_=`_approveTitle_mgd72_18`,v=`_approveIcon_mgd72_22`,y={stepperDemo:p,stepperDemoWide:m,approveStep:h,approveButton:g,approveTitle:_,approveIcon:v}})),x,S,C,w,T,E,D,O,k,A,j,M,N,P;t((()=>{x=e(n(),1),u(),d(),a(),b(),S=r(),C={title:`Components/Stepper`,component:o,parameters:{layout:`centered`},argTypes:{className:{table:{disable:!0}}}},w={render:()=>{let e=[{label:`Project details`,description:`Enter project name and basic configuration`},{label:`Select market`,description:`Choose the target market for deployment`},{label:`Design policy`,description:`Define the design constraints and rules`}];return(0,S.jsx)(`div`,{className:y.stepperDemo,children:(0,S.jsx)(o,{count:e.length,children:e.map((t,n)=>(0,S.jsx)(l,{index:n,children:(0,S.jsx)(s,{index:n,label:t.label,description:t.description,actions:(0,S.jsx)(c,{children:n===e.length-1?`Finish`:`Next`})})},n))})})}},T={render:()=>{let e=[{label:`Project details`},{label:`Select market`},{label:`Design policy`}];return(0,S.jsx)(`div`,{className:y.stepperDemo,children:(0,S.jsx)(o,{count:e.length,children:e.map((t,n)=>(0,S.jsx)(l,{index:n,children:(0,S.jsx)(s,{index:n,label:t.label,actions:(0,S.jsx)(c,{children:n===e.length-1?`Finish`:`Next`})})},n))})})}},E={parameters:{docs:{source:{type:`code`}}},render:function(){let[e,t]=(0,x.useState)(0),[n,r]=(0,x.useState)(`docked`),i=[{label:`Project details`,description:`Enter project name and basic configuration`},{label:`Select market`,description:`Choose the target market for deployment`},{label:`Design policy`,description:`Define the design constraints and rules`}],a=n===`floating`;return(0,S.jsx)(f,{open:!0,variant:n,draggable:a,disablePadding:a,slotProps:{collapseButton:{onClick:()=>{r(a?`docked`:`floating`)},collapsed:a}},children:(0,S.jsx)(o,{count:i.length,activeStep:e,onStepChange:({step:e})=>t(e),variant:a?`single`:void 0,floating:a,children:i.map((e,t)=>(0,S.jsx)(l,{index:t,children:(0,S.jsx)(s,{index:t,label:e.label,description:e.description,actions:(0,S.jsx)(c,{children:t===i.length-1?`Finish`:`Next`})})},t))})})}},D={parameters:{layout:`padded`},render:()=>{let e=[{label:`Project details`,description:`Set up the project scope and requirements`},{label:`Select market`,description:`Pick a region and target audience`},{label:`Design policy`,description:`Configure branding and layout guidelines`},{label:`Review summary`,description:`Verify all settings before submission`},{label:`Final approval`,description:`Confirm and finalize the deployment plan`}];return(0,S.jsx)(o,{count:e.length,orientation:`horizontal`,actions:(0,S.jsx)(c,{children:`Next`}),children:e.map((e,t)=>(0,S.jsx)(l,{index:t,children:(0,S.jsx)(s,{index:t,label:e.label,description:e.description})},t))})}},O={parameters:{layout:`padded`},render:()=>{let e=[{label:`Project details`,description:`Configure the basic project settings`},{label:`Select market`,description:`Choose the target market for deployment`},{label:`Design policy`,description:`Define the design constraints and rules`}];return(0,S.jsx)(o,{count:e.length,orientation:`horizontal`,actions:(0,S.jsx)(c,{children:`Next`}),children:e.map((e,t)=>(0,S.jsx)(l,{index:t,children:(0,S.jsx)(s,{index:t,label:e.label,description:e.description})},t))})}},k={parameters:{layout:`padded`},render:()=>{let e=[{label:`Project details`},{label:`Select market`},{label:`Design policy`}];return(0,S.jsx)(o,{count:e.length,orientation:`horizontal`,actions:(0,S.jsx)(c,{children:`Next`}),children:e.map((e,t)=>(0,S.jsx)(l,{index:t,children:(0,S.jsx)(s,{index:t,label:e.label})},t))})}},A={parameters:{layout:`padded`,docs:{source:{type:`code`}}},render:function(){let[e,t]=(0,x.useState)(0),n=[{label:`Upload files`,description:`Drag and drop or browse to upload`,icon:`upload`},{label:`Configure settings`,description:(0,S.jsxs)(`span`,{children:[`Adjust `,(0,S.jsx)(`strong`,{children:`network parameters`}),` for deployment`]}),icon:`settings`},{label:`Deploy`,description:`Review and launch the deployment`,icon:`rocket_launch`}];return(0,S.jsx)(o,{count:n.length,orientation:`horizontal`,activeStep:e,onStepChange:({step:e})=>t(e),actions:(0,S.jsx)(c,{variant:`ghost`,children:e===n.length-1?`Finish`:`Continue`}),children:n.map((e,t)=>(0,S.jsx)(l,{index:t,slots:{indicator:(0,S.jsx)(i,{icon:e.icon,size:`small`})},children:(0,S.jsx)(s,{index:t,label:e.label,description:e.description})},t))})}},j={parameters:{docs:{source:{type:`code`}}},render:function(){let[e,t]=(0,x.useState)(0);return(0,S.jsx)(`div`,{className:y.stepperDemoWide,children:(0,S.jsxs)(o,{count:3,activeStep:e,onStepChange:({step:e})=>t(e),children:[(0,S.jsx)(l,{index:0,children:(0,S.jsx)(s,{index:0,label:`Project details`,description:`Enter project name and basic configuration`,actions:(0,S.jsx)(c,{children:`Next`})})}),(0,S.jsx)(l,{index:1,className:e===1?y.approveStep:void 0,slots:{indicator:(0,S.jsx)(i,{icon:`monitor_heart`,size:`small`})},slotProps:{indicator:{className:e===1?y.approveIcon:void 0}},children:(0,S.jsx)(s,{index:1,label:(0,S.jsx)(`span`,{className:e===1?y.approveTitle:void 0,children:`Verify health`}),description:`Confirm all services report healthy status`,actions:(0,S.jsx)(c,{className:e===1?y.approveButton:void 0,children:`Approve`})})}),(0,S.jsx)(l,{index:2,children:(0,S.jsx)(s,{index:2,label:`Design policy`,description:`Define the design constraints and rules`,actions:(0,S.jsx)(c,{children:`Finish`})})})]})})}},M={render:()=>(0,S.jsx)(`div`,{className:y.stepperDemoWide,children:(0,S.jsxs)(o,{count:4,children:[(0,S.jsx)(l,{index:0,children:(0,S.jsx)(s,{index:0,label:`Basic information`,description:`Enter your project details`,actions:(0,S.jsx)(c,{children:`Next`})})}),(0,S.jsx)(l,{index:1,disabled:!0,children:(0,S.jsx)(s,{index:1,label:`Advanced settings`,description:`Configure advanced options (requires approval)`,actions:(0,S.jsx)(c,{children:`Next`})})}),(0,S.jsx)(l,{index:2,children:(0,S.jsx)(s,{index:2,label:`Review`,description:`Review your configuration`,actions:(0,S.jsx)(c,{children:`Next`})})}),(0,S.jsx)(l,{index:3,disabled:!0,children:(0,S.jsx)(s,{index:3,label:`Deploy`,description:`Deploy to production (requires elevated permissions)`,actions:(0,S.jsx)(c,{children:`Finish`})})})]})})},N={render:()=>(0,S.jsx)(`div`,{className:y.stepperDemoWide,children:(0,S.jsxs)(o,{count:4,children:[(0,S.jsx)(l,{index:0,children:(0,S.jsx)(s,{index:0,label:`Configuration`,description:`Enter deployment configuration`,actions:(0,S.jsx)(c,{children:`Next`})})}),(0,S.jsx)(l,{index:1,variant:`error`,children:(0,S.jsx)(s,{index:1,label:`Validation`,description:`Configuration validation failed`,actions:(0,S.jsx)(c,{children:`Retry`})})}),(0,S.jsx)(l,{index:2,children:(0,S.jsx)(s,{index:2,label:`Review`,description:`Review and confirm changes`,actions:(0,S.jsx)(c,{children:`Next`})})}),(0,S.jsx)(l,{index:3,children:(0,S.jsx)(s,{index:3,label:`Complete`,description:`Finalize deployment`,actions:(0,S.jsx)(c,{children:`Finish`})})})]})})},P=[`Default`,`Compact`,`WithPanel`,`Horizontal`,`HorizontalFewSteps`,`HorizontalCompactFewSteps`,`CustomizedHorizontal`,`CustomizedVertical`,`WithDisabledSteps`,`WithErrorStep`],w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  render: () => {
    const steps = [{
...
}`,...N.parameters?.docs?.source},description:{story:"Set a step's `variant` to `error` to surface a validation failure. The error\nstep shows a close icon instead of its number and exposes `data-error`.",...N.parameters?.docs?.description}}}}))();export{T as Compact,A as CustomizedHorizontal,j as CustomizedVertical,w as Default,D as Horizontal,k as HorizontalCompactFewSteps,O as HorizontalFewSteps,M as WithDisabledSteps,N as WithErrorStep,E as WithPanel,P as __namedExportsOrder,C as default};