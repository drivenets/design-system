...
}`,...w.parameters?.docs?.source},description:{story:"Fully controlled segment group where the parent owns the value via\n`value`/`onValueChange`. Use when other UI must react to the selection.",...w.parameters?.docs?.description}}},T=[`Default`,`Small`,`WithIcons`,`IconOnly`,`Disabled`,`WithDisabledItems`,`TwoOptions`,`Controlled`]}))();export{w as Controlled,_ as Default,x as Disabled,b as IconOnly,v as Small,C as TwoOptions,S as WithDisabledItems,y as WithIcons,T as __namedExportsOrder,g as default};