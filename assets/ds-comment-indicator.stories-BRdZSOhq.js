import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as m}from"./iframe-Dq56RWbn.js";import{c as E}from"./index-Db8_K9ti.js";import{D as W}from"./ds-avatar-DhpAVHeB.js";import{D as N}from"./ds-comment-bubble-BbusABYE.js";import"./ds-thread-item-B8UxSMqX.js";import"./preload-helper-PPVm8Dsz.js";import"./ds-tooltip-Cy9GlW1E.js";import"./index-DloTf3ql.js";import"./index-_MKeDhFA.js";import"./index-CE2WutTF.js";import"./index-D6UB9xJB.js";import"./index-BVhl93ma.js";import"./index-CuI6grRl.js";import"./index-DxsX7jtf.js";import"./floating-ui.dom-o9At5h4Q.js";import"./index-c-Cwl3Qk.js";import"./ds-typography-CHqo9kJX.js";import"./index-DqSkZ5Jy.js";import"./create-split-props-u5h9OPvL.js";import"./use-locale-context-Dp-K3Sjd.js";import"./create-anatomy-DuRcI-Gs.js";import"./mutation-observer-Cu1ou0At.js";import"./raf-CC9hSMXO.js";import"./ds-button-BNSCCS1o.js";import"./ds-button-legacy-BgKt23x6.js";import"./ds-button-new-CrRLKGi9.js";import"./ds-icon-B-PQVI_C.js";import"./ds-checkbox-Dt4-7IBi.js";import"./ds-tag-BuXZnOUU.js";import"./ds-dropdown-menu-BXxDLAgu.js";import"./Combination-NjEQ6LGl.js";import"./ds-text-input-BHsAs8eJ.js";import"./portal-DNIosgEX.js";import"./use-presence-Dc2IF3V_.js";import"./set-DGrMDL5S.js";import"./computed-style-DoNL9F8p.js";import"./event-CBXSxTbR.js";import"./index-CUyXEVDu.js";import"./get-styles-DiNZk02e.js";import"./typeahead-Czqtb0Lm.js";import"./query-CjgVAlRR.js";import"./initial-focus-DVsxzH0c.js";import"./equal-DfFTejAs.js";import"./dismissable-layer-Bq1TYu_q.js";import"./navigate-CZNGs1s9.js";import"./merge-refs-DX9dreSa.js";import"./ds-textarea-Dbdv-qdY.js";import"./format-relative-time-B216dNqo.js";const O="_indicator_mx14w_1",V="_actionRequired_mx14w_19",U="_placeholder_mx14w_24",B="_plusIcon_mx14w_24",H="_avatar_mx14w_44",q={indicator:O,actionRequired:V,placeholder:U,plusIcon:B,avatar:H},w=({type:c="placeholder",avatarSrc:r,avatarName:t="",onClick:C,ref:u,className:y,style:g})=>{const o=c==="placeholder",l=c==="action-required",f=()=>o?"Add comment":"View comment";return e.jsx("button",{ref:u,type:"button",className:E(q.indicator,{[q.placeholder]:o,[q.actionRequired]:l},y),style:g,onClick:C,"aria-label":f(),children:o?e.jsx("span",{className:q.plusIcon,children:"+"}):e.jsx(W,{src:r,name:t,size:"sm",className:q.avatar})})};w.__docgenInfo={description:"",methods:[],displayName:"DsCommentIndicator",props:{type:{required:!1,tsType:{name:"union",raw:"'placeholder' | 'default' | 'action-required'",elements:[{name:"literal",value:"'placeholder'"},{name:"literal",value:"'default'"},{name:"literal",value:"'action-required'"}]},description:"",defaultValue:{value:"'placeholder'",computed:!1}},avatarSrc:{required:!1,tsType:{name:"string"},description:""},avatarName:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},ref:{required:!1,tsType:{name:"Ref",elements:[{name:"HTMLButtonElement"}],raw:"Ref<HTMLButtonElement>"},description:""},className:{required:!1,tsType:{name:"string"},description:""},style:{required:!1,tsType:{name:"CSSProperties"},description:""}}};const L="_container_hd0us_1",F="_header_hd0us_7",P="_headerCell_hd0us_16",$="_row_hd0us_26",K="_interactiveContainer_hd0us_49",J="_instructions_hd0us_56",Y="_indicatorWrapper_hd0us_66",z="_bubbleWrapper_hd0us_74",n={container:L,header:F,headerCell:P,row:$,interactiveContainer:K,instructions:J,indicatorWrapper:Y,bubbleWrapper:z},{expect:p,fn:b,within:T}=__STORYBOOK_MODULE_TEST__,$e={title:"Design System/Comments/CommentIndicator",component:w,parameters:{layout:"centered"},argTypes:{type:{control:"select",options:["placeholder","default","action-required"],description:"Type of indicator"},avatarSrc:{control:"text",description:"Avatar image URL for default/action-required types"},onClick:{action:"clicked",description:"Click handler"}}},k={args:{type:"placeholder",onClick:b()},play:async({canvasElement:c})=>{const t=T(c).getByRole("button",{name:/add comment/i});await p(t).toBeInTheDocument(),await p(t).toHaveAttribute("aria-label","Add comment")}},D={args:{type:"default",avatarSrc:"https://i.pravatar.cc/40?img=1",onClick:b()},play:async({canvasElement:c})=>{const t=T(c).getByRole("button",{name:/view comment/i});await p(t).toBeInTheDocument(),await p(t).toHaveAttribute("aria-label","View comment")}},A={args:{type:"action-required",avatarSrc:"https://i.pravatar.cc/40?img=2",onClick:b()},play:async({canvasElement:c})=>{const t=T(c).getByRole("button",{name:/view comment/i});await p(t).toBeInTheDocument(),await p(t).toHaveClass(/actionRequired/)}},_={render:()=>e.jsxs("div",{className:n.container,children:[e.jsxs("div",{className:n.header,children:[e.jsx("div",{className:n.headerCell,children:"Placeholder"}),e.jsx("div",{className:n.headerCell,children:"No action required"}),e.jsx("div",{className:n.headerCell,children:"Action Required"})]}),e.jsxs("div",{className:n.row,children:[e.jsx(w,{type:"placeholder",onClick:b()}),e.jsx(w,{type:"default",avatarSrc:"https://i.pravatar.cc/40?img=1",onClick:b()}),e.jsx(w,{type:"action-required",avatarSrc:"https://i.pravatar.cc/40?img=2",onClick:b()})]})]}),play:async({canvasElement:c})=>{const t=T(c).getAllByRole("button");await p(t).toHaveLength(3),await p(t[0]).toHaveAttribute("aria-label","Add comment"),await p(t[1]).toHaveAttribute("aria-label","View comment"),await p(t[2]).toHaveAttribute("aria-label","View comment")}},h={id:"user-1",name:"You",avatarSrc:"https://i.pravatar.cc/40?img=1"},j=()=>({id:"comment-1",numericId:42,author:{id:"user-2",name:"Karen J.",avatarSrc:"https://i.pravatar.cc/40?img=2"},createdAt:new Date(Date.now()-1440*60*1e3),isResolved:!1,messages:[{id:"msg-1",author:{id:"user-2",name:"Karen J.",avatarSrc:"https://i.pravatar.cc/40?img=2"},content:"This is the initial comment message.",createdAt:new Date(Date.now()-1440*60*1e3),isInitialMessage:!0},{id:"msg-2",author:h,content:"Thank you for the feedback!",createdAt:new Date(Date.now()-720*60*1e3)}]}),x={render:function(){const[r,t]=m.useState(!1),[C,u]=m.useState(""),[y,g]=m.useState(!1),[o,l]=m.useState(void 0),f=(a,s)=>{if(!o)l({id:"comment-1",numericId:42,author:h,createdAt:new Date,isResolved:!1,messages:[{id:"msg-1",author:h,content:a,createdAt:new Date,isInitialMessage:!0}]}),g(s);else{const d={id:`msg-${String(Date.now())}`,author:h,content:a,createdAt:new Date};l(v=>v&&{...v,messages:[...v.messages,d]})}u("")},R=(a,s)=>{o&&l(d=>d&&{...d,messages:d.messages.map(v=>v.id===a?{...v,content:s}:v)})},S=a=>{o&&l(s=>s&&{...s,messages:s.messages.filter(d=>d.id!==a)})},i=()=>{l(void 0),u(""),g(!1)};return e.jsxs("div",{className:n.interactiveContainer,children:[e.jsxs("p",{className:n.instructions,children:["Click the ",e.jsx("strong",{children:"+"})," icon to open an empty comment bubble, then follow the complete flow:",e.jsx("br",{}),"1. Type a message → Typing mode appears",e.jsx("br",{}),"2. Send → Creates thread with your first comment",e.jsx("br",{}),"3. Add replies → Thread grows with multiple messages"]}),e.jsxs("div",{className:n.indicatorWrapper,children:[e.jsx(w,{type:"placeholder",onClick:()=>t(!r)}),r&&e.jsx("div",{className:n.bubbleWrapper,children:e.jsx(N,{comment:o,currentUser:h,referenceTag:"Resource allocation",value:C,onValueChange:u,actionRequired:y,onActionRequiredChange:g,onSend:f,onEditMessage:R,onDeleteMessage:S,onMessageMarkUnread:a=>console.log("Mark unread:",a),onMessageResolved:a=>console.log("Resolved:",a),onClose:o?i:()=>t(!1),onResolve:()=>console.log("Resolve clicked"),onToggleActionRequired:()=>console.log("Toggle action required"),onForward:()=>console.log("Forward"),onMarkUnread:()=>console.log("Mark unread"),onCopyLink:()=>console.log("Copy link"),onDelete:()=>console.log("Delete")})})]})]})}},M={render:function(){const[r,t]=m.useState(!1),[C,u]=m.useState(""),[y,g]=m.useState(!1),[o,l]=m.useState(j()),f=i=>{const a={id:`msg-${String(Date.now())}`,author:h,content:i,createdAt:new Date};l(s=>({...s,messages:[...s.messages,a]})),u("")},R=(i,a)=>{l(s=>({...s,messages:s.messages.map(d=>d.id===i?{...d,content:a}:d)}))},S=i=>{l(a=>({...a,messages:a.messages.filter(s=>s.id!==i)}))};return e.jsxs("div",{className:n.interactiveContainer,children:[e.jsxs("p",{className:n.instructions,children:["Click the ",e.jsx("strong",{children:"avatar"})," to view existing comments and add replies"]}),e.jsxs("div",{className:n.indicatorWrapper,children:[e.jsx(w,{type:"default",avatarSrc:o.author.avatarSrc,onClick:()=>t(!r)}),r&&e.jsx("div",{className:n.bubbleWrapper,children:e.jsx(N,{comment:o,currentUser:h,referenceTag:"Resource allocation",value:C,onValueChange:u,actionRequired:y,onActionRequiredChange:g,onSend:f,onEditMessage:R,onDeleteMessage:S,onMessageMarkUnread:i=>console.log("Mark unread:",i),onMessageResolved:i=>console.log("Resolved:",i),onClose:()=>t(!1),onResolve:()=>console.log("Resolve clicked"),onToggleActionRequired:()=>console.log("Toggle action required"),onForward:()=>console.log("Forward"),onMarkUnread:()=>console.log("Mark unread"),onCopyLink:()=>console.log("Copy link"),onDelete:()=>console.log("Delete")})})]})]})}},I={render:function(){const[r,t]=m.useState(!1),[C,u]=m.useState(""),[y,g]=m.useState(!0),[o,l]=m.useState(j()),f=R=>{const S={id:`msg-${String(Date.now())}`,author:h,content:R,createdAt:new Date};l(i=>({...i,messages:[...i.messages,S]})),u("")};return e.jsxs("div",{className:n.interactiveContainer,children:[e.jsxs("p",{className:n.instructions,children:["Click the ",e.jsx("strong",{children:"action required avatar"})," to view urgent comments"]}),e.jsxs("div",{className:n.indicatorWrapper,children:[e.jsx(w,{type:"action-required",avatarSrc:o.author.avatarSrc,onClick:()=>t(!r)}),r&&e.jsx("div",{className:n.bubbleWrapper,children:e.jsx(N,{comment:o,currentUser:h,referenceTag:"Resource allocation",value:C,onValueChange:u,actionRequired:y,onActionRequiredChange:g,onSend:f,onClose:()=>t(!1),onResolve:()=>console.log("Resolve clicked"),onToggleActionRequired:()=>console.log("Toggle action required"),onForward:()=>console.log("Forward"),onMarkUnread:()=>console.log("Mark unread"),onCopyLink:()=>console.log("Copy link"),onDelete:()=>console.log("Delete")})})]})]})}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'placeholder',
    onClick: fn()
  },
...
with existing comments marked as requiring action.`,...I.parameters?.docs?.description}}};const Ke=["Placeholder","DefaultIndicator","ActionRequired","Default","WithEmptyBubble","WithExistingComments","WithActionRequired"];export{A as ActionRequired,_ as Default,D as DefaultIndicator,k as Placeholder,I as WithActionRequired,x as WithEmptyBubble,M as WithExistingComments,Ke as __namedExportsOrder,$e as default};
