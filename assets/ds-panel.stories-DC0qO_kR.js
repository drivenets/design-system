import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{n as i,t as a}from"./ds-button-Cql27HAi.js";import{n as o,t as s}from"./ds-panel-4aRlOIh1.js";import{c,i as l,n as u,o as d,t as f}from"./ds-stepper-DttZuxKx.js";var p,m,h,g,_,v,y;t((()=>{o(),a(),f(),p=e(n(),1),m=r(),h={title:`Components/Panel`,component:s,parameters:{layout:`centered`}},g={render:function({variant:e}){let[t,n]=(0,p.useState)(!0);return(0,m.jsxs)(m.Fragment,{children:[!t&&(0,m.jsx)(i,{onClick:()=>n(!0),children:`Open Panel`}),(0,m.jsxs)(s,{open:t,onOpenChange:n,variant:e,children:[(0,m.jsx)(`p`,{children:`This is a panel. It can contain any content you like, such as text, images, or other components.`}),(0,m.jsx)(`p`,{children:`It is collapsible. Hover it to see the trigger button.`}),(0,m.jsx)(i,{size:`small`,children:`Primary Action`})]})]})}},_={render:function(){let[e,t]=(0,p.useState)(!0);return(0,m.jsxs)(m.Fragment,{children:[!e&&(0,m.jsx)(i,{onClick:()=>t(!0),children:`Open Panel`}),(0,m.jsxs)(s,{open:e,onOpenChange:t,width:{lg:480,md:240},children:[(0,m.jsx)(`p`,{children:`This panel uses a responsive width.`}),(0,m.jsx)(`p`,{children:`Large screens: 480px. Medium screens: 240px.`}),(0,m.jsx)(i,{size:`small`,children:`Primary Action`})]})]})}},v={render:function(){let[e,t]=(0,p.useState)(`docked`),[n,r]=(0,p.useState)(0),i=e===`floating`,a=()=>{t(i?`docked`:`floating`)},o=[{label:`Configure network`,description:`Set up interfaces and routing policies`},{label:`Assign resources`,description:`Allocate compute and storage for the deployment`},{label:`Review & deploy`,description:`Verify configuration and launch`}];return(0,m.jsx)(`div`,{style:{position:`relative`,width:600,height:500},children:(0,m.jsx)(s,{open:!0,variant:e,draggable:i,disablePadding:i,slotProps:{collapseButton:{onClick:a,collapsed:i}},children:(0,m.jsx)(c,{count:o.length,activeStep:n,onStepChange:({step:e})=>r(e),variant:i?`single`:void 0,floating:i,children:o.map((e,t)=>(0,m.jsx)(d,{index:t,children:(0,m.jsx)(l,{index:t,label:e.label,description:e.description,actions:(0,m.jsx)(u,{children:t===o.length-1?`Deploy`:`Next`})})},t))})})})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
