...
}`,...E.parameters?.docs?.source},description:{story:"Show or hide columns dynamically via the controlled `columnVisibility` /\n`onColumnVisibilityChange` props — useful for customizable table views or\nresponsive layouts. Toggle a checkbox to add or remove the matching column.",...E.parameters?.docs?.description}}}})))()}O();export{E as ColumnHiding,T as WithProgressInfographic,D as __namedExportsOrder,w as default};