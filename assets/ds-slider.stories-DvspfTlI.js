...
}`,..._.parameters?.docs?.source},description:{story:"Drive the value from external state via `value` + `onValueChange`. The output can be\nformatted with `formatValue` (here as a percentage).",..._.parameters?.docs?.description}}}}))();export{_ as Controlled,f as Default,g as Disabled,h as Large,p as Range,m as Small,v as __namedExportsOrder,d as default};