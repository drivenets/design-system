import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{t as i}from"./ds-icon-BW3ZMuEi.js";import{t as a}from"./ds-icon-m9JGPUU6.js";import{i as o,t as s}from"./ds-checkbox-BHk-Fxbg.js";import{i as c,r as l}from"./use-ark-dialog-body-lock-cleanup-C-WXMXBn.js";import{t as u}from"./ds-radio-group-Bg0kdR98.js";import{n as d,t as f}from"./ds-button-Cql27HAi.js";import{r as p}from"./ds-form-control.types-Dc1SJuf4.js";import{t as m}from"./ds-form-control-CdTd7oXN.js";import{n as h,t as g}from"./ds-modal-0N9O71Lq.js";import{t as _}from"./ds-radio-group-DcOAR0bU.js";import{a as v,c as y,i as ee,n as te,r as b,s as ne,t as x,u as S}from"./zod-BfgemHL3.js";import{a as re,c as C,l as w,n as ie,r as ae,t as oe}from"./zod-BJg-qOEy.js";var se,ce,le,ue,de,fe,pe,me,he,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,ge=t((()=>{se=`_storyContainer_1il54_1`,ce=`_storyHeader_1il54_6`,le=`_formResults_1il54_10`,ue=`_formResultsTitle_1il54_18`,de=`_formResultsGrid_1il54_23`,fe=`_clearResultsButton_1il54_28`,pe=`_formSection_1il54_32`,me=`_formSectionTitle_1il54_38`,he=`_formGrid_1il54_45`,T=`_formGridThree_1il54_51`,E=`_inputLabel_1il54_58`,D=`_inputField_1il54_64`,O=`_customHeader_1il54_72`,k=`_headerButton_1il54_79`,A=`_customFooter_1il54_86`,j=`_customActions_1il54_94`,M=`_statusBadge_1il54_98`,N=`_footerButton_1il54_107`,P=`_footerButtonPrimary_1il54_115`,F=`_fileUploadArea_1il54_124`,I=`_uploadButton_1il54_132`,L=`_uploadText_1il54_143`,R=`_addButton_1il54_148`,z=`_errorMessage_1il54_159`,B={storyContainer:se,storyHeader:ce,formResults:le,formResultsTitle:ue,formResultsGrid:de,clearResultsButton:fe,formSection:pe,formSectionTitle:me,formGrid:he,formGridThree:T,inputLabel:E,inputField:D,customHeader:O,headerButton:k,customFooter:A,customActions:j,statusBadge:M,footerButton:N,footerButtonPrimary:P,fileUploadArea:F,uploadButton:I,uploadText:L,addButton:R,errorMessage:z}})),V,H,U,W,G,K,q,_e,ve,J,Y,X,Z,Q,$,ye;t((()=>{V=e(n(),1),l(),y(),v(),x(),oe(),h(),ge(),f(),m(),_(),s(),a(),H=r(),{expect:U,screen:W,userEvent:G,waitFor:K,within:q}=__STORYBOOK_MODULE_TEST__,_e={title:`Components/Modal`,component:g,parameters:{layout:`centered`},args:{open:!1},argTypes:{open:{control:`boolean`,description:`Controls whether the modal is open`},dividers:{control:`boolean`,description:`Show full-width dividers between header, body, and footer sections`},columns:{control:`select`,options:Array(12).fill(0).map((e,t)=>t+1),description:`Number of grid columns for modal width`},className:{control:`text`,description:`Additional CSS class names`}}},ve=C({name:w().min(1,`Name is required`),email:re(`Invalid email address`),department:w().min(1,`Please select a department`),role:w().min(1,`Please select a role`),description:w().min(20,`Description must be at least 20 characters`),acceptTerms:ae().refine(e=>e,`You must accept the terms and conditions`),subscription:ie([`basic`,`pro`,`enterprise`],{error:()=>`Please select a subscription plan`})}),J={name:``,email:``,department:``,role:``,description:``,acceptTerms:!1,subscription:`basic`},Y={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Default Modal`}),(0,H.jsx)(`p`,{children:`The default variant has an inset header underline and no footer border.`}),(0,H.jsx)(d,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Modal`})]}),(0,H.jsxs)(g,{open:e,columns:4,onOpenChange:t,children:[(0,H.jsxs)(g.Header,{children:[(0,H.jsx)(g.Title,{children:`Modal Title`}),(0,H.jsx)(g.CloseTrigger,{})]}),(0,H.jsx)(g.Body,{children:(0,H.jsx)(`p`,{children:`This is the default modal variant with simple content.`})}),(0,H.jsx)(g.Footer,{children:(0,H.jsxs)(g.Actions,{children:[(0,H.jsx)(d,{design:`v1.2`,buttonType:`secondary`,size:`large`,onClick:()=>t(!1),children:`Cancel`}),(0,H.jsx)(d,{design:`v1.2`,variant:`filled`,size:`large`,onClick:()=>t(!1),children:`Confirm`})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(W.getByRole(`heading`,{name:/modal title/i})).toBeVisible();let n=W.getByRole(`button`,{name:/confirm/i});await G.click(n),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`Default modal variant with inset header underline and no footer border.`}}}},X={render:function(){let[e,t]=(0,V.useState)(!1),[n,r]=(0,V.useState)(null),i=ne({resolver:te(ve),defaultValues:J,mode:`onChange`}),{register:a,handleSubmit:s,formState:{errors:c,isValid:l,touchedFields:f,isDirty:m},setValue:h,watch:_,trigger:v,reset:y,control:x}=i,S=e=>{r(e),t(!1),y(J)},re=()=>{y(J)},C=(e,t)=>{h(e,t!==`indeterminate`&&t,{shouldValidate:!0,shouldTouch:!0,shouldDirty:!0})};return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Interactive Form Modal Demo`}),(0,H.jsx)(`p`,{children:`Click the button below to open a form modal. Fill out the form and click "Save Changes" to see the results displayed here.`}),(0,H.jsx)(d,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Form Modal`})]}),n&&(0,H.jsxs)(`div`,{className:B.formResults,children:[(0,H.jsx)(`h3`,{className:B.formResultsTitle,children:`Form Results:`}),(0,H.jsxs)(`div`,{className:B.formResultsGrid,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Name:`}),` `,n.name]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Email:`}),` `,n.email]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Department:`}),` `,n.department]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Role:`}),` `,n.role||`Not specified`]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Description:`}),` `,n.description]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Subscription:`}),` `,n.subscription]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Terms Accepted:`}),` `,n.acceptTerms?`Yes`:`No`]})]}),(0,H.jsx)(d,{design:`v1.2`,buttonType:`secondary`,size:`small`,onClick:()=>r(null),className:B.clearResultsButton,children:`Clear Results`})]}),(0,H.jsxs)(g,{open:e,columns:8,dividers:!0,onOpenChange:t,children:[(0,H.jsxs)(g.Header,{children:[(0,H.jsx)(g.Title,{children:`User Profile Form`}),(0,H.jsx)(g.CloseTrigger,{})]}),(0,H.jsx)(g.Body,{children:(0,H.jsx)(ee,{...i,children:(0,H.jsxs)(`div`,{className:B.formSection,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Basic Information`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsx)(p,{label:`Full Name`,required:!0,status:`error`,messageIcon:`cancel`,message:f.name?c.name?.message:void 0,children:(0,H.jsx)(b,{name:`name`,control:x,render:({field:e})=>(0,H.jsx)(p.TextInput,{value:e.value,placeholder:`Enter full name`,onChange:e=>C(`name`,e.target.value),onBlur:e=>C(`name`,e.target.value)})})}),(0,H.jsx)(p,{label:`Email Address`,required:!0,status:`error`,messageIcon:`cancel`,message:f.email?c.email?.message:void 0,children:(0,H.jsx)(b,{name:`email`,control:x,render:({field:e})=>(0,H.jsx)(p.TextInput,{type:`email`,value:e.value,placeholder:`Enter email address`,onChange:e=>C(`email`,e.target.value),onBlur:e=>C(`email`,e.target.value)})})})]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Work Information`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsx)(p,{label:`Department`,required:!0,status:`error`,messageIcon:`cancel`,message:f.department?c.department?.message:void 0,children:(0,H.jsx)(b,{name:`department`,control:x,render:({field:e})=>(0,H.jsx)(p.Select,{value:e.value,placeholder:`Select a department`,options:[{label:`Engineering`,value:`engineering`},{label:`Product`,value:`product`},{label:`Design`,value:`design`},{label:`Marketing`,value:`marketing`},{label:`Sales`,value:`sales`},{label:`HR`,value:`hr`}],clearable:!0,onValueChange:e=>C(`department`,e),onBlur:()=>C(`department`,e.value)})})}),(0,H.jsx)(p,{label:`Role`,required:!0,status:`error`,messageIcon:`cancel`,message:f.role?c.role?.message:void 0,children:(0,H.jsx)(b,{name:`role`,control:x,render:({field:e})=>(0,H.jsx)(p.Select,{value:e.value,placeholder:`Select a role`,options:[{label:`Manager`,value:`manager`},{label:`Senior`,value:`senior`},{label:`Mid-level`,value:`mid`},{label:`Junior`,value:`junior`},{label:`Intern`,value:`intern`}],clearable:!0,onValueChange:e=>C(`role`,e),onBlur:()=>C(`role`,e.value)})})})]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Subscription Plan`}),(0,H.jsxs)(u.Root,{value:_(`subscription`),onValueChange:e=>C(`subscription`,e),children:[(0,H.jsx)(u.Item,{value:`basic`,label:`Basic`}),(0,H.jsx)(u.Item,{value:`pro`,label:`Pro`}),(0,H.jsx)(u.Item,{value:`enterprise`,label:`Enterprise`})]}),c.subscription&&(0,H.jsx)(`span`,{className:B.errorMessage,children:c.subscription.message})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Additional Information`}),(0,H.jsx)(p,{label:`Description`,required:!0,status:`error`,messageIcon:`cancel`,message:f.description?c.description?.message:void 0,children:(0,H.jsx)(p.Textarea,{placeholder:`Enter a brief description about the user (min. 20 characters)...`,...a(`description`,{onBlur:()=>v(`description`),onChange:()=>v(`description`)})})})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(o,{label:`I accept the terms and conditions`,checked:_(`acceptTerms`),onCheckedChange:e=>C(`acceptTerms`,e)}),c.acceptTerms&&(0,H.jsx)(`span`,{className:B.errorMessage,children:c.acceptTerms.message})]})]})})}),(0,H.jsx)(g.Footer,{children:(0,H.jsxs)(g.Actions,{children:[(0,H.jsx)(d,{design:`v1.2`,buttonType:`secondary`,size:`large`,onClick:re,children:`Reset`}),(0,H.jsx)(d,{design:`v1.2`,size:`large`,disabled:!m||!l,onClick:s(S),children:`Save Changes`})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e),n=async e=>{await K(()=>U(W.getByText(e)).toBeInTheDocument())},r=t.getByRole(`button`,{name:/open form modal/i});await G.click(r),await K(()=>U(W.getByText(`User Profile Form`)).toBeVisible());let i=W.getByLabelText(`Full Name`);await G.click(i),await G.tab(),await n(`Name is required`);let a=W.getByLabelText(`Email Address`);await G.click(a),await G.tab(),await n(`Invalid email address`);let o=W.getByLabelText(`Department`);await G.click(o),await G.tab(),await n(`Please select a department`);let s=W.getByLabelText(`Role`);await G.click(s),await G.tab(),await n(`Please select a role`);let c=W.getByLabelText(`Description`);await G.click(c),await G.tab(),await n(`Description must be at least 20 characters`);let l=W.getByLabelText(`I accept the terms and conditions`);await G.click(l),await G.click(l),await n(`You must accept the terms and conditions`);let u=`${S.person.firstName()} ${S.person.lastName()}`;await G.type(i,u),await K(()=>U(W.queryByText(`Name is required`)).not.toBeInTheDocument());let d=S.internet.email();await G.clear(a),await G.type(a,d),await K(()=>U(W.queryByText(`Invalid email address`)).not.toBeInTheDocument()),await G.click(o);let f=W.getByRole(`option`,{name:`Product`});await G.click(f),await K(()=>U(W.queryByText(`Please select a department`)).not.toBeInTheDocument()),await G.click(s);let p=W.getByRole(`option`,{name:`Manager`});await G.click(p),await K(()=>U(W.queryByText(`Please select a role`)).not.toBeInTheDocument());let m=S.lorem.sentence(5);await G.clear(c),await G.type(c,m),await K(()=>U(W.queryByText(`Description must be at least 20 characters`)).not.toBeInTheDocument());let h=W.getByLabelText(`Pro`);await G.click(h),await K(()=>U(W.queryByText(`Please select a subscription plan`)).not.toBeInTheDocument()),await G.click(l),await K(()=>U(W.queryByText(`You must accept the terms and conditions`)).not.toBeInTheDocument());let g=W.getByRole(`button`,{name:/save changes/i});await K(()=>U(g).toBeEnabled()),await G.click(g),await K(()=>U(W.queryByText(`User Profile Form`)).not.toBeVisible());let _=e=>U(t.getByText((t,n)=>n?.textContent===e)).toBeInTheDocument();await K(async()=>{await U(t.getByText(`Form Results:`)).toBeInTheDocument(),await _(`Name: ${u}`),await _(`Email: ${d}`),await _(`Role: manager`),await _(`Department: product`),await _(`Description: ${m}`),await _(`Subscription: pro`),await _(`Terms Accepted: Yes`)}),await G.click(r),await K(()=>U(W.getByText(`User Profile Form`)).toBeInTheDocument()),await K(async()=>{await U(i).toHaveValue(``),await U(a).toHaveValue(``),await U(c).toHaveValue(``),await U(l).not.toBeChecked()}),await G.type(i,`Test Name`),await G.type(a,`test@example.com`),await G.type(c,`This is a test description that is long enough`),await G.click(l);let v=W.getByRole(`button`,{name:/reset/i});await G.click(v),await K(async()=>{await U(i).toHaveValue(``),await U(a).toHaveValue(``),await U(c).toHaveValue(``),await U(l).not.toBeChecked()}),await G.keyboard(`{Escape}`),await G.click(t.getByRole(`button`,{name:/clear results/i})),await K(()=>U(t.queryByText(`Form Results:`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`The divided layout adds full-width borders on header and footer for clear visual separation. This example demonstrates form state management using react-hook-form with Zod validation.`}}}},Z={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Custom Modal Demo`}),(0,H.jsx)(`p`,{children:`Click the button below to open a custom modal with custom header and footer content.`}),(0,H.jsx)(d,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Custom Modal`})]}),(0,H.jsxs)(g,{open:e,columns:4,dividers:!0,onOpenChange:t,children:[(0,H.jsx)(g.Header,{children:(0,H.jsxs)(`div`,{className:B.customHeader,children:[(0,H.jsx)(`button`,{className:B.headerButton,children:`⋯`}),(0,H.jsx)(c.CloseTrigger,{className:B.headerButton,children:`✕`})]})}),(0,H.jsx)(g.Body,{children:(0,H.jsxs)(`div`,{className:B.formSection,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Project Details`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`project-name`,className:B.inputLabel,children:`Project Name`}),(0,H.jsx)(`input`,{id:`project-name`,type:`text`,placeholder:`Enter project name`,className:B.inputField})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`category`,className:B.inputLabel,children:`Category`}),(0,H.jsx)(`input`,{id:`category`,type:`text`,placeholder:`Select category`,className:B.inputField})]})]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Team Information`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`team-lead`,className:B.inputLabel,children:`Team Lead`}),(0,H.jsx)(`input`,{id:`team-lead`,type:`text`,placeholder:`Enter team lead name`,className:B.inputField})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`team-size`,className:B.inputLabel,children:`Team Size`}),(0,H.jsx)(`input`,{id:`team-size`,type:`text`,placeholder:`Number of team members`,className:B.inputField})]})]})]}),(0,H.jsx)(`div`,{children:(0,H.jsxs)(`div`,{className:B.formGridThree,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`budget`,className:B.inputLabel,children:`Budget`}),(0,H.jsx)(`input`,{id:`budget`,type:`text`,placeholder:`Enter budget amount`,className:B.inputField})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`timeline`,className:B.inputLabel,children:`Timeline`}),(0,H.jsx)(`input`,{id:`timeline`,type:`text`,placeholder:`Project duration`,className:B.inputField})]}),(0,H.jsx)(`button`,{className:B.addButton,children:`+`})]})}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Project Documents`}),(0,H.jsxs)(`div`,{className:B.fileUploadArea,children:[(0,H.jsx)(`button`,{className:B.uploadButton,children:`☁️ Upload file`}),(0,H.jsx)(`div`,{className:B.uploadText,children:`or drag and drop to upload`})]})]})]})}),(0,H.jsx)(g.Footer,{children:(0,H.jsxs)(`div`,{className:B.customFooter,children:[(0,H.jsx)(`div`,{className:B.statusBadge,children:`All done`}),(0,H.jsxs)(g.Actions,{className:B.customActions,children:[(0,H.jsx)(`button`,{className:B.footerButton,children:`Discard`}),(0,H.jsx)(`button`,{className:B.footerButtonPrimary,children:`Save Changes`})]})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open custom modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(W.getByText(`Project Details`)).toBeVisible();let n=W.getByRole(`button`,{name:/✕/i});await G.click(n),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`A custom modal with custom header and footer content, demonstrating how to override the default modal structure with custom components.`}}}},Q={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Modal with Icon`}),(0,H.jsx)(`p`,{children:`Example showing how to add an icon to the modal header.`}),(0,H.jsx)(d,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Modal`})]}),(0,H.jsxs)(g,{open:e,columns:4,onOpenChange:t,children:[(0,H.jsxs)(g.Header,{children:[(0,H.jsx)(i,{icon:`info`,size:`small`}),(0,H.jsx)(g.Title,{children:`Session Timeout`}),(0,H.jsx)(g.CloseTrigger,{})]}),(0,H.jsx)(g.Body,{children:(0,H.jsx)(`p`,{children:`Your session will expire in 5 minutes due to inactivity.`})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(W.getByRole(`heading`,{name:/session timeout/i})).toBeVisible(),await U(W.getByText(/session will expire/i)).toBeVisible(),await G.keyboard(`{Escape}`),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`Example showing how to add an icon to the modal header by composing DsIcon with DsModal.Header.`}}}},$={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Modal Without Header`}),(0,H.jsx)(`p`,{children:`Modal with only body and footer content, no header section.`}),(0,H.jsx)(d,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Modal`})]}),(0,H.jsxs)(g,{open:e,columns:4,onOpenChange:t,children:[(0,H.jsx)(g.Body,{children:(0,H.jsx)(`p`,{children:`This modal has no header section. Use this pattern when you want a cleaner look without the header underline.`})}),(0,H.jsx)(g.Footer,{children:(0,H.jsxs)(g.Actions,{children:[(0,H.jsx)(d,{design:`v1.2`,buttonType:`secondary`,size:`large`,onClick:()=>t(!1),children:`Close`}),(0,H.jsx)(d,{design:`v1.2`,variant:`filled`,size:`large`,onClick:()=>t(!1),children:`Continue`})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible());let n=W.getByRole(`dialog`);await U(q(n).getByText(/no header section/i)).toBeVisible();let r=W.getByRole(`button`,{name:/continue/i});await U(r).toBeVisible(),await G.click(r),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`Modal without a header component - use this pattern instead of a variant when you want no header underline.`}}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
