import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{n as i,t as a}from"./ds-table-d6i1iGOG.js";import{n as o,t as s}from"./ds-table.stories.module-CixZ03cv.js";import{c,l,n as u,t as d,u as f}from"./components-B31jbPMJ.js";import{n as p,t as m}from"./story-decorators--tHA5VUw.js";var h,g,_,v,y,b,x,S;t((()=>{h=e(n(),1),i(),o(),f(),p(),d(),g=r(),{fn:_}=__STORYBOOK_MODULE_TEST__,v={title:`Components/Table/Expansion`,component:a,parameters:{layout:`fullscreen`},args:{columns:c,data:l,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:(0,g.jsx)(u,{}),onRowClick:_()},decorators:[m]},y={args:{data:l.slice(0,5),expandable:e=>e.firstName!==`Tanner`,renderExpandedRow:e=>(0,g.jsxs)(g.Fragment,{children:[(0,g.jsxs)(`div`,{className:s.expandedRowDetails,children:[(0,g.jsxs)(`h4`,{children:[`Expanded Details for `,e.firstName]}),(0,g.jsxs)(`p`,{children:[`ID: `,e.id]}),(0,g.jsxs)(`p`,{children:[`Full Name: `,e.firstName,` `,e.lastName]}),(0,g.jsxs)(`p`,{children:[`Status: `,e.status]})]}),(0,g.jsx)(a,{columns:[{accessorKey:`id`,header:`ID`},{accessorKey:`firstName`,header:`First Name`},{accessorKey:`lastName`,header:`Last Name`}],data:l.slice(0,3)})]})}},b={args:{data:l.slice(0,5),expandable:!0,expandableColumnWidth:48,renderExpandedRow:e=>(0,g.jsxs)(`div`,{className:s.expandedRowDetails,children:[`Details for `,e.firstName]})}},x={args:{data:l.slice(0,5),expandable:e=>e.firstName!==`Tanner`,renderExpandedRow:e=>(0,g.jsxs)(`div`,{className:s.expandedRowDetails,children:[(0,g.jsxs)(`h4`,{children:[`Expanded Details for `,e.firstName]}),(0,g.jsxs)(`p`,{children:[`ID: `,e.id]}),(0,g.jsxs)(`p`,{children:[`Full Name: `,e.firstName,` `,e.lastName]}),(0,g.jsxs)(`p`,{children:[`Status: `,e.status]})]})},render:function(e){let t=(0,h.useRef)(null),[n,r]=(0,h.useState)([]),i=e=>{t.current?.expandRow(e),r(t=>t.includes(e)?t:[...t,e])};return(0,g.jsxs)(`div`,{children:[(0,g.jsxs)(`div`,{className:s.programmaticSelectionDemo,children:[(0,g.jsx)(`h4`,{className:s.programmaticSelectionDemo__title,children:`Programmatic Row Expansion Demo`}),(0,g.jsx)(`p`,{className:s.programmaticSelectionDemo__description,children:`Use the buttons below to programmatically control row expansion using TanStack Table v8 APIs.`}),(0,g.jsxs)(`p`,{className:s.programmaticSelectionDemo__selectedRows,children:[`Expanded rows: `,n.length>0?n.join(`, `):`None`]})]}),(0,g.jsxs)(`div`,{className:s.programmaticSelectionControls,children:[(0,g.jsx)(`button`,{onClick:()=>i(`2`),className:s.programmaticSelectionButton,children:`Expand Kevin`}),(0,g.jsx)(`button`,{onClick:()=>i(`3`),className:s.programmaticSelectionButton,children:`Expand John`}),(0,g.jsx)(`button`,{onClick:()=>i(`4`),className:s.programmaticSelectionButton,children:`Expand Jane`}),(0,g.jsx)(`button`,{onClick:()=>{t.current?.expandAllRows();let e=l.slice(0,5).filter(e=>e.firstName!==`Tanner`).map(e=>e.id);r(e)},className:s.programmaticSelectionButton,children:`Expand All`}),(0,g.jsx)(`button`,{onClick:()=>{t.current?.collapseAllRows(),r([])},className:s.programmaticSelectionButton,children:`Collapse All`}),(0,g.jsx)(`button`,{onClick:()=>{let e=[`2`,`3`,`4`];t.current?.expandRows(e),r(e)},className:s.programmaticSelectionButton,children:`Expand First 3 Expandable`})]}),(0,g.jsx)(a,{...e,ref:t})]})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...b.parameters?.docs?.source},description:{story:`The expander utility column is 36px by default. Pass a pixel width when the
chevron column needs more (or less) room. It is not user-resizable.`,...b.parameters?.docs?.description}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    data: defaultData.slice(0, 5),
    expandable: row => row.firstName !== 'Tanner',
...
}`,...x.parameters?.docs?.source}}},S=[`Expandable`,`CustomExpanderColumnWidth`,`ProgrammaticExpansion`]}))();export{b as CustomExpanderColumnWidth,y as Expandable,x as ProgrammaticExpansion,S as __namedExportsOrder,v as default};