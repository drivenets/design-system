...
}`,...h.parameters?.docs?.source},description:{story:"Visual reference for every size token, from `xsm` to `xl`. Pick the size that\nmatches the surrounding density; `regular` is the default.",...h.parameters?.docs?.description}}}}))();export{d as Default,f as Overflow,m as Rounded,h as Sizes,p as Small,g as __namedExportsOrder,u as default};