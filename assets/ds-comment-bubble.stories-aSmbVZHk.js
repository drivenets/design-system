import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-p_714bN8.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{n as i,t as a}from"./ds-comment-bubble-D5PUb72f.js";var o,s,c,l,u,d,f=e((()=>{o=`_grid_r8ygt_1`,s=`_column_r8ygt_7`,c=`_heading_r8ygt_13`,l=`_interactiveContainer_r8ygt_20`,u=`_instructions_r8ygt_27`,d={grid:o,column:s,heading:c,interactiveContainer:l,instructions:u}})),p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{p=t(n(),1),a(),f(),m=r(),{fn:h}=__STORYBOOK_MODULE_TEST__,g={id:`user-1`,name:`Karen J.`,avatarSrc:`https://i.pravatar.cc/40?img=1`},_=(e={})=>({id:`comment-1`,numericId:63,author:g,createdAt:new Date(Date.now()-1440*60*1e3),isResolved:!1,messages:[{id:`msg-1`,author:g,content:`We need to review the resource allocation for this project.`,createdAt:new Date(Date.now()-1440*60*1e3),isInitialMessage:!0},{id:`msg-2`,author:g,content:`I think we should consider adjusting the timeline to ensure we have enough resources for the development phase. This will help us maintain quality standards.`,createdAt:new Date(Date.now()-1200*60*1e3)},{id:`msg-3`,author:{id:`user-2`,name:`John D.`,avatarSrc:`https://i.pravatar.cc/40?img=2`},content:`That makes sense. I can help coordinate with the team to identify any potential blockers. We should also check with stakeholders about priority.`,createdAt:new Date(Date.now()-960*60*1e3)},{id:`msg-4`,author:g,content:`Great idea. Let me schedule a meeting with the stakeholders for next week. We can discuss the timeline and resource requirements in detail.`,createdAt:new Date(Date.now()-720*60*1e3)},{id:`msg-5`,author:{id:`user-3`,name:`Jane S.`,avatarSrc:`https://i.pravatar.cc/40?img=3`},content:`I can prepare a summary of our current resource usage and projected needs for the meeting. This will help us make informed decisions.`,createdAt:new Date(Date.now()-480*60*1e3)}],...e}),v={title:`Components/Comments/CommentBubble`,component:i,parameters:{layout:`centered`,docs:{description:{component:`
