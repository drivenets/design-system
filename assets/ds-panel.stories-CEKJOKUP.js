import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-p_714bN8.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{c as i,d as a,i as o,n as s,o as c,t as l,u}from"./ds-stepper-BRsTtwaM.js";import{n as d,t as f}from"./ds-button-CeoHkvOE.js";var p,m,h,g,_,v,y;e((()=>{a(),f(),l(),p=t(n(),1),m=r(),h={title:`Components/Panel`,component:u,parameters:{layout:`centered`}},g={render:function({variant:e}){let[t,n]=(0,p.useState)(!0);return(0,m.jsxs)(m.Fragment,{children:[!t&&(0,m.jsx)(d,{onClick:()=>n(!0),children:`Open Panel`}),(0,m.jsxs)(u,{open:t,onOpenChange:n,variant:e,children:[(0,m.jsx)(`p`,{children:`This is a panel. It can contain any content you like, such as text, images, or other components.`}),(0,m.jsx)(`p`,{children:`It is collapsible. Hover it to see the trigger button.`}),(0,m.jsx)(d,{size:`small`,children:`Primary Action`})]})]})}},_={render:function(){let[e,t]=(0,p.useState)(!0);return(0,m.jsxs)(m.Fragment,{children:[!e&&(0,m.jsx)(d,{onClick:()=>t(!0),children:`Open Panel`}),(0,m.jsxs)(u,{open:e,onOpenChange:t,width:{lg:480,md:240},children:[(0,m.jsx)(`p`,{children:`This panel uses a responsive width.`}),(0,m.jsx)(`p`,{children:`Large screens: 480px. Medium screens: 240px.`}),(0,m.jsx)(d,{size:`small`,children:`Primary Action`})]})]})}},v={render:function(){let[e,t]=(0,p.useState)(`docked`),[n,r]=(0,p.useState)(0),a=e===`floating`,l=()=>{t(a?`docked`:`floating`)},d=[{label:`Configure network`,description:`Set up interfaces and routing policies`},{label:`Assign resources`,description:`Allocate compute and storage for the deployment`},{label:`Review & deploy`,description:`Verify configuration and launch`}];return(0,m.jsx)(`div`,{style:{position:`relative`,width:600,height:500},children:(0,m.jsx)(u,{open:!0,variant:e,draggable:a,disablePadding:a,slotProps:{collapseButton:{onClick:l,collapsed:a}},children:(0,m.jsx)(i,{count:d.length,activeStep:n,onStepChange:({step:e})=>r(e),variant:a?`single`:void 0,floating:a,children:d.map((e,t)=>(0,m.jsx)(c,{index:t,children:(0,m.jsx)(o,{index:t,label:e.label,description:e.description,actions:(0,m.jsx)(s,{children:t===d.length-1?`Deploy`:`Next`})})},t))})})})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
