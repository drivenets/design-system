import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as s}from"./index-Dsv-xH0q.js";import{D as _}from"./ds-icon-DTk7dVp_.js";import{D as p}from"./ds-button-legacy-ClWrMtPq.js";import"./iframe-Crf9NEZk.js";import"./preload-helper-PPVm8Dsz.js";const b=["primary","secondary","error"],d=["filled","ghost","borderless","round","dashed"],B=["large","medium","small"],N="_row_c8evy_1",f="_combinationsContainer_c8evy_8",w="_schemaContainer_c8evy_15",T="_schemaTitle_c8evy_36",x="_variantContainer_c8evy_46",C="_variantTitle_c8evy_52",S="_buttonShowcase_c8evy_60",t={row:N,combinationsContainer:f,schemaContainer:w,"iconButton-small":"_iconButton-small_c8evy_21","iconButton-medium":"_iconButton-medium_c8evy_26","iconButton-large":"_iconButton-large_c8evy_31",schemaTitle:T,variantContainer:x,variantTitle:C,buttonShowcase:S},{expect:g,fn:D,userEvent:j,within:R}=__STORYBOOK_MODULE_TEST__,O={title:"Design System/ButtonLegacy (Deprecated)",component:p,parameters:{layout:"centered"},tags:["deprecated"],argTypes:{schema:{control:{type:"select"},options:b,description:"Button color schema",table:{defaultValue:{summary:"primary"}}},variant:{control:{type:"select"},options:d,table:{defaultValue:{summary:"filled"}}},size:{control:{type:"select"},options:B,table:{defaultValue:{summary:"medium"}}}},args:{onClick:D()}},y="Button Text",l={args:{schema:"primary",variant:"filled",disabled:!1,children:y},play:async({canvasElement:h})=>{const r=R(h).getByRole("button",{name:y});await j.click(r),await g(r).toBeInTheDocument()}},m={parameters:{layout:"fullscreen"},render:function(){const i=(e,n,c,u,v)=>a.jsx("div",{className:s(t.row),children:B.map(o=>a.jsxs(p,{className:s(t.buttonShowcase,{[t[`iconButton-${o}`]]:!v}),schema:e,variant:n,size:o,disabled:c,children:[u&&a.jsx(_,{icon:"add",size:o},o),v&&a.jsxs("span",{children:[o," Button"]})]},`${e}-${n}-${o}`))}),r=(e,n,c,u)=>a.jsxs("div",{className:s(t.variantContainer),children:[u&&a.jsx("div",{className:s(t.row),children:a.jsx("h4",{className:s(t.variantTitle),children:n})}),i(e,n,c,!1,!0),i(e,n,c,!0,!1),i(e,n,c,!0,!0)]},e+n);return a.jsxs("div",{className:s(t.combinationsContainer),children:[b.map(e=>a.jsxs("div",{className:s(t.schemaContainer),children:[a.jsx("h3",{className:s(t.schemaTitle),children:e}),d.map(n=>r(e,n,!1,e==="primary"))]},e)),a.jsxs("div",{className:s(t.schemaContainer),children:[a.jsx("h3",{className:s(t.schemaTitle),children:"Disabled"}),d.map(e=>r("primary",e,!0))]})]})}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    schema: 'primary',
    variant: 'filled',
    disabled: false,
