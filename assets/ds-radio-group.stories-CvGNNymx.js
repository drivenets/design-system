...
}`,...g.parameters?.docs?.source},description:{story:"For richer options, pass custom `children` to an `Item` instead of `label`.\nCompose layout with `DsStack` and `DsTypography` for full control over each row.",...g.parameters?.docs?.description}}}}))();export{h as Controlled,g as CustomComposition,p as Default,m as WithDisabledItems,_ as __namedExportsOrder,f as default};