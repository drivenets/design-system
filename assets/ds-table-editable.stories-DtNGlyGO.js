...
}`,...j.parameters?.docs?.source},description:{story:"`onCellEdit` may be async: save inside it, resolve to an error `string` to keep\nthe cell open or `void`/`null` to commit. The editor locks while saving, and\n`signal` aborts if you Cancel/Escape. Try `taken` to see a server-side rejection.",...j.parameters?.docs?.description}}},M=[`Editable`,`LiveValidation`,`ValidateOnAsyncSave`]}))();export{k as Editable,A as LiveValidation,j as ValidateOnAsyncSave,M as __namedExportsOrder,O as default};