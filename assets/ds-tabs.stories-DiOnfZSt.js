...
}`,...O.parameters?.docs?.source},description:{story:"Adds a `tooltip` per tab — use for icon-light tabs that need extra context on hover.",...O.parameters?.docs?.description}}}}))();export{b as Default,x as HorizontalSmall,D as TextOnly,C as Vertical,w as VerticalSmall,T as VerticalWithMenuActions,E as WithDisabled,S as WithMenuActions,O as WithTooltips,k as __namedExportsOrder,y as default};