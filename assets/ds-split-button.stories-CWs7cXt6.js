...
}`,...g.parameters?.docs?.source},description:{story:"Wire the select `value`/`onValueChange` to local state and drive the button\n`loading` flag from the async action to reflect real usage.",...g.parameters?.docs?.description}}}}))();export{g as Controlled,f as Default,h as Disabled,m as Loading,p as Small,_ as __namedExportsOrder,d as default};