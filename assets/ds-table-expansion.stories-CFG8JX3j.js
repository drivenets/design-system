...
}`,...C.parameters?.docs?.source},description:{story:"Drive expansion imperatively through the table ref. `expandRow`, `expandRows`,\n`expandAllRows`, and `collapseAllRows` on `DsTableApi` let a parent expand or\ncollapse rows from outside the table.",...C.parameters?.docs?.description}}},w=[`Expandable`,`CustomExpanderColumnWidth`,`ProgrammaticExpansion`]}))();export{S as CustomExpanderColumnWidth,x as Expandable,C as ProgrammaticExpansion,w as __namedExportsOrder,b as default};