import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-BJoyWkjz.js";import{t as r}from"./jsx-runtime-cM__dR4X.js";import{t as i}from"./ds-icon-BW3ZMuEi.js";import{t as a}from"./ds-icon-m9JGPUU6.js";import{n as o,t as s}from"./ds-panel-4aRlOIh1.js";import{c,i as l,n as u,o as d,t as f}from"./ds-stepper-DttZuxKx.js";var p,m,h,g,_,v=t((()=>{p=`_approveStep_1nhp1_1`,m=`_approveButton_1nhp1_5`,h=`_approveTitle_1nhp1_10`,g=`_approveIcon_1nhp1_14`,_={approveStep:p,approveButton:m,approveTitle:h,approveIcon:g}})),y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;t((()=>{y=e(n(),1),f(),o(),a(),v(),b=r(),{expect:x,userEvent:S}=__STORYBOOK_MODULE_TEST__,C={title:`Components/Stepper`,component:c,parameters:{layout:`centered`}},w=[{label:`Project details`,description:`Enter project name and basic configuration`},{label:`Select market`,description:`Choose the target market for deployment`},{label:`Design policy`,description:`Define the design constraints and rules`}],T=[{label:`Project details`,description:`Set up the project scope and requirements`},{label:`Select market`,description:`Pick a region and target audience`},{label:`Design policy`,description:`Configure branding and layout guidelines`},{label:`Review summary`,description:`Verify all settings before submission`},{label:`Final approval`,description:`Confirm and finalize the deployment plan`}],E={render:function(){return(0,b.jsx)(`div`,{style:{width:300},children:(0,b.jsx)(c,{count:w.length,children:w.map((e,t)=>(0,b.jsx)(d,{index:t,children:(0,b.jsx)(l,{index:t,label:e.label,description:e.description,actions:(0,b.jsx)(u,{children:t===w.length-1?`Finish`:`Next`})})},t))})})},play:async({canvas:e,step:t})=>{await t(`All steps and descriptions visible`,async()=>{for(let t of w)await x(e.getByText(t.label)).toBeInTheDocument(),await x(e.getByText(t.description)).toBeInTheDocument()}),await t(`Navigate through all steps`,async()=>{await S.click(e.getByRole(`button`,{name:/next/i})),await S.click(e.getByRole(`button`,{name:/next/i})),await x(e.getByRole(`button`,{name:/finish/i})).toBeInTheDocument()})}},D={render:function(){return(0,b.jsx)(`div`,{style:{width:300},children:(0,b.jsx)(c,{count:w.length,children:w.map((e,t)=>(0,b.jsx)(d,{index:t,children:(0,b.jsx)(l,{index:t,label:e.label,actions:(0,b.jsx)(u,{children:t===w.length-1?`Finish`:`Next`})})},t))})})},play:async({canvas:e,step:t})=>{await t(`All step labels visible without descriptions`,async()=>{for(let t of w)await x(e.getByText(t.label)).toBeInTheDocument()}),await t(`Navigate through all steps`,async()=>{await S.click(e.getByRole(`button`,{name:/next/i})),await S.click(e.getByRole(`button`,{name:/next/i})),await x(e.getByRole(`button`,{name:/finish/i})).toBeInTheDocument()})}},O={render:function(){let[e,t]=(0,y.useState)(0),[n,r]=(0,y.useState)(`docked`),i=n===`floating`;return(0,b.jsx)(s,{open:!0,variant:n,draggable:i,disablePadding:i,slotProps:{collapseButton:{onClick:()=>{r(i?`docked`:`floating`)},collapsed:i}},children:(0,b.jsx)(c,{count:w.length,activeStep:e,onStepChange:({step:e})=>t(e),variant:i?`single`:void 0,floating:i,children:w.map((e,t)=>(0,b.jsx)(d,{index:t,children:(0,b.jsx)(l,{index:t,label:e.label,description:e.description,actions:(0,b.jsx)(u,{children:t===w.length-1?`Finish`:`Next`})})},t))})})},play:async({canvas:e,step:t})=>{function n(t){let n=e.getByRole(`button`,{name:new RegExp(t,`i`)});return S.click(n)}let r=async()=>{await S.click(e.getByLabelText(`Toggle panel`))};await t(`Iterate steps - Docked`,async()=>{await n(`Next`),await n(`Next`),await n(`Finish`)}),await t(`Go to first step`,async()=>{await n(`Project details`)}),await t(`Minimize panel`,async()=>{await r()}),await x(e.queryByText(/Enter project name/)).not.toBeInTheDocument(),await t(`Iterate steps - Floating`,async()=>{await n(`Next`),await n(`Next`),await n(`Finish`)}),await t(`Maximize panel`,async()=>{await r()}),await t(`Go to first step`,async()=>{await n(`Project details`)})}},k={parameters:{layout:`padded`},render:function(){return(0,b.jsx)(c,{count:T.length,orientation:`horizontal`,actions:(0,b.jsx)(u,{children:`Next`}),children:T.map((e,t)=>(0,b.jsx)(d,{index:t,children:(0,b.jsx)(l,{index:t,label:e.label,description:e.description})},t))})},play:async({canvas:e,step:t})=>{await t(`All steps visible`,async()=>{for(let t of T)await x(e.getByText(t.label)).toBeInTheDocument()}),await t(`Navigate through steps via Next button`,async()=>{let t=e.getByRole(`button`,{name:/next/i});await x(t).toBeInTheDocument(),await S.click(t);let n=e.getByText(`Select market`);await x(n.closest(`[aria-current="step"]`)).not.toBeNull()})}},A=[{label:`Project details`,description:`Configure the basic project settings`},{label:`Select market`,description:`Choose the target market for deployment`},{label:`Design policy`,description:`Define the design constraints and rules`}],j={parameters:{layout:`padded`},render:function(){return(0,b.jsx)(c,{count:A.length,orientation:`horizontal`,actions:(0,b.jsx)(u,{children:`Next`}),children:A.map((e,t)=>(0,b.jsx)(d,{index:t,children:(0,b.jsx)(l,{index:t,label:e.label,description:e.description})},t))})},play:async({canvas:e,step:t})=>{await t(`All steps visible`,async()=>{for(let t of A)await x(e.getByText(t.label)).toBeInTheDocument()}),await t(`Navigate all steps to completion`,async()=>{let t=e.getByRole(`button`,{name:/next/i});await S.click(t),await S.click(t),await S.click(t)})}},M=[{label:`Project details`},{label:`Select market`},{label:`Design policy`}],N={parameters:{layout:`padded`},render:function(){return(0,b.jsx)(c,{count:M.length,orientation:`horizontal`,actions:(0,b.jsx)(u,{children:`Next`}),children:M.map((e,t)=>(0,b.jsx)(d,{index:t,children:(0,b.jsx)(l,{index:t,label:e.label})},t))})},play:async({canvas:e,step:t})=>{await t(`All steps visible`,async()=>{for(let t of M)await x(e.getByText(t.label)).toBeInTheDocument()}),await t(`Navigate all steps to completion`,async()=>{let t=e.getByRole(`button`,{name:/next/i});await S.click(t),await S.click(t),await S.click(t)})}},P=[{label:`Upload files`,description:`Drag and drop or browse to upload`,icon:`upload`},{label:`Configure settings`,description:(0,b.jsxs)(`span`,{children:[`Adjust `,(0,b.jsx)(`strong`,{children:`network parameters`}),` for deployment`]}),icon:`settings`},{label:`Deploy`,description:`Review and launch the deployment`,icon:`rocket_launch`}],F={parameters:{layout:`padded`},render:function(){let[e,t]=(0,y.useState)(0);return(0,b.jsx)(c,{count:P.length,orientation:`horizontal`,activeStep:e,onStepChange:({step:e})=>t(e),actions:(0,b.jsx)(u,{variant:`ghost`,children:e===P.length-1?`Finish`:`Continue`}),children:P.map((e,t)=>(0,b.jsx)(d,{index:t,slots:{indicator:(0,b.jsx)(i,{icon:e.icon,size:`small`})},children:(0,b.jsx)(l,{index:t,label:e.label,description:e.description})},t))})},play:async({canvas:e,step:t})=>{await t(`All custom steps visible`,async()=>{for(let t of P)await x(e.getByText(t.label)).toBeInTheDocument()}),await t(`Custom icons rendered`,async()=>{await x(e.getByText(`upload`)).toBeInTheDocument(),await x(e.getByText(`settings`)).toBeInTheDocument(),await x(e.getByText(`rocket_launch`)).toBeInTheDocument()}),await t(`Navigate with custom button`,async()=>{let t=e.getByRole(`button`,{name:/continue/i});await x(t).toBeInTheDocument(),await S.click(t);let n=e.getByText(`Configure settings`);await x(n.closest(`[aria-current="step"]`)).not.toBeNull()}),await t(`Rich description rendered`,async()=>{let t=e.getByText(`network parameters`);await x(t.tagName).toBe(`STRONG`)})}},I={render:function(){let[e,t]=(0,y.useState)(0);return(0,b.jsx)(`div`,{style:{width:350},children:(0,b.jsxs)(c,{count:3,activeStep:e,onStepChange:({step:e})=>t(e),children:[(0,b.jsx)(d,{index:0,children:(0,b.jsx)(l,{index:0,label:`Project details`,description:`Enter project name and basic configuration`,actions:(0,b.jsx)(u,{children:`Next`})})}),(0,b.jsx)(d,{index:1,className:e===1?_.approveStep:void 0,slots:{indicator:(0,b.jsx)(i,{icon:`monitor_heart`,size:`small`})},slotProps:{indicator:{className:e===1?_.approveIcon:void 0}},children:(0,b.jsx)(l,{index:1,label:(0,b.jsx)(`span`,{className:e===1?_.approveTitle:void 0,children:`Verify health`}),description:`Confirm all services report healthy status`,actions:(0,b.jsx)(u,{className:e===1?_.approveButton:void 0,children:`Approve`})})}),(0,b.jsx)(d,{index:2,children:(0,b.jsx)(l,{index:2,label:`Design policy`,description:`Define the design constraints and rules`,actions:(0,b.jsx)(u,{children:`Finish`})})})]})})},play:async({canvas:e,step:t})=>{await t(`All steps visible`,async()=>{await x(e.getByText(`Project details`)).toBeInTheDocument(),await x(e.getByText(`Verify health`)).toBeInTheDocument(),await x(e.getByText(`Design policy`)).toBeInTheDocument()}),await t(`Default steps show numbers, custom step shows icon`,async()=>{await x(e.getByText(`1`)).toBeInTheDocument(),await x(e.getByText(`monitor_heart`)).toBeInTheDocument(),await x(e.getByText(`3`)).toBeInTheDocument()}),await t(`Navigate to custom step and verify approve action`,async()=>{let t=e.getByRole(`button`,{name:/next/i});await S.click(t),await x(e.getByRole(`button`,{name:/approve/i})).toBeInTheDocument()})}},L={render:function(){return(0,b.jsx)(`div`,{style:{width:350},children:(0,b.jsxs)(c,{count:4,children:[(0,b.jsx)(d,{index:0,children:(0,b.jsx)(l,{index:0,label:`Basic information`,description:`Enter your project details`,actions:(0,b.jsx)(u,{children:`Next`})})}),(0,b.jsx)(d,{index:1,disabled:!0,children:(0,b.jsx)(l,{index:1,label:`Advanced settings`,description:`Configure advanced options (requires approval)`,actions:(0,b.jsx)(u,{children:`Next`})})}),(0,b.jsx)(d,{index:2,children:(0,b.jsx)(l,{index:2,label:`Review`,description:`Review your configuration`,actions:(0,b.jsx)(u,{children:`Next`})})}),(0,b.jsx)(d,{index:3,disabled:!0,children:(0,b.jsx)(l,{index:3,label:`Deploy`,description:`Deploy to production (requires elevated permissions)`,actions:(0,b.jsx)(u,{children:`Finish`})})})]})})},play:async({canvas:e,step:t})=>{await t(`Disabled steps have data-disabled attribute`,async()=>{let t=e.getByText(`Advanced settings`).closest(`[data-disabled]`);await x(t).not.toBeNull();let n=e.getByText(`Deploy`).closest(`[data-disabled]`);await x(n).not.toBeNull()}),await t(`Enabled steps do not have data-disabled`,async()=>{let t=e.getByText(`Basic information`).closest(`[data-disabled]`);await x(t).toBeNull();let n=e.getByText(`Review`).closest(`[data-disabled]`);await x(n).toBeNull()}),await t(`Disabled completed step is not clickable`,async()=>{let t=e.getByRole(`button`,{name:/next/i});await S.click(t),await S.click(e.getByRole(`button`,{name:/next/i}));let n=e.getByText(`Advanced settings`);await x(n.closest(`button`)).toBeNull()})}},R={render:function(){return(0,b.jsx)(`div`,{style:{width:350},children:(0,b.jsxs)(c,{count:4,children:[(0,b.jsx)(d,{index:0,children:(0,b.jsx)(l,{index:0,label:`Configuration`,description:`Enter deployment configuration`,actions:(0,b.jsx)(u,{children:`Next`})})}),(0,b.jsx)(d,{index:1,variant:`error`,children:(0,b.jsx)(l,{index:1,label:`Validation`,description:`Configuration validation failed`,actions:(0,b.jsx)(u,{children:`Retry`})})}),(0,b.jsx)(d,{index:2,children:(0,b.jsx)(l,{index:2,label:`Review`,description:`Review and confirm changes`,actions:(0,b.jsx)(u,{children:`Next`})})}),(0,b.jsx)(d,{index:3,children:(0,b.jsx)(l,{index:3,label:`Complete`,description:`Finalize deployment`,actions:(0,b.jsx)(u,{children:`Finish`})})})]})})},play:async({canvas:e,step:t})=>{await t(`Error step shows close icon instead of number`,async()=>{await x(e.getByText(`close`)).toBeInTheDocument()}),await t(`Error step has data-error attribute`,async()=>{let t=e.getByText(`Validation`).closest(`[data-error]`);await x(t).not.toBeNull()}),await t(`Non-error steps do not have data-error`,async()=>{let t=e.getByText(`Configuration`).closest(`[data-error]`);await x(t).toBeNull()}),await t(`Navigate to error step and verify current state`,async()=>{let t=e.getByRole(`button`,{name:/next/i});await S.click(t);let n=e.getByText(`Validation`);await x(n.closest(`[data-current]`)).not.toBeNull(),await x(n.closest(`[data-error]`)).not.toBeNull()})}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
