...
- Type-safe filtering
`}}},args:{columns:Ve,data:He,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,onRowClick:Be()},decorators:[ue]},Q={name:`Toolbar — Filters Panel`,parameters:{docs:{source:{type:`code`},description:{story:`
...
`}}},render:function(e){let{columnFilters:t,filterChips:n,filterNavItems:r,enhancedColumns:i,handlers:o,renderFilterContent:c}=S({filterAdapters:q,baseColumns:e.columns}),[l,d]=(0,Y.useState)(!1),[p,m]=(0,Y.useState)(r[0]?.id||``),h=e=>{e&&!p&&r.length>0&&m(r[0]?.id||``),d(e)},g=e=>{e&&m(e)},_=()=>{o.applyFilters(),d(!1)},v=()=>{o.clearAll(),d(!1)},y=({item:e})=>(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(s,{variant:`body-sm-md`,className:T.filterTabLabel,children:e.label}),!!e.count&&(0,X.jsxs)(f,{direction:`row`,alignItems:`center`,gap:8,children:[(0,X.jsx)(`span`,{className:T.filterTabDot}),(0,X.jsx)(s,{variant:`body-sm-reg`,color:`secondary`,children:e.count})]})]});return(0,X.jsxs)(f,{direction:`column`,gap:16,flex:`1`,children:[(0,X.jsx)(f,{direction:`row`,justifyContent:`flex-end`,children:(0,X.jsx)(u,{variant:`secondary`,icon:`filter_list`,"aria-label":`Filter`,onClick:()=>d(!0)})}),n.length>0&&(0,X.jsx)(C,{items:n,onClearAll:v,onItemDelete:o.deleteChip}),(0,X.jsx)(b,{...e,columns:i,columnFilters:t}),(0,X.jsxs)(w,{className:T.filterModal,open:l,onOpenChange:h,children:[(0,X.jsxs)(w.Header,{className:T.filterHeader,children:[(0,X.jsxs)(f,{direction:`row`,alignItems:`center`,gap:8,children:[(0,X.jsx)(a,{icon:`filter_list`,size:`small`}),(0,X.jsx)(w.Title,{children:`Filters`})]}),(0,X.jsx)(w.CloseTrigger,{})]}),(0,X.jsx)(w.Body,{className:T.filterBody,children:(0,X.jsxs)(E,{className:T.filterTabs,value:p,onValueChange:g,children:[(0,X.jsx)(E.List,{className:T.filterTabList,children:r.map(e=>(0,X.jsx)(E.Tab,{value:e.id,disabled:e.disabled,children:(0,X.jsx)(y,{item:e})},e.id))}),r.map(e=>(0,X.jsx)(E.Content,{value:e.id,className:T.filterContent,children:c(e)},e.id))]})}),(0,X.jsxs)(w.Footer,{className:T.filterFooter,children:[(0,X.jsx)(u,{variant:`secondary`,icon:`close`,onClick:v,children:`Clear all`}),(0,X.jsx)(w.Actions,{children:(0,X.jsx)(u,{variant:`primary`,onClick:_,children:`Apply`})})]})]})]})}},$={name:`Toolbar — Controlled`,parameters:{docs:{source:{type:`code`},description:{story:`
...
`}}},render:function(e){let[t,n]=(0,Y.useState)({}),{columnFilters:r,filterChips:i,filterNavItems:o,enhancedColumns:c,handlers:l,renderFilterContent:d}=S({filterAdapters:q,baseColumns:e.columns,appliedFilters:t,onFiltersChange:n}),[p,m]=(0,Y.useState)(!1),[h,g]=(0,Y.useState)(o[0]?.id||``),_=e=>{e&&!h&&o.length>0&&g(o[0]?.id||``),m(e)},v=e=>{e&&g(e)},y=()=>{l.applyFilters(),m(!1)},x=()=>{l.clearAll(),m(!1)},ee=({item:e})=>(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(s,{variant:`body-sm-md`,className:T.filterTabLabel,children:e.label}),!!e.count&&(0,X.jsxs)(f,{direction:`row`,alignItems:`center`,gap:8,children:[(0,X.jsx)(`span`,{className:T.filterTabDot}),(0,X.jsx)(s,{variant:`body-sm-reg`,color:`secondary`,children:e.count})]})]});return(0,X.jsxs)(f,{direction:`column`,gap:16,flex:`1`,children:[(0,X.jsxs)(f,{className:T.debugPanel,direction:`column`,gap:8,children:[(0,X.jsx)(s,{variant:`body-sm-md`,children:`External Filter State (controlled):`}),(0,X.jsx)(`pre`,{className:T.debugCode,children:JSON.stringify(t,null,2)||`{}`})]}),(0,X.jsx)(f,{direction:`row`,justifyContent:`flex-end`,children:(0,X.jsx)(u,{variant:`secondary`,icon:`filter_list`,"aria-label":`Filter`,onClick:()=>m(!0)})}),i.length>0&&(0,X.jsx)(C,{items:i,onClearAll:x,onItemDelete:l.deleteChip}),(0,X.jsx)(b,{...e,columns:c,columnFilters:r}),(0,X.jsxs)(w,{className:T.filterModal,open:p,onOpenChange:_,children:[(0,X.jsxs)(w.Header,{className:T.filterHeader,children:[(0,X.jsxs)(f,{direction:`row`,alignItems:`center`,gap:8,children:[(0,X.jsx)(a,{icon:`filter_list`,size:`small`}),(0,X.jsx)(w.Title,{children:`Filters`})]}),(0,X.jsx)(w.CloseTrigger,{})]}),(0,X.jsx)(w.Body,{className:T.filterBody,children:(0,X.jsxs)(E,{className:T.filterTabs,value:h,onValueChange:v,children:[(0,X.jsx)(E.List,{className:T.filterTabList,children:o.map(e=>(0,X.jsx)(E.Tab,{value:e.id,disabled:e.disabled,children:(0,X.jsx)(ee,{item:e})},e.id))}),o.map(e=>(0,X.jsx)(E.Content,{value:e.id,className:T.filterContent,children:d(e)},e.id))]})}),(0,X.jsxs)(w.Footer,{className:T.filterFooter,children:[(0,X.jsx)(u,{variant:`secondary`,icon:`close`,onClick:x,children:`Clear all`}),(0,X.jsx)(w.Actions,{children:(0,X.jsx)(u,{variant:`primary`,onClick:y,children:`Apply`})})]})]})]})}},We=[`FiltersPanel`,`Controlled`],Q.parameters={...Q.parameters,docs:{...Q.parameters?.docs,source:{originalSource:`{
...
}`,...$.parameters?.docs?.source}}}})))()}Ge();export{$ as Controlled,Q as FiltersPanel,We as __namedExportsOrder,Ue as default};