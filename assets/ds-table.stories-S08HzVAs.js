import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{n,t as r}from"./ds-button-v3-BnV8s8Ko.js";import{n as i,t as a}from"./ds-stack-GU0hZWeR.js";import{n as o,t as s}from"./ds-table-BI2o0ZVf.js";import{i as c,n as l,r as u,t as d}from"./story-decorators-B0BgvTCA.js";import{n as f,r as p,t as m}from"./story-data-DABjxFNS.js";import{n as h,t as g}from"./components-AajuQmct.js";var _,v,y,b,x,S,C,w,T,E;e((()=>{o(),i(),n(),p(),l(),g(),c(),_=t(),{fn:v}=__STORYBOOK_MODULE_TEST__,y=[{accessorKey:`firstName`,header:`First Name`,cell:e=>e.getValue(),size:250},{accessorKey:`lastName`,header:`Last Name`,cell:e=>e.getValue(),size:250},{accessorKey:`age`,header:`Age (years)`,cell:e=>e.getValue(),size:200},{accessorKey:`visits`,header:`Number of Visits`,cell:e=>e.getValue(),size:250},{accessorKey:`status`,header:`Relationship Status`,cell:e=>e.getValue(),size:250},{accessorKey:`progress`,header:`Profile Progress`,cell:e=>`${String(e.getValue())}%`,size:250}],b={title:`Components/Table`,component:s,parameters:{layout:`fullscreen`},args:{columns:m,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:(0,_.jsx)(h,{}),onRowClick:v()},decorators:[d]},x={args:{data:f}},S={args:{data:f,controls:(0,_.jsxs)(a,{direction:`row`,justifyContent:`space-between`,alignItems:`center`,width:`100%`,children:[(0,_.jsx)(r,{variant:`secondary`,size:`small`,children:`RED version V2`}),(0,_.jsxs)(a,{direction:`row`,gap:8,alignItems:`center`,children:[(0,_.jsx)(r,{variant:`secondary`,size:`small`,children:`Import RED`}),(0,_.jsx)(r,{variant:`secondary`,size:`small`,children:`Export RED`}),(0,_.jsx)(r,{size:`small`,children:`Actions`})]})]})}},C={args:{data:[]}},w={args:{data:f,bordered:!1}},T={parameters:{docs:{description:{story:`When columns are wider than the container, the body and header scroll horizontally together while only the body scrolls vertically. The scrollbars are thin and become visible on hover.`}}},decorators:[e=>(0,_.jsx)(`div`,{className:u.horizontalScrollWrapper,children:(0,_.jsx)(e,{})})],args:{data:f,columns:y}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    data: defaultData
  }
