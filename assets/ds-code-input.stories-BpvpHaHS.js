import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{n}from"./iframe-CjiQ0Gqr.js";import{n as r,t as i}from"./ds-tooltip-BA0Zk8-B.js";import{n as a,t as o}from"./ds-button-v3-JsnnMoG0.js";import{n as s,t as c}from"./ds-code-input-C-rvqZH5.js";var l;function u(){return(u=e((()=>{l=[`small`,`default`,`large`]})))()}var d,f,p,m,h,g,_,v,y,b,x,S,C,w;function T(){return(T=e((()=>{d=t(),a(),i(),c(),u(),f=n(),p={title:`Components/CodeInput`,component:s,parameters:{layout:`padded`,docs:{source:{type:`dynamic`}}},argTypes:{size:{control:`select`,options:l},locale:{table:{disable:!0}},slots:{table:{disable:!0}},className:{table:{disable:!0}},style:{table:{disable:!0}},ref:{table:{disable:!0}}}},m={args:{placeholder:`Enter query`}},h={args:{defaultValue:`Status = Active AND trigger = Scheduled
