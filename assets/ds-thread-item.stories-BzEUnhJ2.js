import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./iframe-ftOD7I-v.js";import{r as n,t as r}from"./ds-thread-item-DqqTWSs5.js";var i,a,o,s,c,l,u,d,f,p;e((()=>{r(),i=t(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Components/Comments/ThreadItem`,component:n,parameters:{layout:`padded`},argTypes:{isCommentAuthorMessage:{control:`boolean`},canModify:{control:`boolean`},content:{control:`text`},className:{table:{disable:!0}}},args:{id:`msg-1`,author:{id:`user-1`,name:`Karen J.`,avatarSrc:`https://i.pravatar.cc/150?img=1`},content:`This is a sample message in the comment thread.`,createdAt:new Date(`2026-02-09T09:00:00Z`),isCommentAuthorMessage:!0,canModify:!0,onEdit:a(),onDelete:a(),onMarkUnread:a(),onResolved:a()}},s={args:{isCommentAuthorMessage:!0}},c={args:{id:`msg-2`,isCommentAuthorMessage:!1,content:`This is my reply, so it appears aligned to the right.`}},l={args:{id:`msg-3`,content:`I think we should consider adjusting the timeline to ensure we have enough resources for the development phase. This will help us maintain quality standards and meet all the project requirements.`}},u={args:{id:`msg-4`,content:`Line 1: First line of the message
...
}`,...f.parameters?.docs?.source},description:{story:"A read-only message: without `canModify` and action callbacks, neither the\nmore-actions menu nor the resolve control is rendered.",...f.parameters?.docs?.description}}}}))();export{c as CurrentUserMessage,s as Default,l as LongMessage,u as MultilineMessage,d as NoAvatar,f as ReadOnly,p as __namedExportsOrder,o as default};