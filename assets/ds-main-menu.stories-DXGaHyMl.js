import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{n}from"./iframe-B-V3ECTD.js";import{n as r,t as i}from"./ds-icon-DjXeQnOZ.js";import{t as ee}from"./ds-avatar-CQeY14j3.js";import{n as a,t as o}from"./ds-typography-BdYyq7Aq.js";import{n as te,t as ne}from"./ds-button-v3-CJRyeMUp.js";import{t as re}from"./ds-avatar-CAHFjxrA.js";import{n as s,t as ie}from"./ds-button-CoRWvHgA.js";import{i as ae,n as oe}from"./ds-popover.types-Bd9MSBGn.js";import{t as c}from"./ds-popover-GO6-dwW7.js";import{n as l,t as u}from"./ds-workspace-layout-BIXVWcBA.js";import{_ as d,a as f,b as p,c as m,d as h,f as g,g as _,h as v,i as se,l as ce,m as le,n as ue,o as de,p as fe,r as pe,s as me,t as he,u as ge,y}from"./sample-menu-icons-Be-1_tdx.js";function b(){return(b=e((()=>{l()})))()}var x,S,C,w,T,E,D,O,k,A,j,M,N;function P(){return(P=e((()=>{x=`_popoverContent_1b2q2_1`,S=`_statesHint_1b2q2_14`,C=`_sidebarDemo_1b2q2_21`,w=`_sidebar_1b2q2_21`,T=`_anchorPoint_1b2q2_39`,E=`_anchorLabel_1b2q2_49`,D=`_appHeader_1b2q2_55`,O=`_appHeaderLeft_1b2q2_63`,k=`_appHeaderBrand_1b2q2_70`,A=`_appHeaderSeparator_1b2q2_75`,j=`_appHeaderApp_1b2q2_82`,M=`_appStage_1b2q2_87`,N={popoverContent:x,statesHint:S,sidebarDemo:C,sidebar:w,anchorPoint:T,anchorLabel:E,appHeader:D,appHeaderLeft:O,appHeaderBrand:k,appHeaderSeparator:A,appHeaderApp:j,appStage:M}})))()}var F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{F=t(),re(),ie(),te(),i(),o(),b(),c(),_(),y(),v(),P(),I=n(),L=[{id:`network-visibility`,label:`Network visibility`,icon:`visibility`},{id:`planning`,label:`Planning`,icon:`account_tree`},{id:`configurations`,label:`Configurations`,icon:`tune`},{id:`deployments`,label:`Deployments`,icon:`rocket_launch`},{id:`workflows`,label:`Workflows`,icon:`route`},{id:`packages`,label:`Packages`,icon:`special-packages`},{id:`operations-ai`,label:`AI Ops`,icon:`psychology`},{id:`resource-allocation`,label:`Resource allocation`,icon:`dashboard_customize`},{id:`triggers`,label:`Triggers`,icon:`bolt`},{id:`referential-data`,label:`Referential data`,icon:`table_rows`}],R=[{id:`help-support`,label:`Help & Support`,icon:`contact_support`},{id:`knowledge-center`,label:`Knowledge Center`,icon:`local_library`}],z=[{id:`my-dashboard`,label:`My dashboard`,icon:me},{id:`network-view`,label:`Network view`,icon:ce},{id:`inventory`,label:`Inventory`,icon:de},{id:`network-planning`,label:`Network planning`,icon:m},{id:`configurations`,label:`Configurations`,icon:f},{id:`workflow-automation`,label:`Workflow automation`,icon:le},{id:`software-images`,label:`Software images`,icon:h},{id:`tasks`,label:`Tasks`,icon:g},{id:`backup-files`,label:`Backup files`,icon:pe},{id:`ai-ops`,label:`AI-Ops`,icon:ue},{id:`break-glass`,label:`Break glass`,icon:se},{id:`administration`,label:`Administration`,icon:he},{id:`observability`,label:`Observability`,icon:ge},{id:`technician`,label:`Technician`,icon:fe}],B={title:`Components/MainMenu`,component:d,parameters:{layout:`centered`},args:{variant:`compact`,items:L,utilityLinks:R,side:`bottom`,align:`start`,gutter:8,"aria-label":`Main menu`},argTypes:{variant:{control:`inline-radio`,options:p},side:{control:`select`,options:ae},align:{control:`select`,options:oe},gutter:{control:{type:`number`,min:0,step:1}},selectedId:{control:`select`,options:L.map(e=>e.id)},"aria-label":{control:`text`},items:{table:{disable:!0}},utilityLinks:{table:{disable:!0}},trigger:{table:{disable:!0}},getAnchorElement:{table:{disable:!0}},onItemSelect:{table:{disable:!0}},onOpenChange:{table:{disable:!0}},open:{table:{disable:!0}},className:{table:{disable:!0}},style:{table:{disable:!0}},ref:{table:{disable:!0}}},render:e=>(0,I.jsx)(d,{...e,trigger:e.trigger??(0,I.jsxs)(s,{schema:`secondary`,children:[(0,I.jsx)(r,{icon:`apps`}),` Open main menu`]})})},V={args:{variant:`compact`,selectedId:`network-visibility`,items:[{id:`network-visibility`,label:`Network visibility`,icon:`visibility`,description:`Monitor live topology, health, and traffic across the fabric.`},{id:`planning`,label:`Planning`,icon:`account_tree`,description:`Model capacity and design topology changes before rollout.`},{id:`configurations`,label:`Configurations`,icon:`tune`,description:`Manage device settings, templates, and intended state.`},{id:`deployments`,label:`Deployments`,icon:`rocket_launch`,description:`Roll out software images and track deployment progress.`},{id:`workflows`,label:`Workflows`,icon:`route`,description:`Automate multi-step operational tasks end to end.`},{id:`packages`,label:`Packages`,icon:`special-packages`,description:`Browse and install optional platform capabilities.`}],utilityLinks:[{id:`help-support`,label:`Help & Support`,icon:`contact_support`},{id:`knowledge-center`,label:`Knowledge Center`,icon:`local_library`}]}},H={args:{items:L,utilityLinks:R,selectedId:`packages`}},U={parameters:{docs:{source:{type:`code`}}},render:e=>{let[t,n]=(0,F.useState)(`planning`);return(0,I.jsx)(d,{...e,trigger:e.trigger??(0,I.jsxs)(s,{schema:`secondary`,children:[(0,I.jsx)(r,{icon:`apps`}),` Open main menu`]}),items:L,utilityLinks:R,selectedId:t,onItemSelect:e=>{let t=L.find(t=>t.id===e);t?.state!==`disabled`&&t?.state!==`comingSoon`&&n(e)}})}},W={args:{items:[{id:`available`,label:`My Dashboard`,icon:`speed`},{id:`disabled`,label:`My Dashboard`,icon:`speed`,state:`disabled`},{id:`coming-soon`,label:`My Dashboard`,icon:`speed`,state:`comingSoon`}],utilityLinks:[]}},G={args:{items:[{id:`regular`,label:`My Dashboard`,icon:`speed`},{id:`selected`,label:`My Dashboard`,icon:`speed`}],selectedId:`selected`,utilityLinks:[]}},K={args:{items:[{id:`dashboard`,label:`My dashboard`,icon:`speed`,href:`/dashboard`},{id:`inventory`,label:`Inventory`,icon:`inventory_2`,href:`/inventory`},{id:`planning`,label:`Network planning`,icon:`account_tree`,href:`/planning`}],utilityLinks:[{id:`help`,label:`Help & Support`,icon:`contact_support`,href:`/help`},{id:`docs`,label:`Knowledge Center`,icon:`local_library`,href:`/docs`}]}},q={args:{trigger:(0,I.jsx)(s,{variant:`borderless`,"aria-label":`Open applications`,children:(0,I.jsx)(r,{icon:`apps`})}),items:L,utilityLinks:R,selectedId:`network-visibility`}},J={args:{items:z,utilityLinks:R,selectedId:`my-dashboard`}},Y={name:`Custom anchor (sidebar trigger)`,parameters:{docs:{source:{type:`code`}}},render:e=>{let t=(0,F.useRef)(null);return(0,I.jsxs)(`div`,{className:N.sidebarDemo,children:[(0,I.jsx)(`div`,{className:N.sidebar,children:(0,I.jsx)(d,{...e,trigger:e.trigger??(0,I.jsx)(s,{variant:`borderless`,"aria-label":`Open applications`,children:(0,I.jsx)(r,{icon:`apps`})}),items:L,utilityLinks:R,selectedId:`network-visibility`,side:`right`,align:`start`,getAnchorElement:()=>t.current})}),(0,I.jsx)(`div`,{className:N.anchorPoint,ref:t,children:(0,I.jsx)(`p`,{className:N.anchorLabel,children:`Panel anchors here, not to the sidebar trigger.`})})]})}},X={name:`App switching in workspace header`,parameters:{layout:`fullscreen`,docs:{source:{type:`code`}}},render:e=>{let[t,n]=(0,F.useState)(`my-dashboard`),r=z.find(e=>e.id===t);return(0,I.jsxs)(u,{children:[(0,I.jsx)(u.Header,{children:(0,I.jsxs)(`div`,{className:N.appHeader,children:[(0,I.jsxs)(`div`,{className:N.appHeaderLeft,children:[(0,I.jsx)(d,{...e,trigger:e.trigger??(0,I.jsx)(ne,{color:`light`,variant:`tertiary`,icon:`apps`,"aria-label":`Switch application`}),items:z,utilityLinks:R,selectedId:t,onItemSelect:e=>n(e)}),(0,I.jsx)(a,{variant:`body-md-semi-bold`,className:N.appHeaderBrand,children:`DriveNets Cloud`}),(0,I.jsx)(`span`,{className:N.appHeaderSeparator,"aria-hidden":`true`}),(0,I.jsx)(a,{variant:`body-md-reg`,className:N.appHeaderApp,children:r?.label})]}),(0,I.jsx)(ee,{name:`Ada Lovelace`,size:`sm`})]})}),(0,I.jsx)(u.Content,{children:(0,I.jsxs)(`div`,{className:N.appStage,children:[(0,I.jsx)(a,{variant:`heading2`,children:r?.label}),(0,I.jsx)(a,{variant:`body-md-reg`,color:`secondary`,children:`Open the app switcher in the header to move between applications. The selected app is tracked with local component state — no router involved.`})]})})]})}},Z={name:`Expanded variant`,args:{variant:`expanded`,items:[{id:`my-dashboard`,label:`My dashboard`,icon:`speed`,description:`Track and complete your personal or assigned network tasks.`},{id:`inventory`,label:`Inventory`,icon:`inventory_2`,description:`Browse every managed device, port, and license in one place.`},{id:`planning`,label:`Network planning`,icon:`account_tree`,description:`Model capacity and design topology changes before rollout.`,state:`extend`},{id:`ai-ops`,label:`AI Ops`,icon:`psychology`,description:`Automated anomaly detection and remediation across the fabric.`,state:`comingSoon`},{id:`break-glass`,label:`Break glass`,icon:`lock`,description:`Emergency privileged access — restricted to authorized operators.`,state:`disabled`}],utilityLinks:R,selectedId:`my-dashboard`}},Q=[`Default`,`WithSelection`,`ControlledSelection`,`ItemStates`,`TileInteractionStates`,`WithHrefLinks`,`TriggerIcon`,`WithSvgIcons`,`CustomAnchor`,`InWorkspaceHeader`,`Expanded`],V.parameters={...V.parameters,docs:{...V.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'compact',
