...
}`,...b.parameters?.docs?.source},description:{story:`The select utility column is 36px by default. Pass a pixel width when the
checkbox column needs more (or less) room. It is not user-resizable.`,...b.parameters?.docs?.description}}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    selectable: true,
...
}`,...S.parameters?.docs?.source}}},C=[`Selectable`,`CustomSelectColumnWidth`,`ProgrammaticRowSelection`,`MaxSelectionLimit`]}))();export{b as CustomSelectColumnWidth,S as MaxSelectionLimit,x as ProgrammaticRowSelection,y as Selectable,C as __namedExportsOrder,v as default};