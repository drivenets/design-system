...
}`,...f.parameters?.docs?.source},description:{story:"A read-only message: without `canModify` and action callbacks, neither the\nmore-actions menu nor the resolve control is rendered.",...f.parameters?.docs?.description}}}})))()}m();export{c as CurrentUserMessage,s as Default,l as LongMessage,u as MultilineMessage,d as NoAvatar,f as ReadOnly,p as __namedExportsOrder,o as default};