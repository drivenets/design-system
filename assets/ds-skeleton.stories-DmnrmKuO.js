import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./jsx-runtime-6sF1Ejqi.js";import{t as r}from"./classnames-Ce489xFf.js";import{a as i,i as a,n as o,o as s,r as ee,s as c,t as te}from"./core-table-BMV7-4xZ.js";var l=t((()=>{})),u,ne,d,f=t((()=>{u=Object.freeze({xsm:24,sm:32,regular:40,md:48,lg:64,xl:80}),ne=Object.freeze({"body-md-reg":20,"body-md-md":20,"body-md-semi-bold":20,"body-md-bold":20,"body-md-link":20,"body-sm-reg":18,"body-sm-md":18,"body-sm-semi-bold":18,"body-sm-bold":18,"body-sm-link":18,"body-xs-reg":16,"body-xs-md":16,"body-xs-semi-bold":16,"body-xs-bold":16,"body-xs-link":16,"code-sm-reg":18,"code-sm-semi-bold":18,"code-xs-reg":16,"code-xs-semi-bold":16,heading1:64,heading2:54,heading3:48,heading4:36}),d=Object.freeze({default:4,round:999})})),re,ie,ae,p,m,h,oe,se,g,_=t((()=>{re=`_skeleton_109kt_1`,ie=`_shimmer_109kt_1`,ae=`_gray_109kt_5`,p=`_blue_109kt_12`,m=`_text_109kt_19`,h=`_circle_109kt_27`,oe=`_rectangle_109kt_33`,se=`_container_109kt_38`,g={skeleton:re,shimmer:ie,gray:ae,blue:p,text:m,circle:h,rectangle:oe,container:se}})),ce,v,y,le=t((()=>{ce=e(r(),1),f(),_(),v=n(),y=({typographyVariant:e=`body-sm-reg`,color:t=`gray`,lines:n=1,width:r,radius:i=`default`,className:a,style:o})=>{let s=ne[e],ee=typeof i==`number`?i:d[i],c=()=>r===void 0?`100%`:r,te=(0,ce.default)(g.skeleton,g.text,g[t],a),l=e=>({height:s,width:typeof e==`number`?String(e)+`px`:e,borderRadius:ee,...o});return(0,v.jsx)(`div`,{"aria-hidden":`true`,className:g.container,style:{gap:8},children:Array.from({length:n},(e,t)=>(0,v.jsx)(`span`,{className:te,style:l(c())},t))})},y.__docgenInfo={description:`Text skeleton component - matches typography variants
