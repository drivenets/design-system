import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as x}from"./iframe-CGGjNMjR.js";import{D as u}from"./ds-table-Cl-kf5Gj.js";import{s}from"./ds-table.stories.module-D_XXzStM.js";import{f as C,d as B,c as y,T as f}from"./table-empty-state-iuBItltW.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BU6HzYRM.js";import"./core-table-KyV8_L50.js";import"./ds-button-BvwC3m_h.js";import"./ds-button-legacy-B4kSa0va.js";import"./ds-button-new-k4MPD8CK.js";import"./ds-icon-CYraW5MQ.js";import"./ds-typography-D1d_tkKE.js";import"./index-BXtjBT7w.js";import"./index-C8mRU91X.js";import"./ds-checkbox-BwSKqZb4.js";import"./index-C80X-AiS.js";import"./index-DOtHtDFZ.js";import"./index-iNqQI7lY.js";import"./index-BfJr26sH.js";import"./ds-dropdown-menu-OGlWPlvp.js";import"./index-Civv2OAz.js";import"./Combination-DnBaH9sV.js";import"./index-RETZV8XA.js";import"./floating-ui.dom-o9At5h4Q.js";import"./index-DMEEM2jR.js";import"./ds-text-input-Hy1yGyl3.js";import"./portal-Dxlc7cae.js";import"./create-split-props-u5h9OPvL.js";import"./use-locale-context-C1QBP0lU.js";import"./create-anatomy-DFAzjSBd.js";import"./use-presence-BVKYsvpg.js";import"./set-BLgBqO30.js";import"./raf-CC9hSMXO.js";import"./computed-style-C-r8F6Ni.js";import"./event-CBXSxTbR.js";import"./index-C4SCQYD1.js";import"./get-styles-BHXI4ZJN.js";import"./typeahead-fZo3XsZw.js";import"./query-CjgVAlRR.js";import"./initial-focus-vEwgSQa0.js";import"./equal-DfFTejAs.js";import"./mutation-observer-Cu1ou0At.js";import"./dismissable-layer-DibUIKXE.js";import"./navigate-C8UxtyHa.js";import"./merge-refs-DX9dreSa.js";const{expect:n,fn:g,userEvent:m}=__STORYBOOK_MODULE_TEST__,ge={title:"Design System/Table/Selection",component:u,parameters:{layout:"fullscreen"},args:{columns:y,data:B,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:t.jsx(f,{}),onRowClick:e=>console.log("Row clicked:",e)},decorators:[C]},h={args:{selectable:!0,onSelectionChange:g()},play:async({args:e,canvas:l})=>{const o=l.getAllByRole("checkbox"),a=o[0];await n(a).not.toBeChecked();const c=o[1];await m.click(c),await n(c).toBeChecked(),await n(e.onSelectionChange).toHaveBeenCalled(),await m.click(a);const i=l.getAllByRole("checkbox").slice(1);for(const r of i)await n(r).toBeChecked();await m.click(a);const d=l.getAllByRole("checkbox").slice(1);for(const r of d)await n(r).not.toBeChecked()}},w={args:{selectable:!0,showSelectAllCheckbox:!1,stickyHeader:!0,onSelectionChange:e=>console.log("Selected rows:",e)},render:function(l){const o=x.useRef(null),[a,c]=x.useState([]),i=p=>{o.current?.selectRow(p)},d=()=>{o.current?.selectAllRows()},r=()=>{o.current?.deselectAllRows()},k=()=>{o.current?.selectRows(["1","2","3"])},S=p=>{const R=Object.keys(p);c(R)};return t.jsxs("div",{children:[t.jsxs("div",{className:s.programmaticSelectionDemo,children:[t.jsx("h4",{className:s.programmaticSelectionDemo__title,children:"Programmatic Row Selection Demo"}),t.jsx("p",{className:s.programmaticSelectionDemo__description,children:"Use the buttons below to programmatically control row selection using TanStack Table v8 APIs."}),t.jsxs("p",{className:s.programmaticSelectionDemo__selectedRows,children:["Selected rows: ",a.length>0?a.join(", "):"None"]})]}),t.jsxs("div",{className:s.programmaticSelectionControls,children:[t.jsx("button",{onClick:()=>i("1"),className:s.programmaticSelectionButton,children:"Select Row 1"}),t.jsx("button",{onClick:()=>i("2"),className:s.programmaticSelectionButton,children:"Select Row 2"}),t.jsx("button",{onClick:()=>i("3"),className:s.programmaticSelectionButton,children:"Select Row 3"}),t.jsx("button",{onClick:d,className:s.programmaticSelectionButton,children:"Select All"}),t.jsx("button",{onClick:r,className:s.programmaticSelectionButton,children:"Deselect All"}),t.jsx("button",{onClick:k,className:s.programmaticSelectionButton,children:"Select First 3 Rows"})]}),t.jsx(u,{...l,ref:o,onSelectionChange:S})]})},play:async({canvas:e})=>{await n(e.getByText(/selected rows: none/i)).toBeInTheDocument(),await m.click(e.getByRole("button",{name:/select row 1/i})),await n(e.getByText((c,i)=>i?.textContent==="Selected rows: 1")).toBeInTheDocument(),await m.click(e.getByRole("button",{name:/^select all$/i}));const l=e.getAllByRole("checkbox");for(const c of l)await n(c).toBeChecked();await m.click(e.getByRole("button",{name:/deselect all/i})),await n(e.getByText(/selected rows: none/i)).toBeInTheDocument(),await m.click(e.getByRole("button",{name:/select first 3 rows/i}));const a=e.getAllByRole("checkbox").filter(c=>c.checked||c.getAttribute("data-state")==="checked").length;await n(a).toBe(3)}},b={name:"Max N Selections",args:{showSelectAllCheckbox:!1,onSelectionChange:g()},render:function(l){const[o,a]=x.useState({}),c=2,i=Object.keys(o).filter(r=>o[r]).length,d=r=>{a(r),l.onSelectionChange?.(r)};return t.jsxs("div",{children:[t.jsxs("div",{className:s.programmaticSelectionDemo,children:[t.jsx("h4",{className:s.programmaticSelectionDemo__title,children:"Max Selection Limit Demo"}),t.jsxs("p",{className:s.programmaticSelectionDemo__description,children:["You can select at most ",c," rows. Once the limit is reached, checkboxes for other rows are disabled."]}),t.jsxs("p",{className:s.programmaticSelectionDemo__selectedRows,children:["Selected: ",i," / ",c]})]}),t.jsx(u,{...l,onSelectionChange:d,selectable:r=>o[r.id]||i<c})]})},play:async({canvas:e})=>{await n(e.getByText(/selected: 0 \/ 2/i)).toBeInTheDocument();const l=e.getAllByRole("checkbox"),o=l[0],a=l[1],c=l[2];await m.click(o),await n(e.getByText(/selected: 1 \/ 2/i)).toBeInTheDocument(),await m.click(a),await n(e.getByText(/selected: 2 \/ 2/i)).toBeInTheDocument(),await n(c).toBeDisabled(),await m.click(o),await n(e.getByText(/selected: 1 \/ 2/i)).toBeInTheDocument();const i=e.getAllByRole("checkbox")[2];await n(i).not.toBeDisabled()}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    selectable: true,
...
}`,...b.parameters?.docs?.source}}};const ke=["Selectable","ProgrammaticRowSelection","MaxSelectionLimit"];export{b as MaxSelectionLimit,w as ProgrammaticRowSelection,h as Selectable,ke as __namedExportsOrder,ge as default};
