import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Z as n,k as r}from"./iframe-BzOV0upS.js";import{t as i}from"./classnames-Dm_LJ4P4.js";import{t as a}from"./ds-icon-Bd3a-dGJ.js";import{t as o}from"./ds-icon-D-gBnQXK.js";import{n as s,t as c}from"./ds-button-Xbf9y1fs.js";import{a as l,c as u,i as d,l as f,n as p,o as m,r as h,s as g,t as _}from"./dist-ChkFjSSo.js";var v,y,b,x,S,C,w=e((()=>{v=`_overlay_cw3f2_45`,y=`_dialog_cw3f2_52`,b=`_title_cw3f2_80`,x=`_description_cw3f2_91`,S=`_customPlacement_cw3f2_102`,C={overlay:v,dialog:y,title:b,description:x,customPlacement:S}})),T,E,D,O=e((()=>{f(),p(),T=t(i(),1),w(),E=r(),D=({open:e,onOpenChange:t,title:n,hideTitle:r,description:i,hideDescription:a,children:o,className:s,anchorRef:c,customPosition:f,modal:p=!0})=>{let v={};if(f)v={position:`fixed`,...f};else if(c?.current){let e=c.current.getBoundingClientRect();v={position:`fixed`,top:e.bottom,left:e.left}}return(0,E.jsx)(g,{open:e,onOpenChange:t,children:(0,E.jsxs)(m,{children:[p&&(0,E.jsx)(l,{className:C.overlay}),(0,E.jsxs)(h,{className:(0,T.default)(C.dialog,s,{[C.customPlacement]:f||c}),style:f||c?v:void 0,children:[(0,E.jsx)(u,{asChild:!0,children:r?(0,E.jsx)(_,{children:(0,E.jsx)(u,{className:C.title,children:n})}):(0,E.jsx)(u,{className:C.title,children:n})}),i&&(0,E.jsx)(d,{asChild:!0,children:a?(0,E.jsx)(_,{children:(0,E.jsx)(d,{className:C.description,children:i})}):(0,E.jsx)(d,{className:C.description,children:i})}),o]})]})})},D.displayName=`DsDialog`,D.__docgenInfo={description:``,methods:[],displayName:`DsDialog`,props:{open:{required:!0,tsType:{name:`boolean`},description:`Controls whether the dialog is open.`},onOpenChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(open: boolean) => void`,signature:{arguments:[{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:`Callback fired when the open state should change.`},title:{required:!0,tsType:{name:`string`},description:`The accessible title for the dialog. Required for accessibility.`},hideTitle:{required:!1,tsType:{name:`boolean`},description:`If true, the dialog title will be visually hidden but accessible to screen readers.`},description:{required:!1,tsType:{name:`string`},description:`The accessible description for the dialog. Optional, but recommended for accessibility.`},hideDescription:{required:!1,tsType:{name:`boolean`},description:`If true, the dialog description will be visually hidden but accessible to screen readers.`},children:{required:!0,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:`The content to render inside the dialog.`},className:{required:!1,tsType:{name:`string`},description:`Additional CSS class names for the dialog container.`},anchorRef:{required:!1,tsType:{name:`ReactRefObject`,raw:`React.RefObject<HTMLElement>`,elements:[{name:`HTMLElement`}]},description:`Ref to the element the dialog should be anchored to (for relative placement)`},customPosition:{required:!1,tsType:{name:`signature`,type:`object`,raw:`{
	/**
