...
`}));function Xe(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,hr:`hr`,p:`p`,strong:`strong`,...s(),...e.components};return(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(t.h1,{id:`file-upload`,children:`File Upload`}),`
...
`,(0,$.jsx)(a,{children:(0,$.jsx)(r,{name:`Default`})}),`
`,(0,$.jsx)(t.h2,{id:`example-fileuploadadapter`,children:`Example FileUploadAdapter`}),`
`,(0,$.jsx)(o,{code:Je,language:`ts`,dark:!0})]})}function Ze(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,$.jsx)(t,{...e,children:(0,$.jsx)(Xe,{...e})}):Xe(e)}var $,Qe=e((()=>{$=c(),S(),i(),qe(),Ye()})),$e,et,tt,nt,rt,it,at,ot,st,ct,lt,ut,dt,ft;e((()=>{y(),Ue(),ze(),Ge(),De(),Qe(),$e=c(),{fn:et}=__STORYBOOK_MODULE_TEST__,tt={title:`Components/FileUpload`,component:He,parameters:{layout:`centered`,docs:{page:Ze,source:{code:`
