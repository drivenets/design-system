...
`,r.jsx(_t,{code:La,language:"ts",dark:!0})]})}function za(e={}){const{wrapper:t}={...Ne(),...e.components};return t?r.jsx(t,{...e,children:r.jsx(ze,{...e})}):ze(e)}const{expect:F,fn:Z,userEvent:q,waitFor:M,within:ue}=__STORYBOOK_MODULE_TEST__,xi={title:"Design System/FileUpload",component:Qe,parameters:{layout:"centered",docs:{page:za,source:{code:`
...
Demonstrates upload cancellation functionality`,...ie.parameters?.docs?.description}}};const hi=["Default","Manual","Compact","Disabled","UploadError","UploadInterrupted","MaxFiles","DuplicateFiles","CancelUpload"];export{ie as CancelUpload,se as Compact,K as Default,Q as Disabled,ae as DuplicateFiles,J as Manual,de as MaxFiles,ee as UploadError,te as UploadInterrupted,hi as __namedExportsOrder,xi as default};
