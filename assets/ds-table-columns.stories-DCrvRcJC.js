import{a as e,n as t}from"./chunk-BneVvdWh.js";import{S as n}from"./iframe-Cg3ONfEQ.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{t as i}from"./classnames-DN2IqHsz.js";import{r as a}from"./ds-checkbox.types-mrDAHkUT.js";import{t as o}from"./ds-checkbox-HHT2Fv-n.js";import{n as s,t as c}from"./ds-table-D5_iMktW.js";import{n as l,t as u}from"./ds-table.stories.module-aibWCt8_.js";import{a as d,c as f,i as p,l as m,n as h,o as g,s as _,t as v}from"./components-Ckbgkzu5.js";var y,b,x,S,C,w,T;t((()=>{y=e(n(),1),b=e(i(),1),o(),s(),l(),m(),g(),v(),x=r(),S={title:`Components/Table/Columns`,component:c,parameters:{layout:`fullscreen`},args:{columns:_,data:f,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:(0,x.jsx)(h,{}),onRowClick:e=>console.log(`Row clicked:`,e)},decorators:[d]},C={name:`Progress as Infographic`,args:{columns:_.map(e=>`accessorKey`in e&&e.accessorKey===`progress`?{...e,header:`Profile Progress`,cell:e=>(0,x.jsx)(p,{value:e.getValue()})}:`accessorKey`in e&&e.accessorKey===`status`?{...e,header:`Status`,cell:e=>(0,x.jsx)(`span`,{className:(0,b.default)(u.statusCell,u[`statusCell--${e.getValue()}`]),children:e.getValue()})}:e),data:f}},w={render:function(e){let t=[{id:`age`,label:`Age`},{id:`visits`,label:`Visits`},{id:`status`,label:`Status`},{id:`progress`,label:`Profile Progress`}],[n,r]=(0,y.useState)({age:!0,visits:!0,status:!0,progress:!0}),i=e=>{r(t=>({...t,[e]:!t[e]}))};return(0,x.jsxs)(`div`,{children:[(0,x.jsxs)(`div`,{className:u.programmaticSelectionDemo,children:[(0,x.jsx)(`h4`,{className:u.programmaticSelectionDemo__title,children:`Column Hiding Demo`}),(0,x.jsx)(`p`,{className:u.programmaticSelectionDemo__description,children:`Use the checkboxes below to show or hide specific columns dynamically. This is useful for customizable table views or responsive layouts.`})]}),(0,x.jsx)(`div`,{className:u.programmaticSelectionControls,children:t.map(e=>(0,x.jsx)(a,{label:e.label,checked:n[e.id],onCheckedChange:()=>i(e.id)},e.id))}),(0,x.jsx)(c,{...e,columnVisibility:n,onColumnVisibilityChange:r})]})}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
