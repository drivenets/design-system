...
`,(0,l.jsx)(i,{dark:!0,language:`typescript`,code:`
import { z } from 'zod';
...
`,(0,l.jsx)(i,{dark:!0,language:`tsx`,code:`<Controller
  name="name"
  control={control}
...
`,(0,l.jsx)(i,{dark:!0,language:`tsx`,code:`<DsButtonV3 type="submit" disabled={!isDirty || isSubmitting} loading={isSubmitting}>
  Submit
</DsButtonV3>`}),`
`,(0,l.jsx)(n.p,{children:`For create forms, keep submit enabled and rely on validation on submit:`}),`
`,(0,l.jsx)(i,{dark:!0,language:`tsx`,code:`<DsButtonV3 type="submit" disabled={isSubmitting} loading={isSubmitting}>
  Submit
</DsButtonV3>`}),`
...
`]}),`
`]}),`
`]})]})}function c(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,l.jsx)(n,{...e,children:(0,l.jsx)(s,{...e})}):s(e)}var l;e((()=>{l=a(),o(),n()}))();export{c as default};