import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as x}from"./index-Bkff790b.js";import{D as o}from"./ds-icon-BN8hZyrB.js";import{D as C}from"./ds-spinner-2v2eVBvX.js";import{D as w}from"./ds-button-new-C28yRHBL.js";import"./iframe-zD3xWcdw.js";import"./preload-helper-PPVm8Dsz.js";const D=["primary","secondary","secondary-light","tertiary"],z=["filled","ghost","danger","dark"],B=["large","medium","small"],S="_showcaseContainer_1rt0z_1",$="_showcaseTable_1rt0z_7",j="_showcaseHeader_1rt0z_12",I="_showcaseCell_1rt0z_18",N="_showcaseCellBold_1rt0z_24",H="_showcaseCellInline_1rt0z_29",E="_showcaseCellDark_1rt0z_33",t={showcaseContainer:S,showcaseTable:$,showcaseHeader:j,showcaseCell:I,showcaseCellBold:N,showcaseCellInline:H,showcaseCellDark:E},{expect:f,fn:R,userEvent:T,within:g}=__STORYBOOK_MODULE_TEST__,W={title:"Design System/Button",component:w,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{buttonType:{control:{type:"select"},options:D,description:"Button type",table:{defaultValue:{summary:"primary"}}},variant:{control:{type:"select"},options:z,table:{defaultValue:{summary:"filled"}}},size:{control:{type:"select"},options:B,table:{defaultValue:{summary:"medium"}}}},args:{onClick:R()}},l="Button Text",c={args:{buttonType:"primary",variant:"filled",size:"large",disabled:!1,children:e.jsxs(e.Fragment,{children:[e.jsx(o,{icon:"check_circle",size:"tiny","aria-hidden":"true"}),l,e.jsx(o,{icon:"keyboard_arrow_down",size:"tiny","aria-hidden":"true"})]})},play:async({canvasElement:i})=>{const s=g(i).getByRole("button",{name:l});await T.click(s),await f(s).toBeInTheDocument()}},d={args:{buttonType:"primary",variant:"filled",size:"large",disabled:!1,children:e.jsxs(e.Fragment,{children:[e.jsx(C,{}),l,e.jsx(o,{icon:"keyboard_arrow_down",size:"tiny","aria-hidden":"true"})]})},play:async({canvasElement:i})=>{const s=g(i).getByRole("button",{name:l});await T.click(s),await f(s).toBeInTheDocument()}},y={parameters:{layout:"fullscreen"},render:function(){const u=e.jsxs(e.Fragment,{children:[e.jsx(o,{icon:"check_circle",size:"tiny"}),l,e.jsx(o,{icon:"keyboard_arrow_down",size:"tiny"})]}),s=e.jsx(o,{icon:"check_circle",size:"tiny"}),k=["primary-filled","primary-danger","secondary-filled","secondary-ghost","secondary-danger","tertiary-filled","tertiary-ghost","tertiary-danger","tertiary-dark","primary-dark","secondary-dark","secondary-light-dark"],v=(a,n)=>k.includes(`${a}-${n}`),_=[{label:"Primary",buttonType:"primary",icon:!1},{label:"Secondary",buttonType:"secondary",icon:!1},{label:"Secondary-Light",buttonType:"secondary-light",icon:!1,variant:"dark"},{label:"Tertiary",buttonType:"tertiary",icon:!1},{label:"Icon Primary",buttonType:"primary",icon:!0},{label:"Icon Secondary",buttonType:"secondary",icon:!0},{label:"Icon Tertiary",buttonType:"tertiary",icon:!0},{label:"Icon Primary Dark",buttonType:"primary",icon:!0,variant:"dark"},{label:"Icon Secondary Dark",buttonType:"secondary",icon:!0,variant:"dark"},{label:"Icon Tertiary Dark",buttonType:"tertiary",icon:!0,variant:"dark"}],p=["filled","ghost","danger","dark"],m=["small","medium","large"],h=[!1,!0];return e.jsx("div",{className:t.showcaseContainer,children:e.jsxs("table",{className:t.showcaseTable,children:[e.jsxs("thead",{children:[e.jsxs("tr",{children:[e.jsx("th",{className:t.showcaseHeader}),p.map(a=>e.jsx("th",{colSpan:m.length*h.length,className:t.showcaseHeader,children:a.charAt(0).toUpperCase()+a.slice(1)},a))]}),e.jsxs("tr",{children:[e.jsx("th",{className:t.showcaseHeader}),p.map(a=>m.map(n=>h.map(r=>e.jsx("th",{className:t.showcaseHeader,children:`${n}${r?" (disabled)":""}`},`${a}-${n}-${r?"disabled":"default"}`))))]})]}),e.jsx("tbody",{children:_.map(a=>e.jsxs("tr",{children:[e.jsx("td",{className:t.showcaseCellBold,children:a.label}),p.map(n=>m.map(r=>h.map(b=>v(a.buttonType,n)?e.jsx("td",{className:x(t.showcaseCell,{[t.showcaseCellDark]:n==="dark"}),children:e.jsx("div",{className:t.showcaseCellInline,children:e.jsx(w,{buttonType:a.buttonType,variant:n,size:r,disabled:b,children:a.icon?s:u})})},`${a.label}-${n}-${r}-${b?"disabled":"default"}`):e.jsx("td",{className:t.showcaseCell},`${a.label}-${n}-${r}-${b?"disabled":"default"}`)))).flat()]},a.label))})]})})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    buttonType: 'primary',
    variant: 'filled',
    size: 'large',
...
}`,...y.parameters?.docs?.source}}};const K=["DefaultButton","WithSpinner","Showcase"];export{c as DefaultButton,y as Showcase,d as WithSpinner,K as __namedExportsOrder,W as default};
