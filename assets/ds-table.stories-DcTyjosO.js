import{i as e}from"./preload-helper-xPQekRTU.js";import{k as t}from"./iframe-D3oER9bw.js";import{n,t as r}from"./ds-table-wlveghtw.js";import{n as i,t as a}from"./ds-table.stories.module-BH4xkOob.js";import{c as o,l as s,n as c,t as l,u}from"./components-Cn30zMht.js";import{n as d,t as f}from"./story-decorators-CMQSEtpy.js";var p,m,h,g,_,v,y,b,x;e((()=>{n(),u(),d(),l(),i(),p=t(),{fn:m}=__STORYBOOK_MODULE_TEST__,h=[{accessorKey:`firstName`,header:`First Name`,cell:e=>e.getValue(),size:250},{accessorKey:`lastName`,header:`Last Name`,cell:e=>e.getValue(),size:250},{accessorKey:`age`,header:`Age (years)`,cell:e=>e.getValue(),size:200},{accessorKey:`visits`,header:`Number of Visits`,cell:e=>e.getValue(),size:250},{accessorKey:`status`,header:`Relationship Status`,cell:e=>e.getValue(),size:250},{accessorKey:`progress`,header:`Profile Progress`,cell:e=>`${String(e.getValue())}%`,size:250}],g={title:`Components/Table`,component:r,parameters:{layout:`fullscreen`},args:{columns:o,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:(0,p.jsx)(c,{}),onRowClick:m()},decorators:[f]},_={args:{data:s}},v={args:{data:[]}},y={args:{data:s,bordered:!1}},b={parameters:{docs:{description:{story:`When columns are wider than the container, the body and header scroll horizontally together while only the body scrolls vertically. The scrollbars are thin and become visible on hover.`}}},decorators:[e=>(0,p.jsx)(`div`,{className:a.horizontalScrollWrapper,children:(0,p.jsx)(e,{})})],args:{data:s,columns:h}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  args: {
    data: defaultData
  }
