import{a as e,n as t}from"./chunk-BneVvdWh.js";import{S as n}from"./iframe-xsaqW-tK.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{a as i,i as a,n as o,o as s,r as c,s as l,t as u}from"./ds-stepper-DvPQd8S6.js";import{n as d,t as f}from"./ds-button-nIKj1ExY.js";var p,m,h,g,_,v,y;t((()=>{l(),f(),u(),p=e(n(),1),m=r(),h={title:`Components/Panel`,component:s,parameters:{layout:`centered`}},g={render:function({variant:e}){let[t,n]=(0,p.useState)(!0);return(0,m.jsxs)(m.Fragment,{children:[!t&&(0,m.jsx)(d,{onClick:()=>n(!0),children:`Open Panel`}),(0,m.jsxs)(s,{open:t,onOpenChange:n,variant:e,children:[(0,m.jsx)(`p`,{children:`This is a panel. It can contain any content you like, such as text, images, or other components.`}),(0,m.jsx)(`p`,{children:`It is collapsible. Hover it to see the trigger button.`}),(0,m.jsx)(d,{size:`small`,children:`Primary Action`})]})]})}},_={render:function(){let[e,t]=(0,p.useState)(!0);return(0,m.jsxs)(m.Fragment,{children:[!e&&(0,m.jsx)(d,{onClick:()=>t(!0),children:`Open Panel`}),(0,m.jsxs)(s,{open:e,onOpenChange:t,width:{lg:480,md:240},children:[(0,m.jsx)(`p`,{children:`This panel uses a responsive width.`}),(0,m.jsx)(`p`,{children:`Large screens: 480px. Medium screens: 240px.`}),(0,m.jsx)(d,{size:`small`,children:`Primary Action`})]})]})}},v={render:function(){let[e,t]=(0,p.useState)(`docked`),[n,r]=(0,p.useState)(0),l=e===`floating`,u=()=>{t(l?`docked`:`floating`)},d=[{label:`Configure network`,description:`Set up interfaces and routing policies`},{label:`Assign resources`,description:`Allocate compute and storage for the deployment`},{label:`Review & deploy`,description:`Verify configuration and launch`}];return(0,m.jsx)(`div`,{style:{position:`relative`,width:600,height:500},children:(0,m.jsx)(s,{open:!0,variant:e,draggable:l,disablePadding:l,slotProps:{collapseButton:{onClick:u,collapsed:l}},children:(0,m.jsx)(i,{count:d.length,activeStep:n,onStepChange:({step:e})=>r(e),variant:l?`single`:void 0,floating:l,children:d.map((e,t)=>(0,m.jsx)(a,{index:t,children:(0,m.jsx)(c,{index:t,label:e.label,description:e.description,actions:(0,m.jsx)(o,{children:t===d.length-1?`Deploy`:`Next`})})},t))})})})}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
