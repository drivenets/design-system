import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as k}from"./index-CAjgkSpS.js";import{D as r}from"./ds-icon-CnIgB9vW.js";import{D as g}from"./ds-spinner-DMQ7v6Ba.js";import{D as h}from"./ds-button-new-ityBlADU.js";import"./iframe-DqXDffqa.js";import"./preload-helper-PPVm8Dsz.js";const _=["primary","secondary","secondary-light","tertiary"],C=["filled","ghost","danger","dark"],x=["large","medium","small"],z="_showcaseContainer_1rt0z_1",v="_showcaseTable_1rt0z_7",D="_showcaseHeader_1rt0z_12",S="_showcaseCell_1rt0z_18",$="_showcaseCellBold_1rt0z_24",j="_showcaseCellInline_1rt0z_29",B="_showcaseCellDark_1rt0z_33",t={showcaseContainer:z,showcaseTable:v,showcaseHeader:D,showcaseCell:S,showcaseCellBold:$,showcaseCellInline:j,showcaseCellDark:B},{fn:I}=__STORYBOOK_MODULE_TEST__,L={title:"Design System/Button",component:h,parameters:{layout:"centered"},argTypes:{buttonType:{control:{type:"select"},options:_,description:"Button type",table:{defaultValue:{summary:"primary"}}},variant:{control:{type:"select"},options:C,table:{defaultValue:{summary:"filled"}}},size:{control:{type:"select"},options:x,table:{defaultValue:{summary:"medium"}}}},args:{onClick:I()}},p="Button Text",o={args:{buttonType:"primary",variant:"filled",size:"large",disabled:!1,children:e.jsxs(e.Fragment,{children:[e.jsx(r,{icon:"check_circle",size:"tiny","aria-hidden":"true"}),p,e.jsx(r,{icon:"keyboard_arrow_down",size:"tiny","aria-hidden":"true"})]})}},l={args:{buttonType:"primary",variant:"filled",size:"large",disabled:!1,children:e.jsxs(e.Fragment,{children:[e.jsx(g,{}),p,e.jsx(r,{icon:"keyboard_arrow_down",size:"tiny","aria-hidden":"true"})]})}},i={parameters:{layout:"fullscreen"},render:function(){const m=e.jsxs(e.Fragment,{children:[e.jsx(r,{icon:"check_circle",size:"tiny"}),p,e.jsx(r,{icon:"keyboard_arrow_down",size:"tiny"})]}),b=e.jsx(r,{icon:"check_circle",size:"tiny"}),f=["primary-filled","primary-danger","secondary-filled","secondary-ghost","secondary-danger","tertiary-filled","tertiary-ghost","tertiary-danger","tertiary-dark","primary-dark","secondary-dark","secondary-light-dark"],w=(a,n)=>f.includes(`${a}-${n}`),T=[{label:"Primary",buttonType:"primary",icon:!1},{label:"Secondary",buttonType:"secondary",icon:!1},{label:"Secondary-Light",buttonType:"secondary-light",icon:!1,variant:"dark"},{label:"Tertiary",buttonType:"tertiary",icon:!1},{label:"Icon Primary",buttonType:"primary",icon:!0},{label:"Icon Secondary",buttonType:"secondary",icon:!0},{label:"Icon Tertiary",buttonType:"tertiary",icon:!0},{label:"Icon Primary Dark",buttonType:"primary",icon:!0,variant:"dark"},{label:"Icon Secondary Dark",buttonType:"secondary",icon:!0,variant:"dark"},{label:"Icon Tertiary Dark",buttonType:"tertiary",icon:!0,variant:"dark"}],c=["filled","ghost","danger","dark"],d=["small","medium","large"],y=[!1,!0];return e.jsx("div",{className:t.showcaseContainer,children:e.jsxs("table",{className:t.showcaseTable,children:[e.jsxs("thead",{children:[e.jsxs("tr",{children:[e.jsx("th",{className:t.showcaseHeader}),c.map(a=>e.jsx("th",{colSpan:d.length*y.length,className:t.showcaseHeader,children:a.charAt(0).toUpperCase()+a.slice(1)},a))]}),e.jsxs("tr",{children:[e.jsx("th",{className:t.showcaseHeader}),c.map(a=>d.map(n=>y.map(s=>e.jsx("th",{className:t.showcaseHeader,children:`${n}${s?" (disabled)":""}`},`${a}-${n}-${s?"disabled":"default"}`))))]})]}),e.jsx("tbody",{children:T.map(a=>e.jsxs("tr",{children:[e.jsx("td",{className:t.showcaseCellBold,children:a.label}),c.map(n=>d.map(s=>y.map(u=>w(a.buttonType,n)?e.jsx("td",{className:k(t.showcaseCell,{[t.showcaseCellDark]:n==="dark"}),children:e.jsx("div",{className:t.showcaseCellInline,children:e.jsx(h,{buttonType:a.buttonType,variant:n,size:s,disabled:u,children:a.icon?b:m})})},`${a.label}-${n}-${s}-${u?"disabled":"default"}`):e.jsx("td",{className:t.showcaseCell},`${a.label}-${n}-${s}-${u?"disabled":"default"}`)))).flat()]},a.label))})]})})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    buttonType: 'primary',
    variant: 'filled',
    size: 'large',
