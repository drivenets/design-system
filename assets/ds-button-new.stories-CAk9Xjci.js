import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{n}from"./iframe-CgoBVqrN.js";import{t as r}from"./classnames-DavMFNTn.js";import{n as i,t as a}from"./ds-icon-BM5w7WmP.js";import{t as o}from"./ds-spinner-5FSQsg-r.js";import{t as s}from"./ds-spinner-BXH0bgOI.js";import{n as c,t as l}from"./ds-button-new-8BDP9Gt1.js";var u,d,f;function p(){return(p=t((()=>{u=[`primary`,`secondary`,`secondary-light`,`tertiary`],d=[`filled`,`ghost`,`danger`,`dark`],f=[`large`,`medium`,`small`,`tiny`]})))()}var m,h,g,_,v,y,b,x;function S(){return(S=t((()=>{m=`_showcaseContainer_1ll0g_1`,h=`_showcaseTable_1ll0g_7`,g=`_showcaseHeader_1ll0g_12`,_=`_showcaseCell_1ll0g_18`,v=`_showcaseCellBold_1ll0g_24`,y=`_showcaseCellInline_1ll0g_29`,b=`_showcaseCellDark_1ll0g_33`,x={showcaseContainer:m,showcaseTable:h,showcaseHeader:g,showcaseCell:_,showcaseCellBold:v,showcaseCellInline:y,showcaseCellDark:b}})))()}var C,w,T,E,D,O,k,A,j;function M(){return(M=t((()=>{C=e(r(),1),a(),s(),c(),p(),S(),w=n(),{fn:T}=__STORYBOOK_MODULE_TEST__,E={title:`Components/Button`,component:l,parameters:{layout:`centered`},argTypes:{buttonType:{control:{type:`select`},options:u,description:`Button type`,table:{defaultValue:{summary:`primary`}}},variant:{control:{type:`select`},options:d,table:{defaultValue:{summary:`filled`}}},size:{control:{type:`select`},options:f,table:{defaultValue:{summary:`medium`}}}},args:{onClick:T()}},D=`Button Text`,O={args:{buttonType:`primary`,variant:`filled`,size:`large`,disabled:!1,children:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(i,{icon:`check_circle`,size:`tiny`,"aria-hidden":`true`}),D,(0,w.jsx)(i,{icon:`keyboard_arrow_down`,size:`tiny`,"aria-hidden":`true`})]})}},k={args:{buttonType:`primary`,variant:`filled`,size:`large`,disabled:!1,children:(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(o,{}),D,(0,w.jsx)(i,{icon:`keyboard_arrow_down`,size:`tiny`,"aria-hidden":`true`})]})}},A={parameters:{layout:`fullscreen`},render:function(){let e=(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(i,{icon:`check_circle`,size:`tiny`}),D,(0,w.jsx)(i,{icon:`keyboard_arrow_down`,size:`tiny`})]}),t=(0,w.jsx)(i,{icon:`check_circle`,size:`tiny`}),n=[`primary-filled`,`primary-danger`,`secondary-filled`,`secondary-ghost`,`secondary-danger`,`tertiary-filled`,`tertiary-ghost`,`tertiary-danger`,`tertiary-dark`,`primary-dark`,`secondary-dark`,`secondary-light-dark`],r=(e,t)=>n.includes(`${e}-${t}`),a=[{label:`Primary`,buttonType:`primary`,icon:!1},{label:`Secondary`,buttonType:`secondary`,icon:!1},{label:`Secondary-Light`,buttonType:`secondary-light`,icon:!1,variant:`dark`},{label:`Tertiary`,buttonType:`tertiary`,icon:!1},{label:`Icon Primary`,buttonType:`primary`,icon:!0},{label:`Icon Secondary`,buttonType:`secondary`,icon:!0},{label:`Icon Tertiary`,buttonType:`tertiary`,icon:!0},{label:`Icon Primary Dark`,buttonType:`primary`,icon:!0,variant:`dark`},{label:`Icon Secondary Dark`,buttonType:`secondary`,icon:!0,variant:`dark`},{label:`Icon Tertiary Dark`,buttonType:`tertiary`,icon:!0,variant:`dark`}],o=d,s=f,c=[!1,!0];return(0,w.jsx)(`div`,{className:x.showcaseContainer,children:(0,w.jsxs)(`table`,{className:x.showcaseTable,children:[(0,w.jsxs)(`thead`,{children:[(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`th`,{className:x.showcaseHeader}),o.map(e=>(0,w.jsx)(`th`,{colSpan:s.length*c.length,className:x.showcaseHeader,children:e.charAt(0).toUpperCase()+e.slice(1)},e))]}),(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`th`,{className:x.showcaseHeader}),o.map(e=>s.map(t=>c.map(n=>(0,w.jsx)(`th`,{className:x.showcaseHeader,children:`${t}${n?` (disabled)`:``}`},`${e}-${t}-${n?`disabled`:`default`}`))))]})]}),(0,w.jsx)(`tbody`,{children:a.map(n=>(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`td`,{className:x.showcaseCellBold,children:n.label}),o.map(i=>s.map(a=>c.map(o=>r(n.buttonType,i)?(0,w.jsx)(`td`,{className:(0,C.default)(x.showcaseCell,{[x.showcaseCellDark]:i===`dark`}),children:(0,w.jsx)(`div`,{className:x.showcaseCellInline,children:(0,w.jsx)(l,{buttonType:n.buttonType,variant:i,size:a,disabled:o,children:n.icon?t:e})})},`${n.label}-${i}-${a}-${o?`disabled`:`default`}`):(0,w.jsx)(`td`,{className:x.showcaseCell},`${n.label}-${i}-${a}-${o?`disabled`:`default`}`)))).flat()]},n.label))})]})})}},j=[`DefaultButton`,`WithSpinner`,`Showcase`],O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  args: {
    buttonType: 'primary',
    variant: 'filled',
    size: 'large',
...
}`,...A.parameters?.docs?.source}}}})))()}M();export{O as DefaultButton,A as Showcase,k as WithSpinner,j as __namedExportsOrder,E as default};