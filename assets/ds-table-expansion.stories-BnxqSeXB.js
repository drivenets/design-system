import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as g}from"./iframe-Dy6SS36-.js";import{D as w}from"./ds-table-DEuJSatS.js";import{s as n}from"./ds-table.stories.module-D_XXzStM.js";import{f as B,d,c as f,T as b}from"./table-empty-state-BO1aeRsg.js";import{g as T}from"./story-test-helpers-PqH2Bcxs.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DqNJ7Hgs.js";import"./core-table-13MXjYLI.js";import"./ds-button-41O6kJRu.js";import"./ds-button-legacy-DjFZj43n.js";import"./ds-button-new-D4nLbd9B.js";import"./ds-icon-CvRVPcqP.js";import"./ds-typography-Da2cjcXF.js";import"./index-B0PnPE3E.js";import"./index-Btt4cvEF.js";import"./ds-checkbox-CxZ-oQHe.js";import"./index-CgAnCV2y.js";import"./index-JDIXPvFM.js";import"./index-CD44qpmb.js";import"./index-H2xV4SiH.js";import"./ds-dropdown-menu-BUnT0eAQ.js";import"./index-DFQMbGjH.js";import"./Combination-CIo-MpCg.js";import"./index-BJyvBKVH.js";import"./floating-ui.dom-D3zTlarL.js";import"./index-kT2QvDka.js";import"./ds-text-input-ByzrRThj.js";import"./portal-BsPwAuJQ.js";import"./create-split-props-u5h9OPvL.js";import"./use-locale-context-DUC77wSF.js";import"./create-anatomy-DXjEE3v2.js";import"./use-presence-CxJLinAV.js";import"./set-Bq9lVoEM.js";import"./raf-CC9hSMXO.js";import"./event-CBXSxTbR.js";import"./index-D6mHLL9J.js";import"./get-styles-C_viWxRO.js";import"./typeahead-B8zPPRc6.js";import"./query-CjgVAlRR.js";import"./equal-DfFTejAs.js";import"./mutation-observer-Cu1ou0At.js";import"./dismissable-layer-G837k9-0.js";import"./navigate-DvSvm2bo.js";import"./merge-refs-DX9dreSa.js";const{expect:a,fn:N,userEvent:l}=__STORYBOOK_MODULE_TEST__,ge={title:"Design System/Table/Expansion",component:w,parameters:{layout:"fullscreen"},args:{columns:f,data:d,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:t.jsx(b,{}),onRowClick:N()},decorators:[B]},m={args:{data:d.slice(0,5),expandable:e=>e.firstName!=="Tanner",renderExpandedRow:e=>t.jsxs(t.Fragment,{children:[t.jsxs("div",{className:n.expandedRowDetails,children:[t.jsxs("h4",{children:["Expanded Details for ",e.firstName]}),t.jsxs("p",{children:["ID: ",e.id]}),t.jsxs("p",{children:["Full Name: ",e.firstName," ",e.lastName]}),t.jsxs("p",{children:["Status: ",e.status]})]}),t.jsx(w,{columns:[{accessorKey:"id",header:"ID"},{accessorKey:"firstName",header:"First Name"},{accessorKey:"lastName",header:"Last Name"}],data:d.slice(0,3)})]})},play:async({canvas:e})=>{await a(T(e)).toHaveLength(5);const s=e.getAllByRole("button",{name:/chevron_right/i});await a(s).toHaveLength(4),await l.click(s[0]),await a(e.getByText(/expanded details for kevin/i)).toBeInTheDocument(),await l.click(s[0]),await a(e.queryByText(/expanded details for kevin/i)).not.toBeInTheDocument()}},x={args:{data:d.slice(0,5),expandable:e=>e.firstName!=="Tanner",renderExpandedRow:e=>t.jsxs("div",{className:n.expandedRowDetails,children:[t.jsxs("h4",{children:["Expanded Details for ",e.firstName]}),t.jsxs("p",{children:["ID: ",e.id]}),t.jsxs("p",{children:["Full Name: ",e.firstName," ",e.lastName]}),t.jsxs("p",{children:["Status: ",e.status]})]})},render:function(s){const r=g.useRef(null),[c,p]=g.useState([]),u=o=>{r.current?.expandRow(o),p(i=>i.includes(o)?i:[...i,o])},h=()=>{r.current?.expandAllRows();const o=d.slice(0,5).filter(i=>i.firstName!=="Tanner").map(i=>i.id);p(o)},R=()=>{r.current?.collapseAllRows(),p([])},y=()=>{const o=["2","3","4"];r.current?.expandRows(o),p(o)};return t.jsxs("div",{children:[t.jsxs("div",{className:n.programmaticSelectionDemo,children:[t.jsx("h4",{className:n.programmaticSelectionDemo__title,children:"Programmatic Row Expansion Demo"}),t.jsx("p",{className:n.programmaticSelectionDemo__description,children:"Use the buttons below to programmatically control row expansion using TanStack Table v8 APIs."}),t.jsxs("p",{className:n.programmaticSelectionDemo__selectedRows,children:["Expanded rows: ",c.length>0?c.join(", "):"None"]})]}),t.jsxs("div",{className:n.programmaticSelectionControls,children:[t.jsx("button",{onClick:()=>u("2"),className:n.programmaticSelectionButton,children:"Expand Kevin"}),t.jsx("button",{onClick:()=>u("3"),className:n.programmaticSelectionButton,children:"Expand John"}),t.jsx("button",{onClick:()=>u("4"),className:n.programmaticSelectionButton,children:"Expand Jane"}),t.jsx("button",{onClick:h,className:n.programmaticSelectionButton,children:"Expand All"}),t.jsx("button",{onClick:R,className:n.programmaticSelectionButton,children:"Collapse All"}),t.jsx("button",{onClick:y,className:n.programmaticSelectionButton,children:"Expand First 3 Expandable"})]}),t.jsx(w,{...s,ref:r})]})},play:async({canvas:e})=>{await a(e.getByText(/expanded rows: none/i)).toBeInTheDocument(),await l.click(e.getByRole("button",{name:/expand kevin/i})),await a(e.getByText((r,c)=>c?.textContent==="Expanded rows: 2")).toBeInTheDocument(),await a(e.getByText(/expanded details for kevin/i)).toBeInTheDocument(),await l.click(e.getByRole("button",{name:/^expand all$/i}));const s=e.getAllByRole("button",{name:/chevron_right/i});await a(s).toHaveLength(4),await l.click(e.getByRole("button",{name:/collapse all/i})),await a(e.getByText(/expanded rows: none/i)).toBeInTheDocument(),await a(e.queryByText(/expanded details for kevin/i)).not.toBeInTheDocument(),await l.click(e.getByRole("button",{name:/expand first 3 expandable/i})),await a(e.getByText((r,c)=>c?.textContent==="Expanded rows: 2, 3, 4")).toBeInTheDocument(),await l.click(e.getByRole("button",{name:/collapse all/i})),await a(e.getByText(/expanded rows: none/i)).toBeInTheDocument()}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...x.parameters?.docs?.source}}};const he=["Expandable","ProgrammaticExpansion"];export{m as Expandable,x as ProgrammaticExpansion,he as __namedExportsOrder,ge as default};
