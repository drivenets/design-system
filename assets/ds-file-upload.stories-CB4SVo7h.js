...
`,(0,$.jsx)(c,{code:Je,language:`ts`,dark:!0})]})}function Ze(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,$.jsx)(t,{...e,children:(0,$.jsx)(Xe,{...e})}):Xe(e)}var $,Qe=t((()=>{$=r(),S(),o(),qe(),Ye()})),$e,et,tt,nt,rt,it,at,ot,st,ct,lt,ut,dt,ft;t((()=>{x(),Ue(),ze(),Ge(),De(),Qe(),$e=r(),{fn:et}=__STORYBOOK_MODULE_TEST__,tt={title:`Components/FileUpload`,component:He,parameters:{layout:`centered`,docs:{page:Ze,source:{code:`
