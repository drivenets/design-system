import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{X as n}from"./iframe-BWhkbzUk.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{t as i}from"./ds-icon-B1HSCb9A.js";import{t as a}from"./ds-icon-DXVKEKLy.js";import{P as o}from"./dist-srzmhjgw.js";import{n as s,t as c}from"./ds-button-BLC4jOn5.js";import{r as l}from"./ds-checkbox.types-BnVwyErh.js";import{t as u}from"./ds-checkbox-DtohtjT3.js";import{t as d}from"./dialog-DlQqjHn4.js";import{n as f,t as p}from"./ds-modal-CWWh-lJO.js";import{r as m}from"./ds-form-control.types-CtOITUs9.js";import{t as h}from"./ds-form-control-CPcdnv11.js";import{t as g}from"./ds-radio-group-CoNaBKkN.js";import{t as _}from"./ds-radio-group-OJJ_vtfG.js";import{_ as v,a as y,c as b,d as ee,f as x,g as te,l as S,m as ne,n as C,p as re,r as ie,t as ae,u as oe,v as w}from"./zod-B0XmsSyT.js";var se,ce,le,ue,de,fe,pe,me,he,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,ge=e((()=>{se=`_storyContainer_1il54_1`,ce=`_storyHeader_1il54_6`,le=`_formResults_1il54_10`,ue=`_formResultsTitle_1il54_18`,de=`_formResultsGrid_1il54_23`,fe=`_clearResultsButton_1il54_28`,pe=`_formSection_1il54_32`,me=`_formSectionTitle_1il54_38`,he=`_formGrid_1il54_45`,T=`_formGridThree_1il54_51`,E=`_inputLabel_1il54_58`,D=`_inputField_1il54_64`,O=`_customHeader_1il54_72`,k=`_headerButton_1il54_79`,A=`_customFooter_1il54_86`,j=`_customActions_1il54_94`,M=`_statusBadge_1il54_98`,N=`_footerButton_1il54_107`,P=`_footerButtonPrimary_1il54_115`,F=`_fileUploadArea_1il54_124`,I=`_uploadButton_1il54_132`,L=`_uploadText_1il54_143`,R=`_addButton_1il54_148`,z=`_errorMessage_1il54_159`,B={storyContainer:se,storyHeader:ce,formResults:le,formResultsTitle:ue,formResultsGrid:de,clearResultsButton:fe,formSection:pe,formSectionTitle:me,formGrid:he,formGridThree:T,inputLabel:E,inputField:D,customHeader:O,headerButton:k,customFooter:A,customActions:j,statusBadge:M,footerButton:N,footerButtonPrimary:P,fileUploadArea:F,uploadButton:I,uploadText:L,addButton:R,errorMessage:z}})),V,H,U,W,G,K,q,_e,ve,J,Y,X,Z,Q,$,ye;e((()=>{V=t(n(),1),d(),v(),ne(),oe(),ae(),f(),ge(),c(),h(),_(),u(),a(),H=r(),{expect:U,screen:W,userEvent:G,waitFor:K,within:q}=__STORYBOOK_MODULE_TEST__,_e={title:`Components/Modal`,component:p,parameters:{layout:`centered`},args:{open:!1},argTypes:{open:{control:`boolean`,description:`Controls whether the modal is open`},dividers:{control:`boolean`,description:`Show full-width dividers between header, body, and footer sections`},columns:{control:`select`,options:Array(12).fill(0).map((e,t)=>t+1),description:`Number of grid columns for modal width`},className:{control:`text`,description:`Additional CSS class names`}}},ve=b({name:S().min(1,`Name is required`),email:y(`Invalid email address`),department:S().min(1,`Please select a department`),role:S().min(1,`Please select a role`),description:S().min(20,`Description must be at least 20 characters`),acceptTerms:ie().refine(e=>e,`You must accept the terms and conditions`),subscription:C([`basic`,`pro`,`enterprise`],{error:()=>`Please select a subscription plan`})}),J={name:``,email:``,department:``,role:``,description:``,acceptTerms:!1,subscription:`basic`},Y={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Default Modal`}),(0,H.jsx)(`p`,{children:`The default variant has an inset header underline and no footer border.`}),(0,H.jsx)(s,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Modal`})]}),(0,H.jsxs)(p,{open:e,columns:4,onOpenChange:t,children:[(0,H.jsxs)(p.Header,{children:[(0,H.jsx)(p.Title,{children:`Modal Title`}),(0,H.jsx)(p.CloseTrigger,{})]}),(0,H.jsx)(p.Body,{children:(0,H.jsx)(`p`,{children:`This is the default modal variant with simple content.`})}),(0,H.jsx)(p.Footer,{children:(0,H.jsxs)(p.Actions,{children:[(0,H.jsx)(s,{design:`v1.2`,buttonType:`secondary`,size:`large`,onClick:()=>t(!1),children:`Cancel`}),(0,H.jsx)(s,{design:`v1.2`,variant:`filled`,size:`large`,onClick:()=>t(!1),children:`Confirm`})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(W.getByRole(`heading`,{name:/modal title/i})).toBeVisible();let n=W.getByRole(`button`,{name:/confirm/i});await G.click(n),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`Default modal variant with inset header underline and no footer border.`}}}},X={render:function(){let[e,t]=(0,V.useState)(!1),[n,r]=(0,V.useState)(null),i=te({resolver:ee(ve),defaultValues:J,mode:`onChange`}),{register:a,handleSubmit:o,formState:{errors:c,isValid:u,touchedFields:d,isDirty:f},setValue:h,watch:_,trigger:v,reset:y,control:b}=i,S=e=>{r(e),t(!1),y(J)},ne=()=>{y(J)},C=(e,t)=>{h(e,t===`indeterminate`?!1:t,{shouldValidate:!0,shouldTouch:!0,shouldDirty:!0})};return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Interactive Form Modal Demo`}),(0,H.jsx)(`p`,{children:`Click the button below to open a form modal. Fill out the form and click "Save Changes" to see the results displayed here.`}),(0,H.jsx)(s,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Form Modal`})]}),n&&(0,H.jsxs)(`div`,{className:B.formResults,children:[(0,H.jsx)(`h3`,{className:B.formResultsTitle,children:`Form Results:`}),(0,H.jsxs)(`div`,{className:B.formResultsGrid,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Name:`}),` `,n.name]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Email:`}),` `,n.email]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Department:`}),` `,n.department]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Role:`}),` `,n.role||`Not specified`]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Description:`}),` `,n.description]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Subscription:`}),` `,n.subscription]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`strong`,{children:`Terms Accepted:`}),` `,n.acceptTerms?`Yes`:`No`]})]}),(0,H.jsx)(s,{design:`v1.2`,buttonType:`secondary`,size:`small`,onClick:()=>r(null),className:B.clearResultsButton,children:`Clear Results`})]}),(0,H.jsxs)(p,{open:e,columns:8,dividers:!0,onOpenChange:t,children:[(0,H.jsxs)(p.Header,{children:[(0,H.jsx)(p.Title,{children:`User Profile Form`}),(0,H.jsx)(p.CloseTrigger,{})]}),(0,H.jsx)(p.Body,{children:(0,H.jsx)(re,{...i,children:(0,H.jsxs)(`div`,{className:B.formSection,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Basic Information`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsx)(m,{label:`Full Name`,required:!0,status:`error`,messageIcon:`cancel`,message:d.name?c.name?.message:void 0,children:(0,H.jsx)(x,{name:`name`,control:b,render:({field:e})=>(0,H.jsx)(m.TextInput,{value:e.value,placeholder:`Enter full name`,onChange:e=>C(`name`,e.target.value),onBlur:e=>C(`name`,e.target.value)})})}),(0,H.jsx)(m,{label:`Email Address`,required:!0,status:`error`,messageIcon:`cancel`,message:d.email?c.email?.message:void 0,children:(0,H.jsx)(x,{name:`email`,control:b,render:({field:e})=>(0,H.jsx)(m.TextInput,{type:`email`,value:e.value,placeholder:`Enter email address`,onChange:e=>C(`email`,e.target.value),onBlur:e=>C(`email`,e.target.value)})})})]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Work Information`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsx)(m,{label:`Department`,required:!0,status:`error`,messageIcon:`cancel`,message:d.department?c.department?.message:void 0,children:(0,H.jsx)(x,{name:`department`,control:b,render:({field:e})=>(0,H.jsx)(m.Select,{value:e.value,placeholder:`Select a department`,options:[{label:`Engineering`,value:`engineering`},{label:`Product`,value:`product`},{label:`Design`,value:`design`},{label:`Marketing`,value:`marketing`},{label:`Sales`,value:`sales`},{label:`HR`,value:`hr`}],clearable:!0,onValueChange:e=>C(`department`,e),onBlur:()=>C(`department`,e.value)})})}),(0,H.jsx)(m,{label:`Role`,required:!0,status:`error`,messageIcon:`cancel`,message:d.role?c.role?.message:void 0,children:(0,H.jsx)(x,{name:`role`,control:b,render:({field:e})=>(0,H.jsx)(m.Select,{value:e.value,placeholder:`Select a role`,options:[{label:`Manager`,value:`manager`},{label:`Senior`,value:`senior`},{label:`Mid-level`,value:`mid`},{label:`Junior`,value:`junior`},{label:`Intern`,value:`intern`}],clearable:!0,onValueChange:e=>C(`role`,e),onBlur:()=>C(`role`,e.value)})})})]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Subscription Plan`}),(0,H.jsxs)(g.Root,{value:_(`subscription`),onValueChange:e=>C(`subscription`,e),children:[(0,H.jsx)(g.Item,{value:`basic`,label:`Basic`}),(0,H.jsx)(g.Item,{value:`pro`,label:`Pro`}),(0,H.jsx)(g.Item,{value:`enterprise`,label:`Enterprise`})]}),c.subscription&&(0,H.jsx)(`span`,{className:B.errorMessage,children:c.subscription.message})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Additional Information`}),(0,H.jsx)(m,{label:`Description`,required:!0,status:`error`,messageIcon:`cancel`,message:d.description?c.description?.message:void 0,children:(0,H.jsx)(m.Textarea,{placeholder:`Enter a brief description about the user (min. 20 characters)...`,...a(`description`,{onBlur:()=>v(`description`),onChange:()=>v(`description`)})})})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(l,{label:`I accept the terms and conditions`,checked:_(`acceptTerms`),onCheckedChange:e=>C(`acceptTerms`,e)}),c.acceptTerms&&(0,H.jsx)(`span`,{className:B.errorMessage,children:c.acceptTerms.message})]})]})})}),(0,H.jsx)(p.Footer,{children:(0,H.jsxs)(p.Actions,{children:[(0,H.jsx)(s,{design:`v1.2`,buttonType:`secondary`,size:`large`,onClick:ne,children:`Reset`}),(0,H.jsx)(s,{design:`v1.2`,size:`large`,disabled:!f||!u,onClick:o(S),children:`Save Changes`})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e),n=async e=>{await K(()=>U(W.getByText(e)).toBeInTheDocument())},r=t.getByRole(`button`,{name:/open form modal/i});await G.click(r),await K(()=>U(W.getByText(`User Profile Form`)).toBeVisible());let i=W.getByLabelText(`Full Name`);await G.click(i),await G.tab(),await n(`Name is required`);let a=W.getByLabelText(`Email Address`);await G.click(a),await G.tab(),await n(`Invalid email address`);let o=W.getByLabelText(`Department`);await G.click(o),await G.tab(),await n(`Please select a department`);let s=W.getByLabelText(`Role`);await G.click(s),await G.tab(),await n(`Please select a role`);let c=W.getByLabelText(`Description`);await G.click(c),await G.tab(),await n(`Description must be at least 20 characters`);let l=W.getByLabelText(`I accept the terms and conditions`);await G.click(l),await G.click(l),await n(`You must accept the terms and conditions`);let u=`${w.person.firstName()} ${w.person.lastName()}`;await G.type(i,u),await K(()=>U(W.queryByText(`Name is required`)).not.toBeInTheDocument());let d=w.internet.email();await G.clear(a),await G.type(a,d),await K(()=>U(W.queryByText(`Invalid email address`)).not.toBeInTheDocument()),await G.click(o);let f=W.getByRole(`option`,{name:`Product`});await G.click(f),await K(()=>U(W.queryByText(`Please select a department`)).not.toBeInTheDocument()),await G.click(s);let p=W.getByRole(`option`,{name:`Manager`});await G.click(p),await K(()=>U(W.queryByText(`Please select a role`)).not.toBeInTheDocument());let m=w.lorem.sentence(5);await G.clear(c),await G.type(c,m),await K(()=>U(W.queryByText(`Description must be at least 20 characters`)).not.toBeInTheDocument());let h=W.getByLabelText(`Pro`);await G.click(h),await K(()=>U(W.queryByText(`Please select a subscription plan`)).not.toBeInTheDocument()),await G.click(l),await K(()=>U(W.queryByText(`You must accept the terms and conditions`)).not.toBeInTheDocument());let g=W.getByRole(`button`,{name:/save changes/i});await K(()=>U(g).toBeEnabled()),await G.click(g),await K(()=>U(W.queryByText(`User Profile Form`)).not.toBeVisible());let _=e=>U(t.getByText((t,n)=>n?.textContent===e)).toBeInTheDocument();await K(async()=>{await U(t.getByText(`Form Results:`)).toBeInTheDocument(),await _(`Name: ${u}`),await _(`Email: ${d}`),await _(`Role: manager`),await _(`Department: product`),await _(`Description: ${m}`),await _(`Subscription: pro`),await _(`Terms Accepted: Yes`)}),await G.click(r),await K(()=>U(W.getByText(`User Profile Form`)).toBeInTheDocument()),await K(async()=>{await U(i).toHaveValue(``),await U(a).toHaveValue(``),await U(c).toHaveValue(``),await U(l).not.toBeChecked()}),await G.type(i,`Test Name`),await G.type(a,`test@example.com`),await G.type(c,`This is a test description that is long enough`),await G.click(l);let v=W.getByRole(`button`,{name:/reset/i});await G.click(v),await K(async()=>{await U(i).toHaveValue(``),await U(a).toHaveValue(``),await U(c).toHaveValue(``),await U(l).not.toBeChecked()}),await G.keyboard(`{Escape}`),await G.click(t.getByRole(`button`,{name:/clear results/i})),await K(()=>U(t.queryByText(`Form Results:`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`The divided layout adds full-width borders on header and footer for clear visual separation. This example demonstrates form state management using react-hook-form with Zod validation.`}}}},Z={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Custom Modal Demo`}),(0,H.jsx)(`p`,{children:`Click the button below to open a custom modal with custom header and footer content.`}),(0,H.jsx)(s,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Custom Modal`})]}),(0,H.jsxs)(p,{open:e,columns:4,dividers:!0,onOpenChange:t,children:[(0,H.jsx)(p.Header,{children:(0,H.jsxs)(`div`,{className:B.customHeader,children:[(0,H.jsx)(`button`,{className:B.headerButton,children:`⋯`}),(0,H.jsx)(o.CloseTrigger,{className:B.headerButton,children:`✕`})]})}),(0,H.jsx)(p.Body,{children:(0,H.jsxs)(`div`,{className:B.formSection,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Project Details`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`project-name`,className:B.inputLabel,children:`Project Name`}),(0,H.jsx)(`input`,{id:`project-name`,type:`text`,placeholder:`Enter project name`,className:B.inputField})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`category`,className:B.inputLabel,children:`Category`}),(0,H.jsx)(`input`,{id:`category`,type:`text`,placeholder:`Select category`,className:B.inputField})]})]})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Team Information`}),(0,H.jsxs)(`div`,{className:B.formGrid,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`team-lead`,className:B.inputLabel,children:`Team Lead`}),(0,H.jsx)(`input`,{id:`team-lead`,type:`text`,placeholder:`Enter team lead name`,className:B.inputField})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`team-size`,className:B.inputLabel,children:`Team Size`}),(0,H.jsx)(`input`,{id:`team-size`,type:`text`,placeholder:`Number of team members`,className:B.inputField})]})]})]}),(0,H.jsx)(`div`,{children:(0,H.jsxs)(`div`,{className:B.formGridThree,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`budget`,className:B.inputLabel,children:`Budget`}),(0,H.jsx)(`input`,{id:`budget`,type:`text`,placeholder:`Enter budget amount`,className:B.inputField})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`label`,{htmlFor:`timeline`,className:B.inputLabel,children:`Timeline`}),(0,H.jsx)(`input`,{id:`timeline`,type:`text`,placeholder:`Project duration`,className:B.inputField})]}),(0,H.jsx)(`button`,{className:B.addButton,children:`+`})]})}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(`h3`,{className:B.formSectionTitle,children:`Project Documents`}),(0,H.jsxs)(`div`,{className:B.fileUploadArea,children:[(0,H.jsx)(`button`,{className:B.uploadButton,children:`☁️ Upload file`}),(0,H.jsx)(`div`,{className:B.uploadText,children:`or drag and drop to upload`})]})]})]})}),(0,H.jsx)(p.Footer,{children:(0,H.jsxs)(`div`,{className:B.customFooter,children:[(0,H.jsx)(`div`,{className:B.statusBadge,children:`All done`}),(0,H.jsxs)(p.Actions,{className:B.customActions,children:[(0,H.jsx)(`button`,{className:B.footerButton,children:`Discard`}),(0,H.jsx)(`button`,{className:B.footerButtonPrimary,children:`Save Changes`})]})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open custom modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(W.getByText(`Project Details`)).toBeVisible();let n=W.getByRole(`button`,{name:/✕/i});await G.click(n),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`A custom modal with custom header and footer content, demonstrating how to override the default modal structure with custom components.`}}}},Q={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Modal with Icon`}),(0,H.jsx)(`p`,{children:`Example showing how to add an icon to the modal header.`}),(0,H.jsx)(s,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Modal`})]}),(0,H.jsxs)(p,{open:e,columns:4,onOpenChange:t,children:[(0,H.jsxs)(p.Header,{children:[(0,H.jsx)(i,{icon:`info`,size:`small`}),(0,H.jsx)(p.Title,{children:`Session Timeout`}),(0,H.jsx)(p.CloseTrigger,{})]}),(0,H.jsx)(p.Body,{children:(0,H.jsx)(`p`,{children:`Your session will expire in 5 minutes due to inactivity.`})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(W.getByRole(`heading`,{name:/session timeout/i})).toBeVisible(),await U(W.getByText(/session will expire/i)).toBeVisible(),await G.keyboard(`{Escape}`),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`Example showing how to add an icon to the modal header by composing DsIcon with DsModal.Header.`}}}},$={render:function(){let[e,t]=(0,V.useState)(!1);return(0,H.jsxs)(`div`,{className:B.storyContainer,children:[(0,H.jsxs)(`div`,{className:B.storyHeader,children:[(0,H.jsx)(`h2`,{children:`Modal Without Header`}),(0,H.jsx)(`p`,{children:`Modal with only body and footer content, no header section.`}),(0,H.jsx)(s,{design:`v1.2`,size:`large`,onClick:()=>t(!0),children:`Open Modal`})]}),(0,H.jsxs)(p,{open:e,columns:4,onOpenChange:t,children:[(0,H.jsx)(p.Body,{children:(0,H.jsx)(`p`,{children:`This modal has no header section. Use this pattern when you want a cleaner look without the header underline.`})}),(0,H.jsx)(p.Footer,{children:(0,H.jsxs)(p.Actions,{children:[(0,H.jsx)(s,{design:`v1.2`,buttonType:`secondary`,size:`large`,onClick:()=>t(!1),children:`Close`}),(0,H.jsx)(s,{design:`v1.2`,variant:`filled`,size:`large`,onClick:()=>t(!1),children:`Continue`})]})})]})]})},play:async({canvasElement:e})=>{let t=q(e).getByRole(`button`,{name:/open modal/i});await G.click(t),await K(()=>U(W.getByRole(`dialog`)).toBeVisible()),await U(q(W.getByRole(`dialog`)).getByText(/no header section/i)).toBeVisible();let n=W.getByRole(`button`,{name:/continue/i});await U(n).toBeVisible(),await G.click(n),await K(()=>U(W.queryByRole(`dialog`)).not.toBeInTheDocument())},parameters:{docs:{description:{story:`Modal without a header component - use this pattern instead of a variant when you want no header underline.`}}}},Y.parameters={...Y.parameters,docs:{...Y.parameters?.docs,source:{originalSource:`{
