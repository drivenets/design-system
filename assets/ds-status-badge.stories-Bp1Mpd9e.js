import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-V7H8WQFa.js";import{n,t as r}from"./ds-typography-ClnFnIDB.js";import{n as i,t as a}from"./ds-stack-DC_qSfFt.js";import{n as o,t as s}from"./ds-status-badge-zfU9iS1i.js";var c,l;function u(){return(u=e((()=>{c=[`active`,`running`,`pending`,`draft`,`inactive`,`warning`,`failed`],l=[`medium`,`small`]})))()}var d,f,p,m,h,g,_;function v(){return(v=e((()=>{s(),u(),i(),r(),d=t(),f={title:`Components/StatusBadge`,component:o,parameters:{layout:`centered`},argTypes:{icon:{control:`text`,description:`Icon to display in the badge`},status:{control:`select`,options:c,description:`Status type of the badge`},label:{control:`text`,description:`Optional label to display instead of the default status text`},ghost:{control:`boolean`,description:`Whether the badge should use ghost style (light background)`},size:{control:`select`,options:l,description:`Size of the status badge`},className:{table:{disable:!0}},style:{table:{disable:!0}}}},p={args:{icon:`check_circle`,status:`active`}},m={args:{icon:`check_circle`,status:`active`,ghost:!0}},h={args:{icon:`check_circle`,status:`active`,size:`small`}},g={tags:[`!manifest`],parameters:{docs:{canvas:{sourceState:`none`}}},render:()=>{let e={active:`check_circle`,running:`change_circle`,pending:`pause_circle`,draft:`stylus_note`,inactive:`stop_circle`,warning:`warning`,failed:`cancel`};return(0,d.jsxs)(a,{direction:`column`,gap:`var(--xl)`,children:[(0,d.jsxs)(a,{direction:`row`,gap:`var(--3xl)`,children:[(0,d.jsxs)(a,{direction:`column`,gap:`var(--sm)`,children:[(0,d.jsx)(n,{variant:`body-sm-md`,color:`secondary`,children:`Filled`}),(0,d.jsx)(a,{direction:`column`,gap:`var(--xs)`,alignItems:`flex-start`,children:c.map(t=>(0,d.jsx)(o,{icon:e[t],status:t},`filled-${t}`))})]}),(0,d.jsxs)(a,{direction:`column`,gap:`var(--sm)`,children:[(0,d.jsx)(n,{variant:`body-sm-md`,color:`secondary`,children:`Ghost`}),(0,d.jsx)(a,{direction:`column`,gap:`var(--xs)`,alignItems:`flex-start`,children:c.map(t=>(0,d.jsx)(o,{icon:e[t],status:t,ghost:!0},`ghost-${t}`))})]})]}),(0,d.jsxs)(a,{direction:`row`,gap:`var(--3xl)`,children:[(0,d.jsxs)(a,{direction:`column`,gap:`var(--sm)`,children:[(0,d.jsx)(n,{variant:`body-sm-md`,color:`secondary`,children:`Filled — Small`}),(0,d.jsx)(a,{direction:`column`,gap:`var(--xs)`,alignItems:`flex-start`,children:c.map(t=>(0,d.jsx)(o,{icon:e[t],status:t,size:`small`},`filled-small-${t}`))})]}),(0,d.jsxs)(a,{direction:`column`,gap:`var(--sm)`,children:[(0,d.jsx)(n,{variant:`body-sm-md`,color:`secondary`,children:`Ghost — Small`}),(0,d.jsx)(a,{direction:`column`,gap:`var(--xs)`,alignItems:`flex-start`,children:c.map(t=>(0,d.jsx)(o,{icon:e[t],status:t,ghost:!0,size:`small`},`ghost-small-${t}`))})]})]})]})}},_=[`Default`,`Ghost`,`Small`,`All`],p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    icon: 'check_circle',
    status: 'active'
  }
...
}`,...g.parameters?.docs?.source},description:{story:`Every status across filled/ghost styles and both sizes, for visual comparison.`,...g.parameters?.docs?.description}}}})))()}v();export{g as All,p as Default,m as Ghost,h as Small,_ as __namedExportsOrder,f as default};