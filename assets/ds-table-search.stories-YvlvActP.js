import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{X as n}from"./iframe-AZ-wAHM1.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{n as i,t as a}from"./ds-table-DQTRXHfc.js";import{t as o}from"./ds-smart-tabs-ap9Hjlr7.js";import{t as s}from"./ds-smart-tabs-Dhs55Nl2.js";import{n as c,t as l}from"./ds-table.stories.module-BH4xkOob.js";import{c as u,i as d,l as f,n as p,t as m,u as h}from"./components-CX7DPFvP.js";import{n as g,t as _}from"./story-decorators-9jfApPlh.js";var v,y,b,x,S,C;e((()=>{v=t(n(),1),s(),i(),c(),h(),g(),m(),y=r(),b={title:`Components/Table/Filters`,component:a,parameters:{layout:`fullscreen`},args:{columns:u,data:f,stickyHeader:!0,bordered:!0,fullWidth:!0,expandable:!1,emptyState:(0,y.jsx)(p,{}),onRowClick:e=>console.log(`Row clicked:`,e)},decorators:[_]},x={name:`Search — Global Input`,render:function(e){let[t,n]=(0,v.useState)(``),r=(0,v.useMemo)(()=>{if(!t)return e.data;let n=t.toLowerCase();return e.data.filter(e=>Object.values(e).some(e=>String(e).toLowerCase().includes(n)))},[t,e.data]);return(0,y.jsxs)(`div`,{children:[(0,y.jsx)(`div`,{style:{marginBottom:`1rem`},children:(0,y.jsx)(`input`,{type:`text`,value:t,onChange:e=>n(e.target.value),placeholder:`Search all columns...`,style:{padding:`0.5rem`,width:`300px`}})}),(0,y.jsx)(a,{...e,data:r})]})}},S={name:`Tabs — Status Filter`,render:function(e){let[t,n]=(0,v.useState)([]),[r,i]=(0,v.useState)(`all`),s=e=>{let t=e;i(t),n(t===`all`?[]:[{id:`status`,value:t}])},c=e=>{switch(e){case`relationship`:return`favorite`;case`complicated`:return`psychology`;default:return`person`}},u={accessorKey:`status`,header:`Status`,cell:e=>{let t=e.getValue();return(0,y.jsx)(d,{icon:c(t),label:t})}},p=e.columns.map(e=>e.accessorKey===`status`?u:e);return(0,y.jsxs)(`div`,{className:l.tableFilterContainer,children:[(0,y.jsxs)(o,{activeTab:r,onTabClick:s,children:[(0,y.jsx)(o.Tab,{label:`All People`,value:`all`,icon:`groups`,color:`dark-blue`,content:f.length}),(0,y.jsx)(o.Tab,{label:`In a Relationship`,value:`relationship`,icon:`favorite`,color:`green`,content:f.filter(e=>e.status===`relationship`).length}),(0,y.jsx)(o.Tab,{label:`It's Complicated`,value:`complicated`,icon:`psychology`,color:`red`,content:f.filter(e=>e.status===`complicated`).length}),(0,y.jsx)(o.Tab,{label:`Single`,value:`single`,icon:`person`,color:`gray`,content:f.filter(e=>e.status===`single`).length})]}),(0,y.jsx)(a,{...e,columns:p,columnFilters:t,onColumnFiltersChange:n})]})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
