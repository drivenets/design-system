import{a as e,n as t}from"./chunk-BneVvdWh.js";import{S as n}from"./iframe-BC0CjoRk.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{t as i}from"./classnames-DN2IqHsz.js";import{t as a}from"./compiler-runtime-nX8mKx1K.js";import{i as o}from"./ds-icon.types-BYNtKUV3.js";import{t as s}from"./ds-icon-MUu2GB8N.js";import{n as c,t as l}from"./ds-typography-le9kry9g.js";import{n as u,t as d}from"./ds-button-CIj8fQcq.js";import{r as f}from"./ds-text-input.types-CDq9_5KD.js";import{t as p}from"./ds-text-input-CXpFmY3c.js";import{n as m,t as h}from"./ds-drawer-C4s52t2w.js";import{i as g,r as _,t as v}from"./ds-system-status.types-Bz6eNdox.js";var y=t((()=>{g(),v()})),b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I=t((()=>{b=`_description_yyopy_1`,x=`_headerActions_yyopy_6`,S=`_expand_yyopy_10`,C=`_divider_yyopy_14`,w=`_tabs_yyopy_21`,T=`_tab_yyopy_21`,E=`_selected_yyopy_40`,D=`_body_yyopy_45`,O=`_bodyGrid_yyopy_50`,k=`_section_yyopy_56`,A=`_sectionHeader_yyopy_62`,j=`_sectionContent_yyopy_65`,M=`_storyWrapper_yyopy_75`,N=`_responsiveButtons_yyopy_79`,P=`_contentSection_yyopy_86`,F={description:b,headerActions:x,expand:S,divider:C,tabs:w,tab:T,selected:E,body:D,bodyGrid:O,section:k,sectionHeader:A,sectionContent:j,storyWrapper:M,responsiveButtons:N,contentSection:P}})),L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z;t((()=>{L=a(),R=e(n(),1),z=e(i(),1),m(),d(),p(),s(),y(),I(),l(),B=r(),V={title:`Components/Drawer`,component:h,parameters:{layout:`fullscreen`,docs:{description:{component:`
