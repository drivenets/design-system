import{a as e,n as t}from"./rolldown-runtime-DkW27tQK.js";import{n}from"./iframe-CjiQ0Gqr.js";import{t as r}from"./compiler-runtime-qQQXpJgv.js";import{t as i}from"./classnames-D09xBJOL.js";import{n as a,t as o}from"./ds-button-v3-JsnnMoG0.js";import{n as s,t as c}from"./ds-stack-rLkmoLJd.js";var l,u,d;function f(){return(f=t((()=>{l=[`primary`,`primary-subtle`,`secondary`,`tertiary`],u=[`default`,`error`,`light`],d=[`large`,`medium`,`small`,`tiny`]})))()}var p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=t((()=>{p=`_matrix_2qas9_1`,m=`_sectionTitle_2qas9_8`,h=`_columnHeaders_2qas9_18`,g=`_columnHeader_2qas9_18`,_=`_rowLabel_2qas9_35`,v=`_onDark_2qas9_45`,y=`_onDarkLabel_2qas9_51`,b=`_onDarkSectionTitle_2qas9_55`,x=`_sectionTitleSpaced_2qas9_59`,S=`_onDarkColumnHeader_2qas9_63`,C={matrix:p,sectionTitle:m,columnHeaders:h,columnHeader:g,rowLabel:_,onDark:v,onDarkLabel:y,onDarkSectionTitle:b,sectionTitleSpaced:x,onDarkColumnHeader:S}})))()}var T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J;function Y(){return(Y=t((()=>{T=r(),E=e(i(),1),a(),f(),w(),s(),D=n(),{fn:O}=__STORYBOOK_MODULE_TEST__,k={title:`Components/ButtonV3`,component:o,parameters:{layout:`centered`},argTypes:{color:{control:`select`,options:u},variant:{control:`select`,options:l},size:{control:`select`,options:d},loading:{control:`boolean`},disabled:{control:`boolean`},highEmphasis:{control:`boolean`},className:{table:{disable:!0}},style:{table:{disable:!0}},ref:{table:{disable:!0}}},args:{onClick:O()}},A={args:{color:`default`,variant:`primary`,size:`medium`,icon:`check_circle`,children:`Button`}},j={color:`default`,size:`medium`,icon:`check_circle`,children:`Button`},M={args:{...j,variant:`primary`,loading:!0}},N={args:{...j,variant:`primary`,disabled:!0}},P={args:{color:`default`,size:`medium`,variant:`primary`,icon:`check_circle`,"aria-label":`Confirm`}},F={args:{...j,variant:`secondary`,selected:!0}},I={args:{...j,variant:`primary`,highEmphasis:!0}},L={args:{...j,color:`light`,variant:`primary`},decorators:[e=>(0,D.jsx)(`div`,{className:C.onDark,children:(0,D.jsx)(e,{})})]},R={render:()=>(0,D.jsxs)(c,{direction:`row`,alignItems:`center`,gap:`var(--sm)`,children:[(0,D.jsx)(o,{size:{lg:`large`,md:`small`},children:`lg: large / md: small`}),(0,D.jsx)(o,{size:{lg:`medium`,md:`tiny`},children:`lg: medium / md: tiny`}),(0,D.jsx)(o,{size:`medium`,children:`static: medium`})]})},z=e=>[...(e===`light`?l.filter(e=>e!==`primary-subtle`):l).map(e=>({label:e,loading:!1})),{label:`loading`,loading:!0}],B=[{label:`check circle`,icon:`check_circle`,variant:`primary`,color:`default`,loading:!1},{label:`info`,icon:`info`,variant:`secondary`,color:`default`,loading:!1},{label:`delete`,icon:`delete`,variant:`tertiary`,color:`error`,loading:!1},{label:`loading`,icon:`check_circle`,variant:`primary`,color:`default`,loading:!0}],V=[{label:`arrow down`,icon:`keyboard_arrow_down`,variant:`primary`,color:`light`,loading:!1},{label:`home`,icon:`home`,variant:`secondary`,color:`light`,loading:!1},{label:`info`,icon:`info`,variant:`tertiary`,color:`light`,loading:!1},{label:`loading`,icon:`info`,variant:`primary`,color:`light`,loading:!0}],H=e=>{let t=(0,T.c)(7),{color:n}=e,r=n===`light`,i;if(t[0]!==n||t[1]!==r){let e=z(n),a;t[3]===r?a=t[4]:(a=d.map(e=>(0,D.jsx)(`span`,{className:(0,E.default)(C.columnHeader,{[C.onDarkColumnHeader]:r}),children:e},e)),t[3]=r,t[4]=a);let s;t[5]===a?s=t[6]:(s=(0,D.jsx)(`div`,{className:C.columnHeaders,children:a}),t[5]=a,t[6]=s),i=(0,D.jsxs)(c,{gap:`var(--sm)`,children:[s,e.map(e=>{let{label:t,loading:i}=e;return(0,D.jsxs)(c,{direction:`row`,alignItems:`center`,gap:`var(--sm)`,children:[(0,D.jsx)(`span`,{className:(0,E.default)(C.rowLabel,{[C.onDarkLabel]:r}),children:t}),d.map(e=>(0,D.jsx)(c,{direction:`row`,justifyContent:`center`,flex:1,children:(0,D.jsx)(o,{color:n,variant:i?`primary`:t,size:e,icon:`check_circle`,loading:i,children:e===`tiny`?void 0:`Button`})},e))]},t)})]}),t[0]=n,t[1]=r,t[2]=i}else i=t[2];return i},U=e=>{let t=(0,T.c)(12),{rows:n,isOnDark:r}=e,i=r!==void 0&&r,a;t[0]===i?a=t[1]:(a=d.map(e=>(0,D.jsx)(`span`,{className:(0,E.default)(C.columnHeader,{[C.onDarkColumnHeader]:i}),children:e},e)),t[0]=i,t[1]=a);let s;t[2]===a?s=t[3]:(s=(0,D.jsx)(`div`,{className:C.columnHeaders,children:a}),t[2]=a,t[3]=s);let l;if(t[4]!==i||t[5]!==n){let e;t[7]===i?e=t[8]:(e=e=>{let{label:t,icon:n,loading:r,variant:a,color:s}=e;return(0,D.jsxs)(c,{direction:`row`,alignItems:`center`,gap:`var(--sm)`,children:[(0,D.jsx)(`span`,{className:(0,E.default)(C.rowLabel,{[C.onDarkLabel]:i}),children:t}),d.map(e=>{let i=`${t} ${e}`;return(0,D.jsx)(c,{direction:`row`,justifyContent:`center`,flex:1,children:(0,D.jsx)(o,{color:s,variant:a,size:e,icon:n,loading:r,"aria-label":i})},e)})]},t)},t[7]=i,t[8]=e),l=n.map(e),t[4]=i,t[5]=n,t[6]=l}else l=t[6];let u;return t[9]!==s||t[10]!==l?(u=(0,D.jsxs)(c,{gap:`var(--sm)`,children:[s,l]}),t[9]=s,t[10]=l,t[11]=u):u=t[11],u},W={tags:[`!manifest`],parameters:{layout:`fullscreen`,docs:{canvas:{sourceState:`none`}}},render:()=>(0,D.jsxs)(`div`,{className:C.matrix,children:[(0,D.jsx)(`p`,{className:C.sectionTitle,children:`Default`}),(0,D.jsx)(H,{color:`default`})]})},G={tags:[`!manifest`],parameters:{layout:`fullscreen`,docs:{canvas:{sourceState:`none`}}},render:()=>(0,D.jsxs)(`div`,{className:C.matrix,children:[(0,D.jsx)(`p`,{className:C.sectionTitle,children:`Error`}),(0,D.jsx)(H,{color:`error`})]})},K={tags:[`!manifest`],parameters:{layout:`fullscreen`,docs:{canvas:{sourceState:`none`}}},render:()=>(0,D.jsx)(`div`,{className:C.matrix,children:(0,D.jsxs)(`div`,{className:C.onDark,children:[(0,D.jsx)(`p`,{className:(0,E.default)(C.sectionTitle,C.onDarkSectionTitle),children:`On Dark — Default`}),(0,D.jsx)(H,{color:`light`})]})})},q={tags:[`!manifest`],parameters:{layout:`fullscreen`,docs:{canvas:{sourceState:`none`}}},render:()=>(0,D.jsxs)(`div`,{className:C.matrix,children:[(0,D.jsx)(`p`,{className:C.sectionTitle,children:`Icons — Default`}),(0,D.jsx)(U,{rows:B}),(0,D.jsxs)(`div`,{className:C.onDark,children:[(0,D.jsx)(`p`,{className:(0,E.default)(C.sectionTitle,C.onDarkSectionTitle,C.sectionTitleSpaced),children:`Icons — On Dark`}),(0,D.jsx)(U,{rows:V,isOnDark:!0})]})]})},J=[`Default`,`Loading`,`Disabled`,`IconOnly`,`Selected`,`HighEmphasis`,`OnDark`,`ResponsiveSize`,`MatrixDefault`,`MatrixError`,`MatrixOnDark`,`MatrixIcons`],A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'default',
    variant: 'primary',
    size: 'medium',
...
}`,...q.parameters?.docs?.source}}}})))()}Y();export{A as Default,N as Disabled,I as HighEmphasis,P as IconOnly,M as Loading,W as MatrixDefault,G as MatrixError,q as MatrixIcons,K as MatrixOnDark,L as OnDark,R as ResponsiveSize,F as Selected,J as __namedExportsOrder,k as default};