...
}`,...g.parameters?.docs?.source},description:{story:"Replace the bundled art with a custom `DsIllustration`. Variant still\nselects the default message unless `message` is also passed.",...g.parameters?.docs?.description}}}})))()}v();export{g as CustomIllustration,f as Default,h as Message,p as NoMatches,m as WithAction,_ as __namedExportsOrder,d as default};