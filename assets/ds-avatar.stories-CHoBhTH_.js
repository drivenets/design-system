...
}`,...h.parameters?.docs?.source},description:{story:"Visual reference for every size token, from `xsm` to `xl`. Pick the size that\nmatches the surrounding density; `regular` is the default.",...h.parameters?.docs?.description}}}}))();export{d as Default,p as ImageFallback,m as Rounded,h as Sizes,f as WithImage,g as __namedExportsOrder,u as default};