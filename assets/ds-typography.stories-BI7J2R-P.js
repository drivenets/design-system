import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t}from"./iframe-DVysNJuQ.js";import{c as n,n as r,o as i,s as a,t as o}from"./ds-typography-Cu_YN1U3.js";import{n as s,t as c}from"./ds-stack-Dy-M5AZb.js";var l,u,d;function f(){return(f=e((()=>{l=`_onDark_f3uze_1`,u=`_truncateBox_f3uze_6`,d={onDark:l,truncateBox:u}})))()}var p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A;function j(){return(j=e((()=>{s(),o(),i(),f(),p=t(),m=Object.keys(n),h=`The quick brown fox jumps over the lazy dog.`,g=[`on-action`,`on-disabled`,`light-disabled`],_=e=>(0,p.jsx)(`div`,{className:d.truncateBox,children:(0,p.jsx)(e,{})}),v={title:`Components/Typography`,component:r,parameters:{layout:`padded`},argTypes:{variant:{control:`select`,options:m},color:{control:`select`,options:a},asChild:{control:`boolean`},truncate:{control:`select`,options:[`off`,`single`,`2 lines`,`3 lines`],mapping:{off:!1,single:!0,"2 lines":2,"3 lines":3}},tooltip:{control:`boolean`},tooltipContent:{table:{disable:!0}},className:{table:{disable:!0}},style:{table:{disable:!0}},ref:{table:{disable:!0}}},args:{variant:`body-md-reg`,children:`The quick brown fox jumps over the lazy dog.`}},y={args:{variant:`body-md-reg`,color:`main`,children:`The quick brown fox jumps over the lazy dog.`}},b={args:{variant:`heading3`,children:`The quick brown fox jumps over the lazy dog.`}},x={args:{variant:`body-md-reg`,color:`secondary`,children:`The quick brown fox jumps over the lazy dog.`}},S={args:{variant:`body-md-reg`,color:`var(--color-dap-purple-600)`,children:`The quick brown fox jumps over the lazy dog.`}},C={parameters:{controls:{disable:!0}},render:()=>(0,p.jsx)(r,{variant:`body-md-link`,asChild:!0,children:(0,p.jsx)(`a`,{href:`https://example.com`,children:`Link rendered via asChild`})})},w={args:{variant:`body-md-reg`,truncate:!0,children:`The quick brown fox jumps over the lazy dog while the sleepy cat watches from the warm windowsill nearby.`},decorators:[_]},T={args:{variant:`body-md-reg`,truncate:2,children:`The quick brown fox jumps over the lazy dog while the sleepy cat watches from the warm windowsill nearby.`},decorators:[_]},E={args:{variant:`body-md-reg`,truncate:!0,tooltip:!0,children:`The quick brown fox jumps over the lazy dog while the sleepy cat watches from the warm windowsill nearby.`},decorators:[_]},D={tags:[`!manifest`],parameters:{controls:{disable:!0},docs:{canvas:{sourceState:`none`}}},render:()=>(0,p.jsx)(c,{direction:`column`,gap:`var(--md)`,children:m.map(e=>(0,p.jsxs)(c,{direction:`column`,gap:`var(--3xs)`,children:[(0,p.jsx)(r,{variant:`code-xs-reg`,color:`secondary`,children:e}),(0,p.jsx)(r,{variant:e,children:h})]},e))})},O={tags:[`!manifest`],parameters:{controls:{disable:!0},docs:{canvas:{sourceState:`none`}}},render:()=>(0,p.jsx)(c,{direction:`column`,gap:`var(--sm)`,children:a.filter(e=>!g.includes(e)).map(e=>(0,p.jsxs)(c,{direction:`column`,gap:`var(--3xs)`,children:[(0,p.jsx)(r,{variant:`code-xs-reg`,color:`secondary`,children:e}),(0,p.jsx)(r,{variant:`body-md-md`,color:e,children:h})]},e))})},k={tags:[`!manifest`],parameters:{controls:{disable:!0},layout:`fullscreen`,docs:{canvas:{sourceState:`none`}}},render:()=>(0,p.jsx)(c,{className:d.onDark,direction:`column`,gap:`var(--sm)`,children:g.map(e=>(0,p.jsxs)(c,{direction:`column`,gap:`var(--3xs)`,children:[(0,p.jsx)(r,{variant:`code-xs-reg`,color:`var(--secondary-300)`,children:e}),(0,p.jsx)(r,{variant:`body-md-md`,color:e,children:h})]},e))})},A=[`Default`,`Heading`,`Color`,`CustomColor`,`AsChild`,`Truncate`,`TruncateMultiline`,`TruncateWithTooltip`,`Variants`,`Colors`,`ColorsOnDark`],y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'body-md-reg',
    color: 'main',
...
}`,...k.parameters?.docs?.source},description:{story:`Colors intended for dark or accent backgrounds.`,...k.parameters?.docs?.description}}}})))()}j();export{C as AsChild,x as Color,O as Colors,k as ColorsOnDark,S as CustomColor,y as Default,b as Heading,w as Truncate,T as TruncateMultiline,E as TruncateWithTooltip,D as Variants,A as __namedExportsOrder,v as default};