import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as j}from"./iframe-zD3xWcdw.js";import{D as L}from"./ds-icon-BN8hZyrB.js";import{D as q}from"./ds-table-ZkDsxhdx.js";import{D as A}from"./ds-button-BdznL9NY.js";import{D as k}from"./ds-modal-CosQTv-F.js";import{D as V}from"./ds-vertical-tabs-gSA19sER.js";import{D as w}from"./ds-typography-_LYOBaEj.js";import{D as Y}from"./ds-chip-group-C_kdTJGR.js";import{D as le}from"./ds-status-badge-Bkg9-7sk.js";import{D as ie}from"./ds-checkbox-BbRcjznU.js";import{D as M}from"./ds-text-input-BX9iwyT6.js";import{c as ne}from"./index-Bkff790b.js";import{s as g}from"./ds-table.stories.module-D_XXzStM.js";import"./preload-helper-PPVm8Dsz.js";import"./core-table-CfB1bO0T.js";import"./index-pOsGLtSz.js";import"./index-Moyb4GcP.js";import"./ds-dropdown-menu-Zgh2Om15.js";import"./index-Lru2z4ct.js";import"./index-BhXYnqkn.js";import"./index-C1cXfuue.js";import"./Combination-k7ot5OvW.js";import"./index-B28m74jq.js";import"./floating-ui.dom-D3zTlarL.js";import"./index-D6vZ8kzq.js";import"./index-CsmTiFYQ.js";import"./portal-12HeV4JI.js";import"./create-split-props-u5h9OPvL.js";import"./use-locale-context-1K7Qlzt9.js";import"./create-anatomy-D0xiuNN3.js";import"./use-presence-CE8N0BSk.js";import"./set-V1TTXNUl.js";import"./raf-CC9hSMXO.js";import"./computed-style-CPj1S2On.js";import"./event-CBXSxTbR.js";import"./index-BZXhRXCF.js";import"./get-styles-Bj9uhrHC.js";import"./typeahead-gxZSEoSi.js";import"./query-CjgVAlRR.js";import"./initial-focus-Dp33qkhY.js";import"./equal-DfFTejAs.js";import"./mutation-observer-Cu1ou0At.js";import"./dismissable-layer-BJ3bHEFQ.js";import"./navigate-B9wmqn6f.js";import"./merge-refs-DX9dreSa.js";import"./ds-button-legacy-CnHe_j44.js";import"./ds-button-new-C28yRHBL.js";import"./dialog-title-CSfVHgWG.js";import"./render-strategy-BFVx5JED.js";import"./tabs-root-BOStBdzV.js";import"./number-Bu-e0fmS.js";import"./resize-observer-ByPftmjk.js";import"./index-CYZU-zwO.js";import"./index-C7aMgrX0.js";import"./ds-chip-CSmAJqg9.js";function Q({filterAdapters:t,baseColumns:a,appliedFilters:l,onFiltersChange:o}){const i=t,u=l!==void 0&&o!==void 0,h=i.reduce((y,p)=>({...y,[p.id]:p.initialValue}),{}),[c,n]=j.useState({}),[r,d]=j.useState({}),m=u?l:c,s=u?o:n,C={...h,...m,...r},B=Object.entries(m).filter(([y])=>{const p=i.find(F=>F.id===y);return p?p.getActiveFiltersCount(m[y])>0:!1}).map(([y,p])=>({id:y,value:p})),R=i.flatMap(y=>{const p=m[y.id];return p!==void 0?y.toChips(p):[]}),S=i.map(y=>({id:y.id,label:y.label,count:y.getActiveFiltersCount(C[y.id])})),b=a?a.map(y=>{const p=i.find(N=>N.id===y.id);if(!p)return y;const F=p.cellRenderer;return{...y,filterFn:p.columnFilterFn,...F&&{cell:N=>F(N.getValue())}}}):[],O=(y,p)=>{d(F=>({...F,[y]:p}))};return{filterState:C,columnFilters:B,filterChips:R,filterNavItems:S,enhancedColumns:b,handlers:{updateFilter:O,applyFilters:()=>{const y=i.reduce((p,F)=>{const N=C[F.id];return F.getActiveFiltersCount(N)>0&&(p[F.id]=N),p},{});s(y),d({})},clearAll:()=>{d({}),s({})},deleteChip:y=>{const p=typeof y.metadata?.key=="string"?y.metadata.key:void 0;if(!p)return;const F=i.find(z=>z.id===p);if(!F)return;const N=m[p];if(N===void 0)return;const E=F.fromChip(y,N),se=F.getActiveFiltersCount(E)===0?Object.fromEntries(Object.entries(m).filter(([z])=>z!==p)):{...m,[p]:E};s(se)}},renderFilterContent:y=>{const p=i.find(E=>E.id===y.id);if(!p)return null;const F=C[p.id],N=E=>O(p.id,E);return p.renderFilter(F,N)}}}function U(t){return{id:t.id,label:t.label,initialValue:t.initialValue,columnFilterFn:t.filterFn,cellRenderer:t.cellRenderer,toChips:t.toChips,fromChip:t.fromChip,getActiveFiltersCount:t.getActiveFiltersCount,reset:()=>t.initialValue,renderFilter:t.renderFilter}}const X=({items:t,renderer:a,selectedItems:l,onSelectionChange:o})=>{const i=(u,h)=>{o(h?[...l,u]:l.filter(c=>c.value!==u.value))};return t.map(u=>{const h=a?a(u):u.label,c=l.findIndex(n=>n.value===u.value)>-1;return e.jsx(ie,{label:h,checked:c,onCheckedChange:n=>i(u,n===!0)},JSON.stringify(u.value))})};function re(t){const{id:a,label:l,items:o,renderer:i,chipLabelTemplate:u=n=>`${l}: ${n.label}`,cellRenderer:h,getRowValue:c=n=>n.getValue(a)}=t;return U({id:a,label:l,initialValue:[],filterFn:(n,r,d)=>{if(d.length===0)return!0;const m=c(n);return d.some(s=>s.value===m)},cellRenderer:h,toChips:n=>n.map(r=>({id:`${a}_${String(r.value)}`,label:u(r),metadata:{key:a,value:r.value}})),fromChip:(n,r)=>r.filter(d=>d.value!==n.metadata?.value),getActiveFiltersCount:n=>n.length,renderFilter:(n,r)=>e.jsx(X,{items:o,renderer:i,selectedItems:n,onSelectionChange:r})})}const oe="_container_u6rur_1",ce="_header_u6rur_9",de="_inputs_u6rur_15",me="_inputGroup_u6rur_20",_={container:oe,header:ce,inputs:de,inputGroup:me},Z=({label:t,value:a,onChange:l,onClear:o})=>{const[i,u]=j.useState(a.from?.toString()||""),[h,c]=j.useState(a.to?.toString()||""),n=s=>{u(s);const C=s?parseInt(s,10):void 0;l({from:C,to:a.to})},r=s=>{c(s);const C=s?parseInt(s,10):void 0;l({from:a.from,to:C})},d=()=>{u(""),c(""),o&&o()},m=a.from!==void 0||a.to!==void 0;return e.jsxs("div",{className:_.container,children:[e.jsxs("div",{className:_.header,children:[e.jsx(w,{variant:"body-md-md",children:t}),m&&o&&e.jsx(A,{design:"v1.2",buttonType:"tertiary",size:"small",onClick:d,children:"Clear"})]}),e.jsxs("div",{className:_.inputs,children:[e.jsxs("div",{className:_.inputGroup,children:[e.jsx(w,{variant:"body-sm-reg",children:"From"}),e.jsx(M,{type:"number",placeholder:"",value:i,onValueChange:n,size:"default"})]}),e.jsxs("div",{className:_.inputGroup,children:[e.jsx(w,{variant:"body-sm-reg",children:"To"}),e.jsx(M,{type:"number",placeholder:"",value:h,onValueChange:r,size:"default"})]})]})]})};Z.__docgenInfo={description:"",methods:[],displayName:"RangeFilter",props:{label:{required:!0,tsType:{name:"string"},description:""},value:{required:!0,tsType:{name:"RangeFilterValue"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: RangeFilterValue) => void",signature:{arguments:[{type:{name:"RangeFilterValue"},name:"value"}],return:{name:"void"}}},description:""},onClear:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};function ue(t){const{id:a,label:l,fields:o,formatNumber:i=c=>c.toLocaleString("en-US"),getRowValue:u=c=>c.getValue(a)}=t,h={};return Object.keys(o).forEach(c=>{h[c]={}}),U({id:a,label:l,initialValue:h,filterFn:(c,n,r)=>{const d=u(c);for(const[m,s]of Object.entries(r)){const C=s.from!==void 0||s.to!==void 0,B=d[m];if(C&&B!==void 0){const R=s.from===void 0||B>=s.from,S=s.to===void 0||B<=s.to;if(!R||!S)return!1}}return!0},cellRenderer:void 0,toChips:c=>{const n=[];return Object.entries(c).forEach(([r,d])=>{if(d.from!==void 0||d.to!==void 0){const s=o[r]||r,C=d.from!==void 0?i(d.from):"",B=d.to!==void 0?i(d.to):"";n.push({id:`${a}_${r}`,label:`${s}: From ${C} to ${B}`,metadata:{key:a,field:r,from:d.from,to:d.to}})}}),n},fromChip:(c,n)=>{const r=c.metadata?.field;return r?{...n,[r]:{}}:n},getActiveFiltersCount:c=>{let n=0;return Object.values(c).forEach(r=>{(r.from!==void 0||r.to!==void 0)&&n++}),n},renderFilter:(c,n)=>e.jsx("div",{children:Object.entries(o).map(([r,d])=>e.jsx(Z,{label:d,value:c[r]||{},onChange:m=>n({...c,[r]:m}),onClear:()=>n({...c,[r]:{}})},r))})})}const pe="_avatar_gwtmy_1",he="_small_gwtmy_9",ge="_medium_gwtmy_13",W={avatar:pe,small:he,medium:ge},K=[{bg:"#E3F2FD",text:"#1976D2"},{bg:"#F3E5F5",text:"#7B1FA2"},{bg:"#E8F5E9",text:"#388E3C"}],ye=t=>{const[a,l]=t.trim().split(" ");return a&&l?`${a[0]}${l[0]}`.toUpperCase():t.slice(0,2).toUpperCase()},G=({name:t,size:a="small",colorIndex:l=0})=>{const o=ye(t),i=K[l%K.length];return e.jsx("div",{className:ne(W.avatar,W[a]),style:{backgroundColor:i?.bg,color:i?.text},children:e.jsx(w,{variant:"body-xs-semi-bold",children:o})})};G.__docgenInfo={description:"",methods:[],displayName:"UserAvatar",props:{name:{required:!0,tsType:{name:"string"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"}]},description:"",defaultValue:{value:"'small'",computed:!1}},colorIndex:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}}}};const fe="_container_sy805_1",be="_section_sy805_7",ve="_header_sy805_14",Ce="_searchWrapper_sy805_20",Te="_searchIcon_sy805_26",xe="_searchInput_sy805_36",Fe="_editorList_sy805_40",De="_editorItem_sy805_45",we="_timeRangeOptions_sy805_51",Ie="_radioOption_sy805_57",ke="_customDateRange_sy805_69",Be="_dateInput_sy805_78",I={container:fe,section:be,header:ve,searchWrapper:Ce,searchIcon:Te,searchInput:xe,editorList:Fe,editorItem:De,timeRangeOptions:we,radioOption:Ie,customDateRange:ke,dateInput:Be},Ne=[{value:"24h",label:"24 hours"},{value:"week",label:"Last week"},{value:"month",label:"Last month"},{value:"3months",label:"Last 3 months"},{value:"custom",label:"Custom"}],ee=({value:t,onChange:a,availableEditors:l})=>{const[o,i]=j.useState(""),h=l.filter(s=>s.name.toLowerCase().includes(o.toLowerCase())).map(s=>({value:s.name,label:s.name,metadata:{colorIndex:s.colorIndex}})),c=h.filter(s=>t.editors.includes(s.value)),n=s=>{a({...t,editors:s.map(C=>C.value)})},r=s=>{a({...t,timeRange:s,...s!=="custom"&&{customFrom:void 0,customTo:void 0}})},d=()=>{a({...t,editors:[]}),i("")},m=()=>{a({...t,timeRange:null,customFrom:void 0,customTo:void 0})};return e.jsxs("div",{className:I.container,children:[e.jsxs("div",{className:I.section,children:[e.jsxs("div",{className:I.header,children:[e.jsx(w,{variant:"body-md-md",children:"Editor"}),t.editors.length>0&&e.jsx(A,{design:"v1.2",buttonType:"tertiary",size:"small",onClick:d,children:"Clear"})]}),e.jsxs("div",{className:I.searchWrapper,children:[e.jsx("div",{className:I.searchIcon,children:e.jsx(L,{icon:"search",size:"tiny"})}),e.jsx(M,{placeholder:"Search",value:o,onValueChange:i,size:"default",className:I.searchInput})]}),e.jsx("div",{className:I.editorList,children:e.jsx(X,{items:h,selectedItems:c,onSelectionChange:n,renderer:s=>e.jsxs("div",{className:I.editorItem,children:[e.jsx(G,{name:s.label,size:"small",colorIndex:s.metadata?.colorIndex||0}),e.jsx(w,{variant:"body-sm-reg",children:s.label})]})})})]}),e.jsxs("div",{className:I.section,children:[e.jsxs("div",{className:I.header,children:[e.jsx(w,{variant:"body-md-md",children:"Last edited"}),t.timeRange&&e.jsx(A,{design:"v1.2",buttonType:"tertiary",size:"small",onClick:m,children:"Clear"})]}),e.jsx("div",{className:I.timeRangeOptions,children:Ne.map(s=>e.jsxs("label",{className:I.radioOption,children:[e.jsx("input",{type:"radio",name:"timeRange",value:s.value,checked:t.timeRange===s.value,onChange:()=>r(s.value)}),e.jsx(w,{variant:"body-sm-reg",children:s.label})]},s.value))}),t.timeRange==="custom"&&e.jsxs("div",{className:I.customDateRange,children:[e.jsxs("div",{className:I.dateInput,children:[e.jsx(w,{variant:"body-sm-reg",children:"From"}),e.jsx(M,{type:"date",value:t.customFrom||"",onValueChange:s=>a({...t,customFrom:s}),size:"default"})]}),e.jsxs("div",{className:I.dateInput,children:[e.jsx(w,{variant:"body-sm-reg",children:"To"}),e.jsx(M,{type:"date",value:t.customTo||"",onValueChange:s=>a({...t,customTo:s}),size:"default"})]})]})]})]})};ee.__docgenInfo={description:"",methods:[],displayName:"LastEditedFilter",props:{value:{required:!0,tsType:{name:"LastEditedFilterValue"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LastEditedFilterValue) => void",signature:{arguments:[{type:{name:"LastEditedFilterValue"},name:"value"}],return:{name:"void"}}},description:""},availableEditors:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ name: string; colorIndex: number }",signature:{properties:[{key:"name",value:{name:"string",required:!0}},{key:"colorIndex",value:{name:"number",required:!0}}]}}],raw:"Array<{ name: string; colorIndex: number }>"},description:""}}};const Re="_container_7pp4u_1",je={container:Re},te=({editor:t,timestamp:a,colorIndex:l=0})=>e.jsxs("div",{className:je.container,children:[e.jsx(G,{name:t,size:"small",colorIndex:l}),e.jsx(w,{variant:"body-sm-reg",children:a})]});te.__docgenInfo={description:"",methods:[],displayName:"LastEditedCell",props:{editor:{required:!0,tsType:{name:"string"},description:""},timestamp:{required:!0,tsType:{name:"string"},description:""},colorIndex:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"0",computed:!1}}}};const Ae=[{value:"active",label:"Active"},{value:"running",label:"Running"},{value:"pending",label:"Pending"},{value:"draft",label:"Draft"},{value:"inactive",label:"Inactive"},{value:"warning",label:"Warning"},{value:"failed",label:"Failed"}],Ve={active:"check_circle",running:"change_circle",pending:"pause_circle",draft:"stylus_note",inactive:"stop_circle",warning:"warning",failed:"cancel"},Se=t=>Ve[t],J=t=>{const a=Se(t);return e.jsx(le,{icon:a,status:t,size:"small"})},Le=re({id:"status",label:"Status",items:Ae,renderer:t=>J(t.value),chipLabelTemplate:t=>`Status: ${t.label}`,cellRenderer:t=>J(t)}),Ee=ue({id:"runningCompleted",label:"Running/Completed",fields:{running:"Running",completed:"Completed"},formatNumber:t=>t.toLocaleString("en-US"),getRowValue:t=>t.getValue("runningCompleted")}),_e=[{name:"Marry Levin",colorIndex:0},{name:"Emery Frank",colorIndex:1},{name:"Ryan Franco",colorIndex:2},{name:"Roger Dias",colorIndex:0},{name:"Chance Booths",colorIndex:1},{name:"Lindsey Westerner",colorIndex:2},{name:"Ruben Stanton",colorIndex:0},{name:"Erin Vertus",colorIndex:1},{name:"Neil Sims",colorIndex:2}],Me=(t,a,l)=>{const o=new Date;if(t==="custom")return{from:a?new Date(a):null,to:l?new Date(l):null};if(!t)return{from:null,to:null};const i=new Date;switch(t){case"24h":i.setHours(o.getHours()-24);break;case"week":i.setDate(o.getDate()-7);break;case"month":i.setMonth(o.getMonth()-1);break;case"3months":i.setMonth(o.getMonth()-3);break}return{from:i,to:o}},Oe=t=>new Date(t),Pe=U({id:"lastEdited",label:"Last edited",initialValue:{editors:[],timeRange:null,customFrom:void 0,customTo:void 0},filterFn:(t,a,l)=>{const o=t.getValue(a),{editors:i,timeRange:u,customFrom:h,customTo:c}=l;let n=!0;i.length>0&&(n=i.includes(o.editor));let r=!0;if(u){const{from:d,to:m}=Me(u,h,c);if(d||m){const s=Oe(o.timestamp);r=(!d||s>=d)&&(!m||s<=m)}}return n&&r},toChips:t=>{const a=[];if(t.editors.forEach(l=>{a.push({id:`editor-${l}`,label:`Editor: ${l}`,metadata:{key:"lastEdited",type:"editor",value:l}})}),t.timeRange){let l="";switch(t.timeRange){case"24h":l="Last edited: Last 24 hours";break;case"week":l="Last edited: Last week";break;case"month":l="Last edited: Last month";break;case"3months":l="Last edited: Last 3 months";break;case"custom":{const o=t.customFrom||"...",i=t.customTo||"...";l=`Last edited: ${o} to ${i}`;break}}a.push({id:"timeRange",label:l,metadata:{key:"lastEdited",type:"timeRange"}})}return a},fromChip:(t,a)=>{const{type:l,value:o}=t.metadata||{};return l==="editor"?{...a,editors:a.editors.filter(i=>i!==o)}:l==="timeRange"?{...a,timeRange:null,customFrom:void 0,customTo:void 0}:a},getActiveFiltersCount:t=>{let a=t.editors.length;return t.timeRange&&(a+=1),a},renderFilter:(t,a)=>e.jsx(ee,{value:t,onChange:a,availableEditors:_e}),cellRenderer:t=>e.jsx(te,{editor:t.editor,timestamp:t.timestamp,colorIndex:t.colorIndex})}),ae=[Le,Ee,Pe],{expect:v,screen:D,userEvent:T,within:H}=__STORYBOOK_MODULE_TEST__,f=[{name:"Marry Levin",colorIndex:0},{name:"Emery Frank",colorIndex:1},{name:"Ryan Franco",colorIndex:2},{name:"Roger Dias",colorIndex:0},{name:"Lindsey Westerner",colorIndex:1},{name:"Neil Sims",colorIndex:2}],$e=[{id:"status",accessorKey:"status",header:"Status",cell:t=>t.getValue()},{id:"name",accessorKey:"name",header:"Name",cell:t=>t.getValue()},{id:"runningCompleted",accessorKey:"runningCompleted",header:"Running/completed",cell:t=>{const a=t.getValue();return`${String(a.running)}/${String(a.completed)}`}},{id:"category",accessorKey:"category",header:"Category",cell:t=>t.getValue()},{id:"version",accessorKey:"version",header:"Version",cell:t=>t.getValue()},{id:"lastEdited",accessorKey:"lastEdited",header:"Last edited"}],ze=[{id:"1",name:"Scheduled Config Backup",status:"active",runningCompleted:{running:3,completed:41},category:"Network Built",version:"000.0003",lastEdited:{editor:f[0].name,timestamp:"2025-11-26T16:47:00",colorIndex:f[0].colorIndex}},{id:"2",name:"Network Provisioning",status:"running",runningCompleted:{running:8,completed:14},category:"Network Built",version:"000.0002",lastEdited:{editor:f[1].name,timestamp:"2025-11-26T15:32:00",colorIndex:f[1].colorIndex}},{id:"3",name:"Service Provisioning",status:"inactive",runningCompleted:{running:0,completed:243},category:"Network Built",version:"000.0033",lastEdited:{editor:f[2].name,timestamp:"2025-11-25T11:15:00",colorIndex:f[2].colorIndex}},{id:"4",name:"Assign IPv4 Address",status:"active",runningCompleted:{running:14,completed:123},category:"Network Built",version:"000.0001",lastEdited:{editor:f[3].name,timestamp:"2025-11-24T14:20:00",colorIndex:f[3].colorIndex}},{id:"5",name:"Shutdown Decommissioned Device",status:"active",runningCompleted:{running:45,completed:45},category:"Optical Optimization",version:"000.0022",lastEdited:{editor:f[4].name,timestamp:"2025-11-23T13:05:00",colorIndex:f[4].colorIndex}},{id:"6",name:"Optical Power Level Calibration",status:"draft",runningCompleted:{running:99,completed:23},category:"Optical Optimization",version:"000.0001",lastEdited:{editor:f[5].name,timestamp:"2025-11-20T09:30:00",colorIndex:f[5].colorIndex}},{id:"7",name:"Deploy Layer 2 VPN Instance",status:"pending",runningCompleted:{running:49,completed:100},category:"Optical Optimization",version:"000.0012",lastEdited:{editor:f[0].name,timestamp:"2025-11-18T12:45:00",colorIndex:f[0].colorIndex}},{id:"8",name:"Initiate Scheduled Firmware Upgrade",status:"active",runningCompleted:{running:25,completed:75},category:"Service Provisioning",version:"000.0010",lastEdited:{editor:f[1].name,timestamp:"2025-11-15T17:10:00",colorIndex:f[1].colorIndex}},{id:"9",name:"Enable High Availability Mode",status:"running",runningCompleted:{running:77,completed:88},category:"Service Provisioning",version:"000.0001",lastEdited:{editor:f[2].name,timestamp:"2025-11-10T10:22:00",colorIndex:f[2].colorIndex}},{id:"10",name:"Audit Access Control Policies",status:"active",runningCompleted:{running:65,completed:200},category:"Service Provisioning",version:"000.0001",lastEdited:{editor:f[3].name,timestamp:"2025-11-05T15:15:00",colorIndex:f[3].colorIndex}},{id:"11",name:"Synchronize NTP Across Network Nodes",status:"warning",runningCompleted:{running:49,completed:142},category:"Service Provisioning",version:"000.0001",lastEdited:{editor:f[4].name,timestamp:"2025-10-28T08:40:00",colorIndex:f[4].colorIndex}},{id:"12",name:"Validate Optical Link Integrity",status:"failed",runningCompleted:{running:90,completed:300},category:"Network Built",version:"000.0001",lastEdited:{editor:f[5].name,timestamp:"2025-10-15T16:47:00",colorIndex:f[5].colorIndex}}],Kt={title:"Design System/Table/Filters",component:q,parameters:{layout:"fullscreen",docs:{description:{component:`
...
`}}},render:function(a){const[l,o]=j.useState({}),{columnFilters:i,filterChips:u,filterNavItems:h,enhancedColumns:c,handlers:n,renderFilterContent:r}=Q({filterAdapters:ae,baseColumns:a.columns,appliedFilters:l,onFiltersChange:o}),[d,m]=j.useState(!1),[s,C]=j.useState(h[0]?.id||""),B=x=>{x&&!s&&h.length>0&&C(h[0]?.id||""),m(x)},R=x=>{x&&C(x)},S=()=>{n.applyFilters(),m(!1)},b=()=>{n.clearAll(),m(!1)},O=({item:x})=>e.jsxs(e.Fragment,{children:[e.jsx(w,{variant:"body-sm-md",className:g.filterTabLabel,children:x.label}),!!x.count&&e.jsxs("div",{className:g.filterTabBadge,children:[e.jsx("span",{className:g.filterTabDot}),e.jsx(w,{variant:"body-sm-reg",className:g.filterTabCount,children:x.count})]})]});return e.jsxs("div",{className:g.tableFilterContainer,children:[e.jsxs("div",{className:g.debugPanel,children:[e.jsx(w,{variant:"body-sm-md",children:"External Filter State (controlled):"}),e.jsx("pre",{className:g.debugCode,children:JSON.stringify(l,null,2)||"{}"})]}),e.jsx("div",{className:g.toolbar,children:e.jsx(A,{design:"v1.2",buttonType:"secondary",onClick:()=>m(!0),children:e.jsx(L,{size:"tiny",icon:"filter_list"})})}),u.length>0&&e.jsx(Y,{items:u,onClearAll:b,onItemDelete:n.deleteChip}),e.jsx(q,{...a,columns:c,columnFilters:i}),e.jsxs(k,{style:{height:"600px"},open:d,onOpenChange:B,children:[e.jsxs(k.Header,{className:g.filterHeader,children:[e.jsxs("div",{className:g.headerLeft,children:[e.jsx(L,{icon:"filter_list",size:"small"}),e.jsx(k.Title,{children:"Filters"})]}),e.jsx(k.CloseTrigger,{})]}),e.jsx(k.Body,{className:g.filterBody,children:e.jsxs(V,{className:g.filterTabs,value:s,onValueChange:R,children:[e.jsx(V.List,{className:g.filterTabList,children:h.map(x=>e.jsx(V.Tab,{value:x.id,disabled:x.disabled,children:e.jsx(O,{item:x})},x.id))}),h.map(x=>e.jsx(V.Content,{value:x.id,className:g.filterContent,children:r(x)},x.id))]})}),e.jsxs(k.Footer,{className:g.filterFooter,children:[e.jsxs(A,{design:"v1.2",variant:"filled",buttonType:"secondary",onClick:b,children:[e.jsx(L,{icon:"close",size:"tiny"}),"Clear all"]}),e.jsx(k.Actions,{children:e.jsx(A,{design:"v1.2",variant:"filled",buttonType:"primary",onClick:S,children:"Apply"})})]})]})]})},args:{},play:async({canvasElement:t})=>{const a=H(t),l=a.getByText("External Filter State (controlled):");await v(l).toBeInTheDocument(),await v(a.getByText("{}")).toBeInTheDocument();const o=a.getByRole("button",{name:/filter/i});await T.click(o);const i=D.getByRole("tab",{name:/status/i});await T.click(i);const u=D.getByRole("checkbox",{name:/^active$/i});await T.click(u),await T.click(D.getByRole("button",{name:/apply/i})),await v(a.getByText(/"status"/)).toBeInTheDocument(),await v(a.getByText(/status: active/i)).toBeInTheDocument(),await T.click(a.getByRole("button",{name:/clear all/i})),await v(a.getByText("{}")).toBeInTheDocument(),await v(a.queryByText(/status: active/i)).not.toBeInTheDocument()}};P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
...
}`,...$.parameters?.docs?.source}}};const Jt=["FiltersPanel","Controlled"];export{$ as Controlled,P as FiltersPanel,Jt as __namedExportsOrder,Kt as default};
