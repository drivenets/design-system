import{j as s}from"./jsx-runtime-u17CrQMm.js";import{D as n}from"./ds-status-badge-F17cSrjP.js";import"./index-LPV9uRn0.js";import"./iframe-B2oe-xAg.js";import"./preload-helper-PPVm8Dsz.js";import"./ds-icon-BhO764TM.js";import"./ds-typography-ChGmLcT1.js";import"./index-COONa7JH.js";import"./index-DgHThz7K.js";const a=["active","running","pending","draft","inactive","warning","failed"],r=["medium","small"],d="_storiesContainer_15qm0_1",m="_storiesRow_15qm0_7",u="_sectionTitle_15qm0_12",v="_storiesList_15qm0_17",e={storiesContainer:d,storiesRow:m,sectionTitle:u,storiesList:v},{expect:p,within:h}=__STORYBOOK_MODULE_TEST__,w={title:"Design System/StatusBadge",component:n,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{icon:{control:"text",description:"Icon to display in the badge"},status:{control:"select",options:a,description:"Status type of the badge"},label:{control:"text",description:"Optional label to display instead of the default status text"},ghost:{control:"boolean",description:"Whether the badge should use ghost style (light background)"},size:{control:"select",options:r,description:"Size of the status badge"},className:{control:"text",description:"Additional CSS class names"},style:{control:"object",description:"Inline styles to apply to the component"}}},o={args:{icon:"check_circle",status:"active"},play:async({canvasElement:i})=>{const l=h(i).getByText("active");await p(l).toBeTruthy()}},c={render:()=>{const i={active:"check_circle",running:"change_circle",pending:"pause_circle",draft:"stylus_note",inactive:"stop_circle",warning:"warning",failed:"cancel"};return s.jsxs("div",{className:e.storiesContainer,children:[s.jsxs("div",{className:e.storiesRow,children:[s.jsxs("div",{children:[s.jsx("div",{className:e.sectionTitle,children:"Filled"}),s.jsx("div",{className:e.storiesList,children:a.map(t=>s.jsx(n,{icon:i[t],status:t},`filled-24-${t}`))})]}),s.jsxs("div",{children:[s.jsx("div",{className:e.sectionTitle,children:"Ghost"}),s.jsx("div",{className:e.storiesList,children:a.map(t=>s.jsx(n,{icon:i[t],status:t,ghost:!0},`ghost-24-${t}`))})]})]}),s.jsxs("div",{className:e.storiesRow,children:[s.jsxs("div",{children:[s.jsx("div",{className:e.sectionTitle,children:"Filled - Small"}),s.jsx("div",{className:e.storiesList,children:a.map(t=>s.jsx(n,{icon:i[t],status:t,size:"small"},`filled-20-${t}`))})]}),s.jsxs("div",{children:[s.jsx("div",{className:e.sectionTitle,children:"Ghost - Small"}),s.jsx("div",{className:e.storiesList,children:a.map(t=>s.jsx(n,{icon:i[t],status:t,ghost:!0,size:"small"},`ghost-20-${t}`))})]})]})]})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    icon: 'check_circle',
    status: 'active'
  },
