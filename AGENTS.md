...
- `*.docs.test.ts` uses the `storybook-docs` vitest project (excluded from default `pnpm test`, like `requires-build`); see [`docs-tests`](.agents/skills/docs-tests/SKILL.md) for workflow.
...
- `*.docs.test.ts` — [`docs-tests`](.agents/skills/docs-tests/SKILL.md)
...
- [`docs-tests`](.agents/skills/docs-tests/SKILL.md) — add/edit `*.docs.test.ts`; Show code + MCP manifest snippet verification
