...
| `*.docs.test.ts`                       | `pnpm test:storybook-docs -- src/components/ds-{name}/__tests__/ds-{name}.docs.test.ts --run` — see [docs-tests skill](../../.agents/skills/docs-tests/SKILL.md)                  |
