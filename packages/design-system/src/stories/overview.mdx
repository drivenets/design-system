...
<div>
  ...
  <div className={styles.steps}>
    ...
    <div className={styles.step}>
      ...
      <Source dark code="pnpm install @drivenets/vite-plugin-design-system" language="bash" />
    </div>
...
<DsTypography variant="body-md-reg" className={styles.sectionDescription}>
  ...
  <div className={styles.steps}>
    <div className={styles.step}>
      ...
      <Source dark code="pnpm install @drivenets/eslint-plugin-design-system" language="bash" />
    </div>

    <div className={styles.step}>
      <DsTypography variant="heading4">2. Add to ESLint config</DsTypography>
      <DsTypography variant="body-sm-reg" className={styles.stepHint}>
        Import and use the recommended preset in your eslint.config.ts:
      </DsTypography>
