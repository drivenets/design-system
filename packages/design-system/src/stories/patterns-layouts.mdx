...
import { DsStack } from '../components/ds-stack';
import { DsGrid, DsGridItem } from '../components/ds-grid';
...
<Source
	dark
	language="tsx"
	code={`import { withResponsiveProps } from '@drivenets/design-system';

const MyLayout = ({ gap, direction }) => /_ ... _/;

export const MyResponsiveLayout = withResponsiveProps(MyLayout, ['gap', 'direction']);

// Consumers can now pass:

<MyResponsiveLayout direction={{ md: 'column', lg: 'row' }} gap={{ md: 8, lg: 16 }} />`}
/>
