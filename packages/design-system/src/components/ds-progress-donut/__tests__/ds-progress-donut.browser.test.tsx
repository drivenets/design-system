...
import { DsProgressDonut } from '../index';

describe('DsProgressDonut', () => {
	it('exposes progress semantics and value text for a mid-range value', async () => {
		await page.render(<DsProgressDonut value={50} />);
	...
	it('forces a full value and check icon for the success variant', async () => {
		await page.render(<DsProgressDonut variant="success" />);
	...
	it('keeps the value and shows the close icon for the error variant', async () => {
		await page.render(<DsProgressDonut variant="error" value={50} />);
	...
	it('shows 0% at the minimum value', async () => {
		await page.render(<DsProgressDonut value={0} />);
	...
	it('shows 100% at the maximum value', async () => {
		await page.render(<DsProgressDonut value={100} />);
