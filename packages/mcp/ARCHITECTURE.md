...
Developer pushes to main
  ...
  → storybook build writes manifests/
  → scripts/enrich-mcp-manifest.ts rewrites components.json
  → storybook-static/ (including enriched manifests/) published to GitHub Pages
